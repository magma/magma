...
#ifndef GRPC_CliFlavour_2eproto__INCLUDED
#define GRPC_CliFlavour_2eproto__INCLUDED
 ...
 public:
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Get(
        ...
        ::devmand::channels::cli::plugin::CliFlavourResponse* response) = 0;
  ...
  class WithAsyncMethod_Get : public BaseClass {
   ...
   public:
    ...
    void RequestGet(
        ::grpc::ServerContext* context,
        ::devmand::channels::cli::plugin::CliFlavourRequest* request,
...
#endif // GRPC_CliFlavour_2eproto__INCLUDED
