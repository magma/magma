...
asn_TYPE_member_t asn_MBR_Ngap_CellIDListForRestart_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_CellIDListForRestart, choice.eUTRA_CGIListforRestart),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Ngap_CellIDListForRestart, choice.nR_CGIListforRestart),
