...
import (
	...
	magmacwfk8scontrollers "magma/cwf/k8s/cwf-operator/controllers/magma.cwf.k8s"
...
func init() {
	...
	utilruntime.Must(magmacwfk8sv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "768c578c.magma.cwf",
	})
	if err != nil {
