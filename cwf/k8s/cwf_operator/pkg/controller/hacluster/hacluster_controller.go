...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileHACluster{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
// Reconcile reads that state of the cluster for a HACluster object and makes changes based on the state read
// and what is in the HACluster.Spec
// Note:
...
func (r *ReconcileHACluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &magmav1alpha1.HACluster{}
