...
type GenTrafficRequest struct {
	...
	Imsi                    string                  `protobuf:"bytes,1,opt,name=imsi,proto3" json:"imsi,omitempty"`
	Volume                  *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=volume,proto3" json:"volume,omitempty"`
	Bitrate                 *wrapperspb.StringValue `protobuf:"bytes,3,opt,name=bitrate,proto3" json:"bitrate,omitempty"`
...
func (x *GenTrafficRequest) GetVolume() *wrapperspb.StringValue {
	if x != nil {
		return x.Volume
	}
	return nil
...
func (x *GenTrafficRequest) GetBitrate() *wrapperspb.StringValue {
	if x != nil {
		return x.Bitrate
	}
	return nil
