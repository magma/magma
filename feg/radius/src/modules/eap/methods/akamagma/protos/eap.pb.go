...
func (EapType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eap_1fdf100004db20d1, []int{0}
}
...
func (EapCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eap_1fdf100004db20d1, []int{1}
}
...
func (*EapMethodList) Descriptor() ([]byte, []int) {
	return fileDescriptor_eap_1fdf100004db20d1, []int{2}
}
...
func init() { proto.RegisterFile("eap.proto", fileDescriptor_eap_1fdf100004db20d1) }

var fileDescriptor_eap_1fdf100004db20d1 = []byte{
