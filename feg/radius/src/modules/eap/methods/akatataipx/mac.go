...
// GenMac calculates AKA MAC given data & K_auth
// (see: https://tools.ietf.org/html/rfc4187#section-10.15)
func GenMac(eapPayload, kaut []byte) []byte {
	return HmacSha1(eapPayload, kaut)[:16]
}
...
func MakeAKAKeys(identity, ik, ck []byte) (kencr, kaut, msk, emsk []byte) {
