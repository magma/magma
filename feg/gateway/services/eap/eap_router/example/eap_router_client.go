...
//		go run magma/feg/gateway/services/eap/eap_router &
//      then
//		go run magma/feg/gateway/services/eap/eap_router/example
func main() {
	serverAddr := flag.String("addr", "localhost:11111", "eap_router server address (host:port)")
	flag.Parse()
