...
func standardSwxProxyTest(t *testing.T) {
	...
	test_util.AssertEqual(t, &protos.RegistrationAnswer{SessionId: regRes.GetSessionId()}, regRes)
	...
	test_util.AssertEqual(t, &protos.RegistrationAnswer{SessionId: regRes.GetSessionId()}, deregRes)
