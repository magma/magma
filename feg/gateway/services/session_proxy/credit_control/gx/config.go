...
const (
	...
	UseEUIIPv6IfNoIPEnv = "USE_EUI64_IPV6_IF_NO_IP"

	PCRF91CompliantFlag  = "pcrf_91_compliant"
	UseEUIIPv6IfNoIPFlag = "use_eui64_ipv6"
)

var (
	pcrf91Compliant = flag.Bool(
		PCRF91CompliantFlag, false, "Set to support 29.212 release 9.1 compliant PCRF")
	useEUIIPv6IfNoIP = flag.Bool(
		UseEUIIPv6IfNoIPFlag, false, "Use MAC based EUI-64 IPv6 address for Gx CCR if IP is not provided")
)
