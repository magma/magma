...
func TestStartSessionGyFail(t *testing.T) {
	...
	mockPolicyDBClient.On("GetOmnipresentRules").Return([]*protos.PolicyRule{}).Once()
...
func TestSessionCreateWithOmnipresentRules(t *testing.T) {
	...
	mockPolicyDBClient.On("GetChargingKeysForRules", mock.Anything, mock.Anything).Return(
		[]policydb.ChargingKey{{RatingGroup: 1}}, nil).Once()
	omniPolicy2 := &protos.PolicyRule{Id: "omnipresent_rule_2"}
	mockPolicyDBClient.On("GetOmnipresentRules").Return([]*protos.PolicyRule{omniPolicy1, omniPolicy2})
	mocksGy.On(
		"SendCreditControlRequest",
		mock.Anything,
		mock.Anything,
...
func TestSessionCreateWithOmnipresentRulesGxDisabled(t *testing.T) {
	...
	omniPolicy1 := &protos.PolicyRule{Id: "omnipresent_rule_1"}
	omniPolicy2 := &protos.PolicyRule{Id: "omnipresent_rule_2"}
	mockPolicyDBClient.On("GetOmnipresentRules").Return([]*protos.PolicyRule{omniPolicy2, omniPolicy1})
	mocksGy.On(
		"SendCreditControlRequest",
		mock.Anything,
		mock.Anything,
...
func TestSessionControllerUseGyForAuthOnlySuccess(t *testing.T) {
	...
	omniPolicy1 := &protos.PolicyRule{Id: "omnipresent_rule_1"}
	mockPolicyDBClient.On("GetOmnipresentRules").Return([]*protos.PolicyRule{omniPolicy1}).Once()
...
func revalidationTimerTest(
	...
	omniPolicy1 := &protos.PolicyRule{Id: "omnipresent_rule_1"}
	omniPolicy2 := &protos.PolicyRule{Id: "omnipresent_rule_2"}
	mockPolicyDBClient.On("GetOmnipresentRules").Return([]*protos.PolicyRule{omniPolicy1, omniPolicy2}).Once()
