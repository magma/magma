...
var (
	...
	PcfSmPolicyUpdateFailure = prometheus.NewCounter(prometheus.CounterOpts{
...
func init() {
	prometheus.MustRegister(
		...
		PcfSmPolicyUpdateFailure, PcfSmPolicyDeleteRequests, PcfSmPolicyDeleteFailures,
...
func NewSessionHealthTracker() *SessionHealthTracker {
	...
	err := mconfig.GetServiceConfigs("n7_proxy", configPtr)
	if err != nil {
...
func (prevMetrics *SessionHealthMetrics) GetDelta(
	...
	if currentMetrics == nil {
		return nil, fmt.Errorf("nil current health metrics provided")
	}
