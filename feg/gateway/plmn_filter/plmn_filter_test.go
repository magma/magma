...
func TestPlmn5(t *testing.T) {
	...
	assert.True(t, CheckImsiOnPlmnIdListIfAny("001030000000055", plmnIdVals),
...
func TestPlmn6(t *testing.T) {
	plmnIdVals := GetPlmnVals(plmns_6)
	...
	assert.True(t, CheckImsiOnPlmnIdListIfAny("009899000000055", plmnIdVals),
