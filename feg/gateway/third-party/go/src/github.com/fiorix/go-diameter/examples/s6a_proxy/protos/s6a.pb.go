...
type ResetRequest struct {
	// Subscriber identifier
	UserId []string `protobuf:"bytes,1,rep,name=user_id,json=userId" json:"user_id,omitempty"`
}

func (m *ResetRequest) Reset()                    { *m = ResetRequest{} }
func (m *ResetRequest) String() string            { return proto.CompactTextString(m) }
func (*ResetRequest) ProtoMessage()               {}
func (*ResetRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*ResetAnswer) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (c *s6AProxyClient) Reset(ctx context.Context, in *ResetRequest, opts ...grpc.CallOption) (*ResetAnswer, error) {
	out := new(ResetAnswer)
	err := grpc.Invoke(ctx, "/S6aProxy/Reset", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
