...
func (srv *FegToGwRelayServer) ChargingReAuth(
	...
	if err := validateFegContext(ctx); err != nil {
		return &protos.ChargingReAuthAnswer{Result: protos.ResultCode_OTHER_FAILURE}, err
	}
	hwID, err := getHwIDFromIMSI(ctx, req.Sid)
	if err != nil {
		return &protos.ChargingReAuthAnswer{Result: protos.ResultCode_SESSION_NOT_FOUND},
	...
	if err != nil {
		return &protos.ChargingReAuthAnswer{Result: protos.ResultCode_OTHER_FAILURE},
