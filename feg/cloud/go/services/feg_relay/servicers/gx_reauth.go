...
func (srv *FegToGwRelayServer) PolicyReAuth(
	...
	if err := validateFegContext(ctx); err != nil {
		return &protos.PolicyReAuthAnswer{Result: protos.ResultCode_OTHER_FAILURE}, err
	}
	hwID, err := getHwIDFromIMSI(ctx, req.Imsi)
	if err != nil {
		return &protos.PolicyReAuthAnswer{Result: protos.ResultCode_SESSION_NOT_FOUND},
	...
	if err != nil {
		return &protos.PolicyReAuthAnswer{Result: protos.ResultCode_OTHER_FAILURE},
