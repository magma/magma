...
import (
	...
	s6a_proxy_servicers "magma/feg/cloud/go/services/feg_relay/gw_to_feg_relay/servicers/southbound"
...
func main() {
	...
	s6aproxy_servicers := s6a_proxy_servicers.NewRelayRouter()
	protos.RegisterS6AProxyServer(srv.GrpcServer, s6aproxy_servicers)
