...
// ContextValidate validates this federation network cluster status based on context it is used
func (m *FederationNetworkClusterStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
