...
type GxCreditControlRequest struct {
	...
	RequestNumber          *wrapperspb.Int32Value        `protobuf:"bytes,3,opt,name=request_number,json=requestNumber,proto3" json:"request_number,omitempty"`
	...
	EventTrigger     *wrapperspb.Int32Value `protobuf:"bytes,13,opt,name=event_trigger,json=eventTrigger,proto3" json:"event_trigger,omitempty"`
}
...
func (x *GxCreditControlRequest) GetRequestNumber() *wrapperspb.Int32Value {
	if x != nil {
...
func (x *GxCreditControlRequest) GetEventTrigger() *wrapperspb.Int32Value {
	if x != nil {
...
type GxCreditControlAnswer struct {
	...
	RevalidationTime     *timestamppb.Timestamp        `protobuf:"bytes,15,opt,name=revalidation_time,json=revalidationTime,proto3" json:"revalidation_time,omitempty"`
}
...
func (x *GxCreditControlAnswer) GetRevalidationTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *GyCreditControlRequest) GetRequestNumber() *wrapperspb.Int32Value {
	if x != nil {
		return x.RequestNumber
	}
	return nil
...
type RuleInstalls struct {
	...
	DeactivationTime *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=deactivation_time,json=deactivationTime,proto3" json:"deactivation_time,omitempty"`
}
...
func (x *RuleInstalls) GetActivationTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *RuleInstalls) GetDeactivationTime() *timestamppb.Timestamp {
	if x != nil {
