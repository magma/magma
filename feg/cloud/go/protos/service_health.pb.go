...
func (*DisableMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_health_8fbf28766d3dc51a, []int{0}
}
...
func (dst *DisableMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DisableMessage.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("feg/protos/service_health.proto", fileDescriptor_service_health_8fbf28766d3dc51a)
}

var fileDescriptor_service_health_8fbf28766d3dc51a = []byte{
