...
func (*AlertAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{0}
}
...
func (dst *AlertAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlertAck.Merge(dst, src)
}
...
func (*AlertReject) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{1}
}
...
func (dst *AlertReject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlertReject.Merge(dst, src)
}
...
func (*AlertRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{2}
}
...
func (*DownlinkUnitdata) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{3}
}
...
func (dst *DownlinkUnitdata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DownlinkUnitdata.Merge(dst, src)
}
...
func (*EPSDetachAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{4}
}
...
func (dst *EPSDetachAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EPSDetachAck.Merge(dst, src)
}
...
func (*EPSDetachIndication) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{5}
}
...
func (dst *EPSDetachIndication) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EPSDetachIndication.Merge(dst, src)
}
...
func (*IMSIDetachAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{6}
}
...
func (dst *IMSIDetachAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IMSIDetachAck.Merge(dst, src)
}
...
func (*IMSIDetachIndication) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{7}
}
...
func (dst *IMSIDetachIndication) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IMSIDetachIndication.Merge(dst, src)
}
...
func (*LocationUpdateAccept) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{8}
}
...
func (dst *LocationUpdateAccept) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocationUpdateAccept.Merge(dst, src)
}
...
func (*LocationUpdateAccept) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _LocationUpdateAccept_OneofMarshaler, _LocationUpdateAccept_OneofUnmarshaler, _LocationUpdateAccept_OneofSizer, []interface{}{
		(*LocationUpdateAccept_NewImsi)(nil),
		(*LocationUpdateAccept_NewTmsi)(nil),
	}
}

func _LocationUpdateAccept_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*LocationUpdateAccept)
	// newIMSITMSI
	switch x := m.NewIMSITMSI.(type) {
	case *LocationUpdateAccept_NewImsi:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.NewImsi)
	case *LocationUpdateAccept_NewTmsi:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.NewTmsi)
	case nil:
	default:
		return fmt.Errorf("LocationUpdateAccept.NewIMSITMSI has unexpected type %T", x)
	}
	return nil
}

func _LocationUpdateAccept_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*LocationUpdateAccept)
	switch tag {
	case 3: // newIMSITMSI.new_imsi
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.NewIMSITMSI = &LocationUpdateAccept_NewImsi{x}
		return true, err
	case 4: // newIMSITMSI.new_tmsi
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.NewIMSITMSI = &LocationUpdateAccept_NewTmsi{x}
		return true, err
	default:
		return false, nil
	}
...
func _LocationUpdateAccept_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*LocationUpdateAccept)
	// newIMSITMSI
	switch x := m.NewIMSITMSI.(type) {
	case *LocationUpdateAccept_NewImsi:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.NewImsi)))
		n += len(x.NewImsi)
	case *LocationUpdateAccept_NewTmsi:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.NewTmsi)))
		n += len(x.NewTmsi)
	case nil:
	default:
...
func (*LocationUpdateReject) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{9}
}
...
func (dst *LocationUpdateReject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocationUpdateReject.Merge(dst, src)
}
...
func (*LocationUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{10}
}
...
func (dst *LocationUpdateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocationUpdateRequest.Merge(dst, src)
}
...
func (*MMInformationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{11}
}
...
func (dst *MMInformationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MMInformationRequest.Merge(dst, src)
}
...
func (*PagingReject) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{12}
}
...
func (dst *PagingReject) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PagingReject.Merge(dst, src)
}
...
func (*PagingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{13}
}
...
func (*ResetAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{14}
}
...
func (dst *ResetAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResetAck.Merge(dst, src)
}
...
func (*ResetIndication) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{15}
}
...
func (dst *ResetIndication) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResetIndication.Merge(dst, src)
}
...
func (*ServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{16}
}
...
func (*Status) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{17}
}
...
func (*TMSIReallocationComplete) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{18}
}
...
func (dst *TMSIReallocationComplete) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TMSIReallocationComplete.Merge(dst, src)
}
...
func (*UEActivityIndication) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{19}
}
...
func (dst *UEActivityIndication) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UEActivityIndication.Merge(dst, src)
}
...
func (*UEUnreachable) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{20}
}
...
func (dst *UEUnreachable) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UEUnreachable.Merge(dst, src)
}
...
func (*UplinkUnitdata) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{21}
}
...
func (dst *UplinkUnitdata) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UplinkUnitdata.Merge(dst, src)
}
...
func (*ReleaseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{22}
}
...
func (*ServiceAbortRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_csfb_ba00b8449992bd80, []int{23}
}
...
func (dst *ServiceAbortRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceAbortRequest.Merge(dst, src)
}
...
func init() { proto.RegisterFile("feg/protos/csfb.proto", fileDescriptor_csfb_ba00b8449992bd80) }

var fileDescriptor_csfb_ba00b8449992bd80 = []byte{
