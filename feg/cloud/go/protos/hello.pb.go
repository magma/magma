...
type HelloRequest struct {
	...
	AgwToFegRelayTimestamp *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=agw_to_feg_relay_timestamp,json=agwToFegRelayTimestamp,proto3" json:"agw_to_feg_relay_timestamp,omitempty"`
}
...
func (x *HelloRequest) GetAgwToFegRelayTimestamp() *timestamppb.Timestamp {
	if x != nil {
...
type ResponseTimestamps struct {
	...
	AgwToFegRelayTimestamp *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=agw_to_feg_relay_timestamp,json=agwToFegRelayTimestamp,proto3" json:"agw_to_feg_relay_timestamp,omitempty"`
	// timestamp of the reception at feg
	FegTimestamp *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=feg_timestamp,json=fegTimestamp,proto3" json:"feg_timestamp,omitempty"`
	// timestamp injected by feg_relay
	FegRelayToAgwTimestamp *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=feg_relay_to_agw_timestamp,json=fegRelayToAgwTimestamp,proto3" json:"feg_relay_to_agw_timestamp,omitempty"`
}
...
func (x *ResponseTimestamps) GetAgwToFegRelayTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.AgwToFegRelayTimestamp
	}
	return nil
...
func (x *ResponseTimestamps) GetFegTimestamp() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ResponseTimestamps) GetFegRelayToAgwTimestamp() *timestamppb.Timestamp {
	if x != nil {
