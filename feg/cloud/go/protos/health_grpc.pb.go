...
// All implementations should embed UnimplementedCloudHealthServer
// for forward compatibility
...
// UnimplementedCloudHealthServer should be embedded to have forward compatible implementations.
