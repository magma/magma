...
export type enodeb_configuration = {
    NeighborCellList ? : Array < NeighborCell >
        ,
    NeighborFreqList ? : Array < NeighborFreq >
        ,
    bandwidth_mhz ? : 3 | 5 | 10 | 15 | 20,
    cell_id: number,
    device_class: "Baicells Nova-233 G2 OD FDD" | "Baicells Nova-243 OD TDD" | "Baicells Neutrino 224 ID FDD" | "Baicells ID TDD/FDD" | "NuRAN Cavium OC-LTE" | "FreedomFi One" | "Baicells Nova-227 OD TDD",
    earfcndl ? : number,
    pci ? : number,
