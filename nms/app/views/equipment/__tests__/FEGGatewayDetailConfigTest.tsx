...
describe('<FEGGatewayDetailConfig />', () => {
  ...
  it('verify gx edit is working', async () => {
    const {getByTestId, getByText, findByTestId} = render(<EditWrapper />);

    fireEvent.click(await findByTestId('gxEditButton'));
  ...
  it('verify gy edit is working', async () => {
    ...
    fireEvent.click(await findByTestId('gyEditButton'));
  ...
  it('verify swx edit is working', async () => {
    ...
    fireEvent.click(await findByTestId('swxEditButton'));
  ...
  it('verify s6a edit is working', async () => {
    const {getByText, findByTestId} = render(<EditWrapper />);

    fireEvent.click(await findByTestId('s6aEditButton'));

    const protocol = await findByTestId('protocol');
  ...
  it('verify csfb edit is working', async () => {
    ...
    fireEvent.click(await findByTestId('csfbEditButton'));

    const serverAddress = await findByTestId('serverAddress');
    const localAddress = getByTestId('localAddress');
