      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12}>
          <DateTimeMetricChart
            ...
            queries={[
              `sum(gtp_port_user_plane_dl_bytes{service="pipelined", ip_addr="${enbIpAddress}"})/1000`,
              `sum(gtp_port_user_plane_ul_bytes{service="pipelined", ip_addr="${enbIpAddress}"})/1000`,
            ]}
