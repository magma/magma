...
export {default as CloseTinyIcon} from './Actions/CloseTinyIcon';
...
export {default as FilterIcon} from './Actions/FilterIcon';
export {default as FiltersIcon} from './Actions/FiltersIcon';
export {default as LinkIcon} from './Actions/LinkIcon';
export {default as MandatoryIcon} from './Actions/MandatoryIcon';
export {default as PlusIcon} from './Actions/PlusIcon';
export {default as RemoveIcon} from './Actions/RemoveIcon';
export {default as ReorderIcon} from './Actions/ReorderIcon';
...
export {default as CellularIcon} from './Indications/CellularIcon';
export {default as CheckIcon} from './Indications/CheckIcon';
export {default as ChecklistCheckIcon} from './Indications/ChecklistCheckIcon';
...
export {default as ArrowUpIcon} from './Navigation/ArrowUpIcon';
export {default as BackArrowIcon} from './Navigation/BackArrowIcon';
