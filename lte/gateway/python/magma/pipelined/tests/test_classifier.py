...
class ClassifierTest(unittest.TestCase):
    ...
    def test_detach_tunnel_flows(self):
        ...
        ue_ip_addr = "192.168.128.31"
        self.classifier_controller.delete_tunnel_flows(
            2, IPAddress(version=IPAddress.IPV4, address=ue_ip_addr.encode('utf-8')),
            ip_flow_dl=ip_flow_dl,
        )
    ...
    def test_detach_multi_tunnel_flows(self):
        ...
        ue_ip_addr = "192.168.128.51"
        self.classifier_controller.delete_tunnel_flows(
            5, IPAddress(version=IPAddress.IPV4, address=ue_ip_addr.encode('utf-8')),
            self.EnodeB2_IP, ip_flow_dl=ip_flow_dl,
        )
    ...
    def test_detach_s8_tunnel_flows(self):
        ...
        self.classifier_controller.delete_s8_tunnel_flows(
            10, IPAddress(version=IPAddress.IPV4, address=ue_ip_addr.encode('utf-8')),
