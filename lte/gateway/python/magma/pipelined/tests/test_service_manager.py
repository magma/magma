...
class ServiceManagerTest(unittest.TestCase):
    ...
    def test_get_all_table_assignments(self):
        ...
        expected = OrderedDict([
            (
                'mme', Tables(
                    main_table=0, scratch_tables=[],
                    type=ControllerType.SPECIAL,
                ),
            ),
            (
                'ingress', Tables(
                    main_table=1, scratch_tables=[],
                    type=ControllerType.SPECIAL,
                ),
            ),
            (
                'arpd', Tables(
                    main_table=2, scratch_tables=[],
                    type=ControllerType.PHYSICAL,
                ),
            ),
            (
                'access_control', Tables(
                    main_table=3, scratch_tables=[],
                    type=ControllerType.PHYSICAL,
                ),
            ),
            (
                'proxy', Tables(
                    main_table=4, scratch_tables=[],
                    type=ControllerType.PHYSICAL,
                ),
            ),
