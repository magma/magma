...
def mocked_get_mac_by_ip6(ipv6_addr: str) -> Optional[str]:
    global ipv6_mac_table
    with gw_info_lock:
...
class InOutTestNonNATBasicFlowsIPv6(unittest.TestCase):
    ...
    @unittest.mock.patch(
        'magma.pipelined.gw_mac_address.get_mac_by_ip6', mocked_get_mac_by_ip6,
    )
    def testFlowSnapshotMatch(self):
        ipv6_addr1 = "2002::22"
        ...
        snapshot_verifier = SnapshotVerifier(
            ...
            self.service_manager,
            max_sleep_time=20,
            datapath=InOutTestNonNATBasicFlowsIPv6.ingress_controller._datapath,
        )
