...
class CreateSessionUtil:
    ...
    def __init__(
        ...
        """
        self._set_session = SessionSet(
            subscriber_id=subscriber_id,
            local_f_teid=local_f_teid,
            session_version=session_version,
            node_id=NodeID(
                node_id_type=NodeID.IPv4,
                node_id=node_id),
            state=Fsm_state(
                state=Fsm_state.CREATED))
    ...
    def CreateSessionMsg(
            self,
            imsi_val: str,
            pdr_entry: SetGroupPDR,
            far_entry: SetGroupFAR = None,
