...
from magma.pipelined.openflow.registers import IMSI_REG, DIRECTION_REG, \
    ...
    VLAN_TAG_REG, DPI_REG, RULE_NUM_REG, PROXY_TAG_REG, NG_FLOW_ENABLE_REG
...
class MagmaMatch(object):
    ...
    def __init__(self, imsi: int = None, direction: Optional[Direction] = None,
                 ...
                 app_id: int = None, proxy_tag: int = None, ng_flow_enabled: int = None,
                 **kwargs):
        self.imsi = imsi
        ...
        self.ng_flow_enabled = ng_flow_enabled
    ...
    def ryu_match(self):
        ...
        if self.ng_flow_enabled is not None:
            ryu_match[NG_FLOW_ENABLE_REG] = self.ng_flow_enabled
        return ryu_match
