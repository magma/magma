...
![OpenFlow Pipeline](docs/openflow-pipeline.png)
...
See the [Unit Test README](tests/README.md) for more details.

### Integration Tests

Traffic integration tests cover the end to end flow of Pipelined. See the [Integration Test README](../../integ_tests/README.md) for more details.
