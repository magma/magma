...
from lte.protos.pipelined_pb2 import RuleModResult, SetupFlowsRequest
...
class EnforcementController(PolicyMixin, MagmaController):
    ...
    def initialize_on_connect(self, datapath):
        ...
        # TODO, once sessiond actually works properly with relay off, nuke this
        if not self._relay_enabled:
            self.setup(SetupFlowsRequest())
