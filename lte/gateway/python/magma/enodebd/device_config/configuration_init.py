...
def _get_enb_config(
    ...
    if mconfig.enb_configs_by_serial is not None and \
        ...
        if enb_serial in mconfig.enb_configs_by_serial:
            ...
            if enb_config.ho_algorithm_config:
...
def _set_ho_algorithm_config(
    ...
    if ho_algorithm_config.lte_intra_a5_threshold_2_rsrp:
    ...
    if ho_algorithm_config.lte_inter_anr_a5_threshold_1_rsrp:
    ...
    if ho_algorithm_config.lte_inter_anr_a5_threshold_2_rsrp:
    ...
    if ho_algorithm_config.b2_threshold1_rsrp:
        cfg.set_parameter(BaicellsParameterName.HO_B2_THRESHOLD1_RSRP, ho_algorithm_config.b2_threshold1_rsrp)
    if ho_algorithm_config.b2_threshold2_rsrp:
        cfg.set_parameter(BaicellsParameterName.HO_B2_THRESHOLD2_RSRP, ho_algorithm_config.b2_threshold2_rsrp)
    if ho_algorithm_config.b2_geran_irat_threshold:
        cfg.set_parameter(BaicellsParameterName.HO_B2_GERAN_IRAT_THRESHOLD, ho_algorithm_config.b2_geran_irat_threshold)
    if ho_algorithm_config.hysteresis:
        cfg.set_parameter(BaicellsParameterName.HO_HYSTERESIS, ho_algorithm_config.hysteresis)
    if len(ho_algorithm_config.time_to_trigger) > 0:
        cfg.set_parameter(BaicellsParameterName.HO_TIME_TO_TRIGGER, ho_algorithm_config.time_to_trigger)
    ...
    if ho_algorithm_config.s_intrasearch:
        cfg.set_parameter(BaicellsParameterName.HO_S_INTRASEARCH, ho_algorithm_config.s_intrasearch)
    if ho_algorithm_config.s_nonintrasearch:
        cfg.set_parameter(BaicellsParameterName.HO_S_NONINTRASEARCH, ho_algorithm_config.s_nonintrasearch)
    if ho_algorithm_config.qrxlevmin_reselection < 0:
        cfg.set_parameter(BaicellsParameterName.HO_QRXLEVMIN_RESELECTION, ho_algorithm_config.qrxlevmin_reselection)
    if ho_algorithm_config.reselection_priority:
        cfg.set_parameter(BaicellsParameterName.HO_RESELECTION_PRIORITY, ho_algorithm_config.reselection_priority)
    if ho_algorithm_config.threshservinglow:
    ...
    if len(ho_algorithm_config.integrity_algorithm) > 0:
