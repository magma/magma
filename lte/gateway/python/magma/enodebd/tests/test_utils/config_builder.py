...
class EnodebConfigBuilder:
    ...
    def get_mconfig(
        ...
        if device is EnodebDeviceName.BAICELLS_QAFB:
        ...
        elif device is EnodebDeviceName.BAICELLS_QRTB:
            device_id = '120200024019APP0105'
            mconfig.enb_configs_by_serial[device_id].earfcndl = 44321
            mconfig.enb_configs_by_serial[device_id].tac = 1
            mconfig.enb_configs_by_serial[device_id].bandwidth_mhz = 20
            mconfig.enb_configs_by_serial[device_id].pci = 260
            mconfig.enb_configs_by_serial[device_id].cell_id = 138777000
            mconfig.enb_configs_by_serial[device_id].subframe_assignment = 2
            mconfig.enb_configs_by_serial[device_id].special_subframe_pattern = 7
            ...
            mconfig.enb_configs_by_serial[device_id] \
                .neighbor_cell_list['1'].earfcn = 44321
            mconfig.enb_configs_by_serial[device_id] \
            ...
            mconfig.tdd_config.earfcndl = 44321
    ...
    def get_multi_enb_mconfig(
        ...
        mconfig.enb_configs_by_serial[id1].earfcndl = 39151
        mconfig.enb_configs_by_serial[id1].subframe_assignment = 2
        mconfig.enb_configs_by_serial[id1].special_subframe_pattern = 7
        mconfig.enb_configs_by_serial[id1].pci = 259
        mconfig.enb_configs_by_serial[id1].bandwidth_mhz = 20
        mconfig.enb_configs_by_serial[id1].tac = 1
        mconfig.enb_configs_by_serial[id1].cell_id = 0
        mconfig.enb_configs_by_serial[id1].transmit_enabled = True
        mconfig.enb_configs_by_serial[id1].device_class = 'Baicells Band 40'

        id2 = '120200002618AGP0004'
        mconfig.enb_configs_by_serial[id2].earfcndl = 39151
        mconfig.enb_configs_by_serial[id2].subframe_assignment = 2
        mconfig.enb_configs_by_serial[id2].special_subframe_pattern = 7
        mconfig.enb_configs_by_serial[id2].pci = 261
        mconfig.enb_configs_by_serial[id2].bandwidth_mhz = 20
        mconfig.enb_configs_by_serial[id2].tac = 1
        mconfig.enb_configs_by_serial[id2].cell_id = 0
        mconfig.enb_configs_by_serial[id2].transmit_enabled = True
        mconfig.enb_configs_by_serial[id2].device_class = 'Baicells Band 40'
