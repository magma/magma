...
class Tr069MessageBuilder:
    ...
    def get_read_only_param_values_response(
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.DeviceInfo.X_COM_GPS_Status',
                val_type='boolean',
                data='0',
            ),
        )
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.DeviceInfo.X_COM_1588_Status',
                val_type='boolean',
                data='0',
            ),
        )
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.DeviceInfo.X_COM_MME_Status',
                val_type='boolean',
                data='false',
            ),
        )
    ...
    @classmethod
    def get_qrtb_read_only_param_values_response(
            cls,
    ) -> models.GetParameterValuesResponse:
        msg = models.GetParameterValuesResponse()
        param_val_list = []
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.ManagementServer.tfcsSyncState',
                val_type='boolean',
                data='0',
            ),
        )
    ...
    @classmethod
    def get_qrtb_regular_param_values_response(
            cls,
            admin_state: bool = False,
            earfcndl: int = 55990,
            exclude_num_plmns: bool = False,
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.DeviceInfo.X_COM_LTE_LGW_Switch',
                val_type='boolean',
                data='0',
            ),
        )
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.Services.FAPService.1.FAPControl.LTE.Gateway.X_COM_MmePool.Enable',
                val_type='boolean',
                data='false',
            ),
        )
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.Services.FAPService.1.X_COM_LTE.EARFCNULInUse',
                val_type='int',
                data='39150',
            ),
        )
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.Services.FAPService.1.X_COM.LTE.EnableX2',
                val_type='boolean',
                data='false',
            ),
        )
        ...
        param_val_list.append(
            cls.get_parameter_value_struct(
                name='Device.Services.FAPService.1.CellConfig.LTE.RAN.RF.X_COM_MaxTxPowerExpanded',
                val_type='int',
                data='22',
            ),
        )
