...
class Tr069MessageBuilder:
    ...
    def get_436Q_inform(
        ...
        # ParameterList
        val_list = [cls.get_parameter_value_struct(name=p.name, val_type=p.val_type, data=p.data)
                    for p in params]
    ...
    @classmethod
    def param_values_436q_response(cls, params, msg_model, status=None) -> models.GetParameterValuesResponse:
        msg = msg_model()
