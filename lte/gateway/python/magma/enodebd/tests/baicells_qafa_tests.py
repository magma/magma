...
class BaicellsQAFAHandlerTests(EnodebHandlerTestCase):
    def test_manual_reboot(self) -> None:
        ...
        acs_state_machine = \
            EnodebAcsStateMachineBuilder \
            .build_acs_state_machine(EnodebDeviceName.BAICELLS_QAFA)
    ...
    def test_provision(self) -> None:
        ...
        req = Tr069MessageBuilder.\
            get_qafa_regular_param_values_response(
                admin_state=False,
                earfcndl=3100,
            )
        resp = acs_state_machine.handle_tr069_message(req)
        ...
        req = Tr069MessageBuilder.get_qafa_object_param_values_response()
        resp = acs_state_machine.handle_tr069_message(req)
