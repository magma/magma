...
class BAICELLS_RTSHandlerTests(EnodebHandlerTestCase):
    def test_initial_enb_bootup(self) -> None:
        ...
        acs_state_machine = \
            EnodebAcsStateMachineBuilder \
                .build_acs_state_machine(EnodebDeviceName.BAICELLS_RTS)
    ...
    def test_missing_param_during_provisioning(self) -> None:
        ...
        req = Tr069MessageBuilder.\
            get_rts_regular_param_values_response(
                admin_state=False,
                earfcndl=39150,
    ...
    def test_provision_multi_without_invasive_changes(self) -> None:
        ...
        acs_state_machine = \
            EnodebAcsStateMachineBuilder \
                .build_multi_enb_acs_state_machine(EnodebDeviceName.BAICELLS_RTS)
