...
from magma.enodebd.data_models.data_model_parameters import ParameterName, BaicellsParameterName
...
class rtsEnodebConfigurationFactoryTest(TestCase):
    ...
    def test_get_enb_config(self):
        ...
        enb_config = _get_enb_config(mconfig, self.device_cfg)
        self.assertTrue(
            enb_config.power_control.reference_signal_power == 33,
    ...
    def test_set_power_control_config(self):
        ...
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.REFERENCE_SIGNAL_POWER), 33,
