...
class qrtbEnodebConfigurationFactoryTest(TestCase):

    def setUp(self):
        self.data_model = BaicellsQRTBTrDataModel()
        self.cfg = EnodebConfiguration(BaicellsQRTBTrDataModel())
        self.device_cfg = EnodebConfiguration(BaicellsQRTBTrDataModel())
    ...
    def test_get_enb_config(self):
        mconfig = EnodebConfigBuilder.get_mconfig(EnodebDeviceName.BAICELLS_QRTB)
        self.device_cfg.set_parameter(
