...
from magma.enodebd.devices.baicells_qafa import BaicellsQAFATrDataModel
from magma.enodebd.devices.device_utils import EnodebDeviceName
from magma.enodebd.exceptions import ConfigurationError
from magma.enodebd.tests.test_utils.config_builder import EnodebConfigBuilder


class qafaEnodebConfigurationFactoryTest(TestCase):

    def setUp(self):
        self.data_model = BaicellsQAFATrDataModel()
        self.cfg = EnodebConfiguration(BaicellsQAFATrDataModel())
        self.device_cfg = EnodebConfiguration(BaicellsQAFATrDataModel())
