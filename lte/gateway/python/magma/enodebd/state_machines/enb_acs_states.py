...
class CheckOptionalParamsState(EnodebAcsState):
    ...
    def read_msg(self, message: Any) -> AcsReadMsgResult:
        ...
        elif isinstance(message, models.GetParameterValuesResponse):
...
class WaitSetParameterValuesState(EnodebAcsState):
    ...
    def read_msg(self, message: Any) -> AcsReadMsgResult:
        if isinstance(message, models.SetParameterValuesResponse):
            if message.Status != 0:
                raise Tr069Error(
