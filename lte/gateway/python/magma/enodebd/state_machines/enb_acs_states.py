...
class EnbSendDownloadState(EnodebAcsState):
    ...
    def get_msg(self, message: Any) -> AcsMsgAndTransition:
        ...
        request.SuccessURL = ''
        request.FailureURL = ''
        self.acs.desired_cfg.delete_parameter(ParameterName.DOWNLOAD_URL)
        self.acs.desired_cfg.delete_parameter(ParameterName.DOWNLOAD_USER)
        self.acs.desired_cfg.delete_parameter(ParameterName.DOWNLOAD_PASSWORD)
        self.acs.desired_cfg.delete_parameter(ParameterName.DOWNLOAD_FILESIZE)
        self.acs.desired_cfg.delete_parameter(ParameterName.DOWNLOAD_FILENAME)
        self.acs.desired_cfg.delete_parameter(ParameterName.DOWNLOAD_MD5)
        return AcsMsgAndTransition(request, self.done_transition)
