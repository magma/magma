...
class BaicellsParameterName():
    ...
    HO_LTE_A2_THRESHOLD_RSRP_IRAT_VOLTE = 'Lte a2 threshold rsrp irat volte'
    HO_LTE_A2_THRESHOLD_RSRQ_IRAT_VOLTE = 'Lte a2 threshold rsrq irat volte'
    ...
    HO_QRXLEVMIN_CHOICE = 'qrxlevmin choice'
