...
from magma.enodebd.data_models.data_model_parameters import (
    ParameterName,
    TrParameterType, BaicellsParameterName,
)
...
from magma.enodebd.state_machines.acs_state_utils import get_all_objects_to_delete, get_all_objects_to_add, \
    get_all_param_values_to_set, parse_get_parameter_values_response, get_params_to_get, does_inform_have_event, \
...
class BaicellsRTSHandler(BasicEnodebAcsStateMachine):
    ...
    def _init_state_map(self) -> None:
        self._state_map = {
            ...
            'wait_factory_reset': WaitFactoryResetResponseState(
                self, when_done='wait_inform_post_factory_reset'),
            'wait_inform_post_factory_reset': WaitInformState(
                self, when_done='wait_empty_post_factory_reset',
                when_boot=None),
            'wait_empty_post_factory_reset': WaitEmptyMessageState(
                self, when_done='get_transient_params',
                when_missing='check_optional_params'),
...
class BaicellsRTSTrDataModel(DataModel):
    ...
    PARAMETERS = {
        ...
        ParameterName.GPS_STATUS: TrParam(DEVICE_PATH + 'DeviceInfo.X_BAICELLS_COM_GPS_Status', True,
                                          TrParameterType.BOOLEAN, False),
        ParameterName.PTP_STATUS: TrParam(DEVICE_PATH + 'DeviceInfo.X_BAICELLS_COM_1588_Status', True,
                                          TrParameterType.BOOLEAN, False),
        ParameterName.MME_STATUS: TrParam(DEVICE_PATH + 'DeviceInfo.X_BAICELLS_COM_MME_Status', True,
                                          TrParameterType.BOOLEAN, False),
        ParameterName.REM_STATUS: TrParam(FAPSERVICE_PATH + 'REM.X_BAICELLS_COM_REM_Status', True,
                                          TrParameterType.BOOLEAN, False),
        ...
        ParameterName.GPS_ENABLE: TrParam(DEVICE_PATH + 'DeviceInfo.X_BAICELLS_COM_GpsSyncEnable', False,
        ...
        ParameterName.SW_VERSION: TrParam(DEVICE_PATH + 'DeviceInfo.SoftwareVersion', True, TrParameterType.STRING,
                                          False),
        ParameterName.SERIAL_NUMBER: TrParam(DEVICE_PATH + 'DeviceInfo.SerialNumber', True, TrParameterType.STRING,
                                             False),
        ...
        ParameterName.BAND_CAPABILITY: TrParam(FAPSERVICE_PATH + 'Capabilities.LTE.BandsSupported', True,
                                               TrParameterType.STRING, False),

        # RF-related parameters
        ParameterName.EARFCNDL: TrParam(FAPSERVICE_PATH + 'X_BAICELLS_COM_LTE.EARFCNDLInUse', True, TrParameterType.INT,
                                        False),
        ParameterName.EARFCNUL: TrParam(FAPSERVICE_PATH + 'X_BAICELLS_COM_LTE.EARFCNULInUse', True, TrParameterType.INT,
                                        False),
        ParameterName.BAND: TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.FreqBandIndicator', True,
                                    TrParameterType.INT, False),
        ParameterName.PCI: TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.PhyCellID', False, TrParameterType.INT,
                                   False),
        ParameterName.DL_BANDWIDTH: TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.DLBandwidth', True,
                                            TrParameterType.STRING, False),
        ParameterName.UL_BANDWIDTH: TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.ULBandwidth', True,
                                            TrParameterType.STRING, False),
        ...
        ParameterName.CELL_ID: TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.Common.CellIdentity', True,
                                       TrParameterType.UNSIGNED_INT, False),

        # Other LTE parameters
        ParameterName.ADMIN_STATE: TrParam(FAPSERVICE_PATH + 'FAPControl.LTE.AdminState', False,
                                           TrParameterType.BOOLEAN, False),
        ParameterName.OP_STATE: TrParam(FAPSERVICE_PATH + 'FAPControl.LTE.OpState', True, TrParameterType.BOOLEAN,
                                        False),
        ParameterName.RF_TX_STATUS: TrParam(FAPSERVICE_PATH + 'FAPControl.LTE.RFTxStatus', True,
                                            TrParameterType.BOOLEAN, False),
        ...
        ParameterName.MME_PORT: TrParam(FAPSERVICE_PATH + 'FAPControl.LTE.Gateway.S1SigLinkPort', True,
                                        TrParameterType.INT, False),
        ParameterName.NUM_PLMNS: TrParam(
            FAPSERVICE_PATH + 'CellConfig.LTE.EPC.PLMNListNumberOfEntries', True, TrParameterType.INT, False,
        ),
        ParameterName.PLMN: TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.EPC.PLMNList.', True, TrParameterType.STRING,
                                    False),
        ...
        # Radio Power config
        BaicellsParameterName.REFERENCE_SIGNAL_POWER:
            TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.ReferenceSignalPower', True, TrParameterType.INT, False),
        BaicellsParameterName.POWER_CLASS:
            TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.X_BAICELLS_COM_MaxTxPowerExpanded', True,
                    TrParameterType.UNSIGNED_INT, False),
        BaicellsParameterName.PA:
            TrParam(FAPSERVICE_PATH + 'CellConfig.LTE.RAN.PHY.PDSCH.Pa', True, TrParameterType.INT, False),
        BaicellsParameterName.PB:
...
class BaicellsWaitGetTransientParametersState(EnodebAcsState):
    ...
    def get_next_state(self) -> str:
        ...
        logger.debug('get object param to get %s', get_object_params_to_get(
            self.acs.desired_cfg,
            self.acs.device_cfg,
            self.acs.data_model,
        ))
