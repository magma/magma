...
class BaicellsQRTBTrDataModel(DataModel):
    ...
    PARAMETERS = {
        ...
        ParameterName.GPS_ALTI: TrParam(
            path=DEVICE_PATH + 'FAP.GPS.altidute',
        ...
        ParameterName.MODEL_NAME: TrParam(
            path=DEVICE_PATH + 'DeviceInfo.ModelName',
            is_invasive=True, type=TrParameterType.STRING, is_optional=False,
        ),
        ...
        ParameterName.UPTIME: TrParam(
            path=DEVICE_PATH + 'DeviceInfo.X_COM_STATION_RUN_Time',
            is_invasive=True, type=TrParameterType.STRING, is_optional=False,
        ),
        ...
        ParameterName.CELL_RESERVED: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.CellRestriction.CellReservedForOperatorUse',
            is_invasive=False, type=TrParameterType.BOOLEAN, is_optional=False,
        ),
        ParameterName.CELL_BARRED: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.CellRestriction.CellBarred',
            is_invasive=True, type=TrParameterType.BOOLEAN, is_optional=False,
        ),
        ...
        BaicellsParameterName.POWER_CLASS: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.RF.X_COM_MaxTxPowerExpanded',
            is_invasive=True, type=TrParameterType.UNSIGNED_INT, is_optional=False,
        ),
        ...
        BaicellsParameterName.MANAGEMENT_SERVER: TrParam(
            path='Device.ManagementServer.URL', is_invasive=True,
            type=TrParameterType.STRING, is_optional=False,
        ),
        BaicellsParameterName.MANAGEMENT_SERVER_PORT: TrParam(
            path='Device.ManagementServer.X_COM_tr069_port',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.MANAGEMENT_SERVER_SSL_ENABLE: TrParam(
            path='Device.ManagementServer.X_COM_ssl_enable',
            is_invasive=True, type=TrParameterType.BOOLEAN, is_optional=False,
        ),
        ...
        BaicellsParameterName.HO_A3_OFFSET: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.HOVA3Offset',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_A3_OFFSET_ANR: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.ANR.AnrA3Offset',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_A4_THRESHOLD_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.RAN.Mobility.ConnMode.EUTRA.A4ThresholdRSRP',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_LTE_INTRA_A5_THRESHOLD_1_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.HOVInterA5Threshold1RSRP',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_LTE_INTRA_A5_THRESHOLD_2_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.HOVInterA5Threshold2RSRP',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_LTE_INTER_ANR_A5_THRESHOLD_1_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.ANR.InterAnrA5Threshold1RSRP',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_LTE_INTER_ANR_A5_THRESHOLD_2_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.ANR.InterAnrA5Threshold2RSRP',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_B2_THRESHOLD1_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.IRAT.B2threshold1RsrpHO',
            is_invasive=True, type=TrParameterType.UNSIGNED_INT, is_optional=False,
        ),
        BaicellsParameterName.HO_B2_THRESHOLD2_RSRP: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.Mobility.ConnMode.IRAT.X_COM_UTRANTDD.B2Threshold2UTRATDDRSCP',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_B2_GERAN_IRAT_THRESHOLD: TrParam(
            path=FAPSERVICE_PATH + 'X_COM.LTE.IRAT.B2Threshold2Geran',
            is_invasive=True, type=TrParameterType.UNSIGNED_INT, is_optional=False,
        ),
        BaicellsParameterName.HO_HYSTERESIS: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.Mobility.ConnMode.EUTRA.Hysteresis',
            is_invasive=True, type=TrParameterType.INT, is_optional=False,
        ),
        BaicellsParameterName.HO_TIME_TO_TRIGGER: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.Mobility.ConnMode.EUTRA.TimeToTrigger',
            is_invasive=True, type=TrParameterType.STRING, is_optional=False,
        ),
        ...
        BaicellsParameterName.HO_RESELECTION_PRIORITY: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.Mobility.IdleMode.IntraFreq.CellReselectionPriority',
            is_invasive=True, type=TrParameterType.UNSIGNED_INT, is_optional=False,
        ),
        BaicellsParameterName.HO_THRESHSERVINGLOW: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.Mobility.IdleMode.IntraFreq.ThreshServingLow',
            is_invasive=True, type=TrParameterType.UNSIGNED_INT, is_optional=False,
        ),
        BaicellsParameterName.HO_CIPHERING_ALGORITHM: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.EPC.AllowedCipheringAlgorithmList',
            is_invasive=True, type=TrParameterType.STRING, is_optional=False,
        ),
        BaicellsParameterName.HO_INTEGRITY_ALGORITHM: TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.EPC.AllowedIntegrityProtectionAlgorithmList',
            is_invasive=True, type=TrParameterType.STRING, is_optional=False,
        ),
    }
    ...
    for i in range(1, NUM_NEIGHBOR_CELL_CONFIG + 1):
        ...
        PARAMETERS[BaicellsParameterName.NEIGHBOR_CELL_TAC_N % i] = TrParam(
            path=FAPSERVICE_PATH + 'CellConfig.LTE.RAN.NeighborList.LTECell.%d.X_COM_TAC' % i,
            is_invasive=True, type=TrParameterType.UNSIGNED_INT, is_optional=False,
        )
    ...
    TRANSFORMS_FOR_MAGMA = {
        ...
        ParameterName.GPS_ALTI: transform_for_magma.gps_tr181,
    }
    ...
    def get_parameter_names(cls) -> List[ParameterName]:
        ...
        names = list(
            filter(
                lambda x: (not str(x).startswith('PLMN')) and (not str(x).startswith('Download'))
                and (not str(x).startswith('neighbor')) and (str(x) not in excluded_params),
                cls.PARAMETERS.keys(),
            ),
        )
        return names
