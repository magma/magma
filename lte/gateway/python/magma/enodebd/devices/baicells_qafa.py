...
class BaicellsQAFAHandler(BasicEnodebAcsStateMachine):
    ...
    def _init_state_map(self) -> None:
        self._state_map = {
            ...
            'wait_get_transient_params': BaicellsQafaWaitGetTransientParametersState(self, when_get='get_params', when_get_obj_params='get_obj_params', when_delete='delete_objs', when_add='add_objs', when_set='set_params', when_skip='end_session'),
            ...
            'get_obj_params': BaicellsQafaGetObjectParametersState(self, when_delete='delete_objs', when_add='add_objs', when_set='set_params', when_skip='end_session'),
            'delete_objs': DeleteObjectsState(self, when_add='add_objs', when_skip='set_params'),
            'add_objs': BaicellsQafaAddObjectsState(self, when_done='set_params'),
...
class BaicellsQafaWaitGetTransientParametersState(EnodebAcsState):
    """
...
class BaicellsQafaGetObjectParametersState(EnodebAcsState):
    """
    Get information on parameters belonging to objects that can be added or
    removed from the configuration.

    Baicells QAFA will report a parameter value as None if it does not exist
...
class BaicellsQafaAddObjectsState(EnodebAcsState):
