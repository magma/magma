    ...
    def test_decode_garbage(self):
        ...
        with self.assertRaises(CodecException):
            message.decode(b'\x01'  # Version
                           ...
                           + b'\x0 0' * (message.HEADER_LEN - 3))

        # Garbage AVPs
        with self.assertRaises(CodecException):
            message.decode(b'\x01'  # Version
                           + b'\x00\x00\x18'  # Length 24
                           + b'\x0 0' * (message.HEADER_LEN))
