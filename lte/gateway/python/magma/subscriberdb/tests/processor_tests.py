...
class ProcessorTests(unittest.TestCase):
    ...
    def test_lte_auth_success(self):
        ...
        self.assertEqual(
            self._processor.generate_lte_auth_vector("11111", 3 * b"\x00"),
            eutran_vector,
        )
    ...
    def test_lte_auth_success_opc(self):
        ...
        eutran_vector = _dummy_eutran_vector()
        self.assertEqual(
            self._processor.generate_lte_auth_vector("44444", 3 * b"\x00"),
            eutran_vector,
        )
    ...
    def test_lte_resync_seq_overflow_protect(self):
        ...
        self.assertEqual(self._processor.get_next_lte_auth_seq("11111"), 2 ** 28 + 2)
    ...
    def test_lte_resync_seq_larger(self):
        ...
        SEQ on auth failure.
        """
        self._processor.set_next_lte_auth_seq("11111", 2 ** 28 + 3)
        auts = 14 * b"\x00"
        with self.assertRaises(CryptoError):
            ...
            self._processor.resync_lte_auth_seq("11111", 16 * b"\x00", auts)
        self.assertEqual(self._processor.get_next_lte_auth_seq("11111"), 2 ** 28 + 3)
    ...
    def test_m5g_auth_success(self):
        ...
        self.assertEqual(
            self._processor.generate_m5g_auth_vector("11111", 3 * b"\x00"),
            m5Gran_vector,
        )
    ...
    def test_m5g_auth_success_opc(self):
        ...
        m5Gran_vector = _dummy_m5gran_vector()
        self.assertEqual(
            self._processor.generate_m5g_auth_vector("44444", 3 * b"\x00"),
            m5Gran_vector,
        )

    def test_m5g_auth_forbidden_network(self):
        """
