...
from magma.subscriberdb.crypto.EC import X25519, ECDH_SECP256R1

class ECIES_test(unittest.TestCase):
# annex C.4.3, ECIES Profile A test data
    def test_profileA(self):
        ...
        #
        plaintext   = str('00012080f6')
        ciphertext  = bytes(b'\x9cP\xe8\xbd\xcf\x02r\x87\xe4\x9e\x988\x14\xb1\xfc\x03')
...
# annex C.4.4, ECIES Profile A test data
    def test_profileB(self):
        ...
        #
        plaintext   = str('00012080F6')
        ciphertext  = bytes(b']\x1a\xf9\x1f\x8fbQ\x13\x16\xeah\x17\xc9\xb9\xa4\xb5')
