...
class CreateAmfSession(object):
	...
	def __init__(self,rat_type = RATType.Name(2),sm_session_state=SMSessionFSMState.Name(0),sm_session_version = [0,'uint32'],pdu_session_id = bytes([1]),rquest_type = RequestType.Name(0),access_type=AccessType.Name(0),pdu_address=RedirectServer(redirect_address_type=RedirectServer.IPV4,redirect_server_address="10.20.30.40"),pdu_session_type=PduSessionType.Name(0),ssc_mode=SscMode.Name(2),tteid=[0,0,0,1]):
		self._set_session = \
		       SetSMSessionContext(common_context=CommonSessionContext(sid = SubscriberID(id="imsi00000000001"),apn = bytes("BLR",'utf-8'),rat_type = RATType.Name(2),
                       sm_session_state=SMSessionFSMState.Name(0),sm_session_version=0),\
                       ...
                       gnode_endpoint=TeidSet(teid = bytes([0,0,0,4]),end_ipv4_addr="192.168.60.21"),\
                       pdu_address=RedirectServer(redirect_address_type=RedirectServer.IPV4, redirect_server_address="10.20.30.40"),access_type=AccessType.Name(0),
