...
def print_suciprofile(obj:SuciProfile):
    ...
    print("home_net_public_key:", obj.home_net_public_key)
    print("length of home_net_public_key:", len(obj.home_net_public_key.hex()))
    print("home_net_private_key:", obj.home_net_private_key)
    print("#######")
