...
def main():
    ...
    # List
    subparser = subparsers.add_parser('list_dhcp_records',
                                      help='Lists all records from Redis')
    subparser.set_defaults(func=cli.list_all_record)

    # Add
    subparser = subparsers.add_parser('add_rec',
    ...
    # del
    subparser = subparsers.add_parser('del_rec',
                                      help='Add ip allocation record')
    subparser.add_argument('mac', help='Mac address, e.g. "8a:00:00:00:0b:11"')
    subparser.set_defaults(func=cli.del_record)

    # set default gw
    subparser = subparsers.add_parser('set_default_gw',
                                      help='Set default GW')
    subparser.add_argument('ip', help='IP address, e.g. "1.1.1.1"')
    ...
    # set gw mac
    subparser = subparsers.add_parser('set_gw_mac',
