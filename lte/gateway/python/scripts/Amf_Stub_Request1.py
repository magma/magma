...
class CreateAmfSession(object):
	...
	def __init__(self,rat_type = RATType.Name(2),sm_session_state=SMSessionFSMState.Name(0),sm_session_version = [0,'uint32'],pdu_session_id = bytes([1]),rquest_type = RequestType.Name(0),access_type=AccessType.Name(0),pdu_address=RedirectServer(redirect_address_type=RedirectServer.IPV4),pdu_session_type=PduSessionType.Name(0),ssc_mode=SscMode.Name(2)):
		self._set_session = \
