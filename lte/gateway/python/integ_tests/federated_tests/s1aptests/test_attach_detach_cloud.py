...
class TestAttachDetachCloud(unittest.TestCase):
    ...
    def test_attach_detach_cloud(self):
        ...
        self._s1ap_wrapper.configUEDevice(num_ues,None,None,True)
        print("restarting all services")
        self._magmad_util.restart_all_services()
        print("all services are restarted...")
