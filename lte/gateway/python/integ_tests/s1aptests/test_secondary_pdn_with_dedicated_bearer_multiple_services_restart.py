...
class TestSecondaryPdnWithDedicatedBearerMultipleServicesRestart(
    ...
    def test_secondary_pdn_with_dedicated_bearer_multiple_services_restart(
        self,
    ):
        """
        Test with a single UE attach + add secondary PDN
        + add 2 dedicated bearers + restart sessiond, mme and pipelined
        services + verify ovs rules + detach"""
