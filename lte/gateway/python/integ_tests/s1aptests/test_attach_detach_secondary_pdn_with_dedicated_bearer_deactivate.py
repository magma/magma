...
class TestAttachDetachSecondaryPdnWithDedicatedBearerDeactivate(unittest.TestCase):
    ...
    def test_attach_detach_secondary_pdn_with_dedicated_bearer_deactivate(self):
