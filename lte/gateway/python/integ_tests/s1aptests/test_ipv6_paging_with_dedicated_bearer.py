...
class TestIpv6PagingWithDedicatedBearer(unittest.TestCase):
    """Test ipv6 paging with dedicated bearer"""
    ...
    def test_ipv6_paging_with_dedicated_bearer(self):
        """ IPv6 Attach, add dedicated bearer,ue context release,
        paging request """
        # Ground work.
