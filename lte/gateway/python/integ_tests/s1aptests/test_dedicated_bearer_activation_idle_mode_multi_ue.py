...
class TestDedicatedBearerActivationIdleModeMultiUe(unittest.TestCase):
    ...
    def test_dedicated_bearer_activation_idle_mode_multi_ue(self):
        """
        Attach + UE context release +
        ...
        # 1 PDN + 2 dedicated bearers per UE.Totally 12 UL flows for 4 UEs
        num_ul_flows = 12
        for i in range(num_ues):
