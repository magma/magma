...
class TestIPv6SecondaryPdnWithDedBearer(unittest.TestCase):
    ...
    def test_ipv6_secondary_pdn_with_ded_bearer(self):
        """ Attach a single UE + add a secondary pdn with """
        """ IPv6 + add dedicated bearer + detach """
        num_ue = 1
        ...
        ulFlow1 = {
            ...
            "ipv6_dst": "d88d:aba4:472f:fc95:7e7d:8457:5301:ebce",
        ...
        dlFlow2 = {
            # IPv6 source address
            "ipv6_src": "fdee:0005:006c:08a0:e6d8:a218:3b54:604d",
