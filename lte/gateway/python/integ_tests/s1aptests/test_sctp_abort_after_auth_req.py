...
class TestSctpAbortAfterAuthReq(unittest.TestCase):
    ...
    def test_sctp_abort_after_auth_req(self):
        """ testing SCTP Abort after Auth Request for a single UE """
        self._s1ap_wrapper.configUEDevice(1)

        req = self._s1ap_wrapper.ue_req
        print("************************* Running SCTP Abort after Auth "
