...
class TestAttachEsmInformationTimerExpiration(unittest.TestCase):
    """Integration Test: TestAttachEsmInformationTimerExpiration"""
    ...
    def test_attach_esm_information_timerexpiration(self):
