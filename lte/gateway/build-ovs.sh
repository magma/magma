...
GTP_PATCH_PATH="$(realpath ../../third_party/gtp_ovs)"

# Build time dependencies
BUILD_DEPS="graphviz debhelper dh-autoreconf python-all python-twisted-conch module-assistant git ruby-dev openssl"
PATCHES="$(ls ${GTP_PATCH_PATH}/ovs/${OVS_VERSION_SHORT})"
PATCHES_PATH="$(find ${GTP_PATCH_PATH}/ovs/${OVS_VERSION_SHORT}/*.patch -print0 | xargs -r0 realpath)"
