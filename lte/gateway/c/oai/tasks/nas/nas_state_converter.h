...
class NasStateConverter : StateConverter {
 public:
  ...
  /**
   * Serialize struct emm_context_t to oai::EmmContext proto message, the memory for
  ...
  /**
   * Deserialize oai::EmmContext proto message to struct emm_context_t, the memory
  ...
  static void proto_to_identity_tuple(
    const oai::IdentityTuple& identity_proto,
