...
int decode_modify_eps_bearer_context_accept(
  ...
  CHECK_PDU_POINTER_AND_LENGTH_DECODER(
      buffer, MODIFY_EPS_BEARER_CONTEXT_ACCEPT_MINIMUM_LENGTH, len);
  ...
  while (len > decoded) {
    ...
    switch (ieiDecoded) {
      case MODIFY_EPS_BEARER_CONTEXT_ACCEPT_PROTOCOL_CONFIGURATION_OPTIONS_IEI:
         ...
         */
        modify_eps_bearer_context_accept->presencemask |=
...
int encode_modify_eps_bearer_context_accept(
  ...
  if ((modify_eps_bearer_context_accept->presencemask &
       MODIFY_EPS_BEARER_CONTEXT_ACCEPT_PROTOCOL_CONFIGURATION_OPTIONS_PRESENT) ==
      MODIFY_EPS_BEARER_CONTEXT_ACCEPT_PROTOCOL_CONFIGURATION_OPTIONS_PRESENT) {
    if ((encode_result = encode_protocol_configuration_options_ie(
             &modify_eps_bearer_context_accept->protocolconfigurationoptions,
