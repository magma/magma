...
//#include "NGap-CauseRadioNetwork.h"
 ...
 // InitialUEMessage_IEs_t *initialUEMessage_IEs)
{
  ...
  */
  ...
  //NGAP_INITIAL_UE_MESSAGE(message_p).ran_ue_ngap_id = initialUEMessage_IEs->ran_ue_ngap_id;
 // NGAP_INITIAL_UE_MESSAGE(message_p).gnb_ue_ngap_id = initialUEMessage_IEs->ran_ue_ngap_id;
 ...
 // NGAP_INITIAL_UE_MESSAGE(message_p).nas = initialUEMessage_IEs->nas_pdu;
  //NGAP_INITIAL_UE_MESSAGE(message_p).userLocationInformation = initialUEMessage_IEs->userLocationInformation;
 // NGAP_INITIAL_UE_MESSAGE(message_p).rrcEstablishmentCause = initialUEMessage_IEs->rrcEstablishmentCause;
 // NGAP_INITIAL_UE_MESSAGE(message_p).ueContextRequest = initialUEMessage_IEs->ueContextRequest;
  ...
  NGAP_INITIAL_UE_MESSAGE(message_p).m5g_rrc_establishment_cause = rrc_cause + 1;
