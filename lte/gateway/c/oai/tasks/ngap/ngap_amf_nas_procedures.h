...
/*
int ngap_generate_ngap_e_rab_setup_req(
    ngap_state_t* state, itti_ngap_e_rab_setup_req_t* const e_rab_setup_req);

int ngap_generate_ngap_e_rab_rel_cmd(
    ngap_state_t* state, itti_ngap_e_rab_rel_cmd_t* const e_rab_rel_cmd);
*/
