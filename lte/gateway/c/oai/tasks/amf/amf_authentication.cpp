...
namespace magma5g
{
    ...
    ***************************************************************************/
    ...
    //auth_info_req = &message_p->ittiMsg.n6_auth_info_req;//TODO -  NEED-RECHECK IMP to consider
...
static int start_authentication_information_procedure(amf_context_t* amf_context, 
                                nas_amf_auth_proc_t* const auth_proc,  const_bstring auts) 
    {
        ...
        nas_5g_auth_info_proc_t* auth_info_proc;// = get_nas_cn_procedure_auth_info(amf_context);//TODO -  NEED-RECHECK IMP
        if (!auth_info_proc) {
            auth_info_proc;//= nas_new_cn_auth_info_procedure(amf_context); //TODO -  NEED-RECHECK IMP
    ...
    //------------------------------------------------------------------------------
#if 0 //TODO -  NEED-RECHECK  this function need to be declared
