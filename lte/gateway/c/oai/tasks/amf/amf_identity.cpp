...
// namespace NR_amf_msg
{
    ...
    */
    rc = amf_proc_identification_complete(ue_id, p_imsi, p_imei, p_imeisv, (uint32_t*) (p_tmsi));
...
//------------------------------------------------------------------------------
   nas_amf_ident_proc_t* get_5g_nas_common_procedure_identification(
      ...
      //return (nas_amf_ident_proc_t*) get_nas5g_common_procedure( ctxt, AMF_COMM_PROC_IDENT);//TODO-RECHECK
}
...
//------------------------------------------------------------------------------
    ...
    ***************************************************************************/
    ...
    // Get the UE context
    ue_m5gmm_context_s* ue_mm_context = amf_ue_context_exists_amf_ue_ngap_id(ue_id);//TODO
    if (ue_mm_context) {
