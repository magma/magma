...
int amf_app_ue_context::amf_insert_ue_context(
  ...
  /* initialise ue_context UE state to Deregister and PDU session state to NULL
   */
  ue_m5gmm_global_context.mm_state = DEREGISTERED;
  ue_m5gmm_global_context.amf_context.smf_context.pdu_session_state =
      SESSION_NULL;
