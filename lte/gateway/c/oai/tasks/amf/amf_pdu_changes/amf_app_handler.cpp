...
#define N1_SM_INFO 0x1  // TODO define in "M5gNasMessage.h" //pdu_change
  ...
  container_len++;
  smf_msg->header.pdu_session_id = pdu_session_resp->pdu_session_id[0];
  container_len++;
...
// QOSRulesMsg qos_rules;
  ...
  //	pdu_session_resp->session_ambr.uplink_unit_type;
  ambr_len += 1;
  smf_msg->pdu_session_estab_accept.session_ambr.dl_session_ambr =
      pdu_session_resp->session_ambr.downlink_units;
  ambr_len += 2;
  smf_msg->pdu_session_estab_accept.session_ambr.ul_session_ambr =
      pdu_session_resp->session_ambr.uplink_units;
  ambr_len += 2;
