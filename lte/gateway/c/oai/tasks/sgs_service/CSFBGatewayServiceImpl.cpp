  ...
  Void *response)
{
  ...
  std::cout
    << "[DEBUG] Received SGSAP_ALERT_REQUEST message from FeG with IMSI: "
  ...
  Void *response)
{
  ...
  std::cout
    << "[DEBUG] Received SGSAP_EPS_DETACH_ACK message from FeG with IMSI: "
    << itti_msg.imsi << std::endl;
  ...
  Void *response)
{
  ...
  std::cout
    << "[DEBUG] Received SGSAP_IMSI_DETACH_ACK message from FeG with IMSI: "
    << itti_msg.imsi << std::endl;
  ...
  Void *response)
{
  ...
  std::cout
    << "[DEBUG] Received SGSAP_PAGING_REQUEST message from FeG with IMSI: "
    << itti_msg.imsi << std::endl;
