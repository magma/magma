...
static inline int s1ap_mme_encode_successfull_outcome(
    s1ap_message* message_p, uint8_t** buffer, uint32_t* len);
...
static inline int s1ap_mme_encode_initial_context_setup_request(
  ...
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_InitialContextSetup,
...
static inline int s1ap_mme_encode_s1setupresponse(
  ...
  return s1ap_generate_successfull_outcome(
      buffer, length, S1ap_ProcedureCode_id_S1Setup, message_p->criticality,
...
static inline int s1ap_mme_encode_resetack(
  ...
  return s1ap_generate_successfull_outcome(
      buffer, length, S1ap_ProcedureCode_id_Reset, message_p->criticality,
      &asn_DEF_S1ap_ResetAcknowledge, s1ResetAck_p);
}
...
static inline int s1ap_mme_encode_pathswitchreqack(
  ...
  memset(
      s1PathSwitchRequestAck_p, 0, sizeof(S1ap_PathSwitchRequestAcknowledge_t));
  ...
  return s1ap_generate_successfull_outcome(
      buffer, length, S1ap_ProcedureCode_id_PathSwitchRequest,
      message_p->criticality, &asn_DEF_S1ap_PathSwitchRequestAcknowledge,
      s1PathSwitchRequestAck_p);
}
...
static inline int s1ap_mme_encode_pathswitchreqfailure(
  ...
  memset(
      s1ap_PathSwitchRequestFailure_p, 0,
  ...
  return s1ap_generate_unsuccessfull_outcome(
      buffer, length, S1ap_ProcedureCode_id_PathSwitchRequest,
      message_p->criticality, &asn_DEF_S1ap_PathSwitchRequestFailure,
      s1ap_PathSwitchRequestFailure_p);
}
...
static inline int s1ap_mme_encode_downlink_nas_transport(
   ...
   */
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_downlinkNASTransport,
      S1ap_Criticality_ignore, &asn_DEF_S1ap_DownlinkNASTransport,
      downlinkNasTransport_p);
}
...
static inline int s1ap_mme_encode_ue_context_release_command(
   ...
   * Convert IE structure into asn1 message_p
   */
  if (s1ap_encode_s1ap_uecontextreleasecommandies(
  ...
  return s1ap_generate_initiating_message(
      ...
      S1ap_Criticality_reject, &asn_DEF_S1ap_UEContextReleaseCommand,
      ueContextReleaseCommand_p);
}
...
static inline int s1ap_mme_encode_paging(
  ...
  if (s1ap_encode_s1ap_pagingies(paging_p, &message_p->msg.s1ap_PagingIEs) <
      0) {
    return -1;
  }
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_Paging, S1ap_Criticality_ignore,
      &asn_DEF_S1ap_Paging, paging_p);
}
...
static inline int s1ap_mme_encode_e_rab_setup(
  ...
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_E_RABSetup, message_p->criticality,
      &asn_DEF_S1ap_E_RABSetupRequest, e_rab_setup_p);
}
...
static inline int s1ap_mme_encode_ue_context_modification_request(
  ...
  memset(
      ueContextModificationRequest_p, 0,
      sizeof(S1ap_UEContextModificationRequest_t));

  if (s1ap_encode_s1ap_uecontextmodificationrequesties(
  ...
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_UEContextModification,
      S1ap_Criticality_reject, &asn_DEF_S1ap_UEContextModificationRequest,
      ueContextModificationRequest_p);
}
...
static inline int s1ap_mme_encode_e_rab_release_command(
  ...
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_E_RABRelease,
      message_p->criticality, &asn_DEF_S1ap_E_RABSetupRequest, e_rab_rel_cmd_p);
}
...
static inline int s1ap_mme_encode_mme_configuration_transfer(
  ...
  memset(
      mmeConfigurationTransfer_p, 0, sizeof(S1ap_MMEConfigurationTransfer_t));
  ...
  return s1ap_generate_initiating_message(
      buffer, length, S1ap_ProcedureCode_id_MMEConfigurationTransfer,
      S1ap_Criticality_ignore, &asn_DEF_S1ap_MMEConfigurationTransfer,
      mmeConfigurationTransfer_p);
}
