...
static asn_per_constraints_t asn_PER_type_S1ap_AreaScopeOfMDT_constr_1
  GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_S1ap_AreaScopeOfMDT_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_AreaScopeOfMDT, choice.cellBased),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_AreaScopeOfMDT, choice.tABased),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_AreaScopeOfMDT, choice.pLMNWide),
