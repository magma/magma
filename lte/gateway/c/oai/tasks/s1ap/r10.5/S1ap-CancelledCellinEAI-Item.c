...
static asn_TYPE_member_t asn_MBR_S1ap_CancelledCellinEAI_Item_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_CancelledCellinEAI_Item, eCGI),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_CancelledCellinEAI_Item, numberOfBroadcasts),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_CancelledCellinEAI_Item, iE_Extensions),
