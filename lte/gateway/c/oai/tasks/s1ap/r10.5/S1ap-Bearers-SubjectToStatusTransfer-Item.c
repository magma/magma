...
static asn_TYPE_member_t asn_MBR_S1ap_Bearers_SubjectToStatusTransfer_Item_1[] =
  {
    {ATF_NOFLAGS,
     0,
     offsetof(struct S1ap_Bearers_SubjectToStatusTransfer_Item, e_RAB_ID),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct S1ap_Bearers_SubjectToStatusTransfer_Item, uL_COUNTvalue),
    ...
    {ATF_NOFLAGS,
     0,
     offsetof(struct S1ap_Bearers_SubjectToStatusTransfer_Item, dL_COUNTvalue),
    ...
    {ATF_POINTER,
     1,
     offsetof(struct S1ap_Bearers_SubjectToStatusTransfer_Item, iE_Extensions),
...
static asn_TYPE_tag2member_t
  asn_MAP_S1ap_Bearers_SubjectToStatusTransfer_Item_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     3,
     0,
     0}, /* receiveStatusofULPDCPSDUs at 89 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0} /* iE-Extensions at 90 */
};
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_Bearers_SubjectToStatusTransfer_Item_specs_1 = {
