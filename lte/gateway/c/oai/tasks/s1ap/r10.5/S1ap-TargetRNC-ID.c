...
static asn_TYPE_member_t asn_MBR_S1ap_TargetRNC_ID_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_TargetRNC_ID, lAI),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_TargetRNC_ID, rAC),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_TargetRNC_ID, rNC_ID),
  ...
  {ATF_POINTER,
   2,
   offsetof(struct S1ap_TargetRNC_ID, extendedRNC_ID),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_TargetRNC_ID, iE_Extensions),
