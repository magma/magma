...
static asn_per_constraints_t asn_PER_type_S1ap_UE_S1AP_IDs_constr_1
  GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_S1ap_UE_S1AP_IDs_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_UE_S1AP_IDs, choice.uE_S1AP_ID_pair),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_UE_S1AP_IDs, choice.mME_UE_S1AP_ID),
