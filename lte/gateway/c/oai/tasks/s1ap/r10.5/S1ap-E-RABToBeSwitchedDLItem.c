...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABToBeSwitchedDLItem_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSwitchedDLItem, e_RAB_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSwitchedDLItem, transportLayerAddress),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSwitchedDLItem, gTP_TEID),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABToBeSwitchedDLItem, iE_Extensions),
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_E_RABToBeSwitchedDLItem_tag2el_1[] = {
  ...
  {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
   1,
   0,
   0}, /* transportLayerAddress at 507 */
