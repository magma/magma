...
static asn_TYPE_member_t asn_MBR_S1ap_ForbiddenTAs_Item_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_ForbiddenTAs_Item, pLMN_Identity),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_ForbiddenTAs_Item, forbiddenTACs),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_ForbiddenTAs_Item, iE_Extensions),
