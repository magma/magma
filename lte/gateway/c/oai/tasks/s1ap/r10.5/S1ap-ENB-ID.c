...
static int memb_macroENB_ID_constraint_1(
...
static int memb_homeENB_ID_constraint_1(
  asn_TYPE_descriptor_t *td,
  const void *sptr,
  asn_app_constraint_failed_f *ctfailcb,
  void *app_key)
...
static asn_TYPE_member_t asn_MBR_S1ap_ENB_ID_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_ENB_ID, choice.macroENB_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_ENB_ID, choice.homeENB_ID),
