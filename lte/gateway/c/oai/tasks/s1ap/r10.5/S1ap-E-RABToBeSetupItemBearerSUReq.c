...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABToBeSetupItemBearerSUReq_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemBearerSUReq, e_RAB_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemBearerSUReq, e_RABlevelQoSParameters),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemBearerSUReq, transportLayerAddress),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemBearerSUReq, gTP_TEID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemBearerSUReq, nAS_PDU),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABToBeSetupItemBearerSUReq, iE_Extensions),
...
static asn_TYPE_tag2member_t
  asn_MAP_S1ap_E_RABToBeSetupItemBearerSUReq_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     1,
     0,
     0}, /* e-RABlevelQoSParameters at 525 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     2,
     0,
     0}, /* transportLayerAddress at 526 */
...
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_E_RABToBeSetupItemBearerSUReq_specs_1 = {
