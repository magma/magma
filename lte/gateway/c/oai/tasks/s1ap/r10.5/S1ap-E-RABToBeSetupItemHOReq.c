...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABToBeSetupItemHOReq_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemHOReq, e_RAB_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemHOReq, transportLayerAddress),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemHOReq, gTP_TEID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemHOReq, e_RABlevelQosParameters),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABToBeSetupItemHOReq, iE_Extensions),
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_E_RABToBeSetupItemHOReq_tag2el_1[] = {
  ...
  {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
   1,
   0,
   0}, /* transportLayerAddress at 484 */
  {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0}, /* gTP-TEID at 485 */
  {(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
   3,
   0,
   0}, /* e-RABlevelQosParameters at 486 */
