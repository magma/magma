...
static asn_TYPE_member_t asn_MBR_S1ap_Cdma2000OneXSRVCCInfo_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cdma2000OneXSRVCCInfo, cdma2000OneXMEID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cdma2000OneXSRVCCInfo, cdma2000OneXMSI),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cdma2000OneXSRVCCInfo, cdma2000OneXPilot),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_Cdma2000OneXSRVCCInfo, iE_Extensions),
