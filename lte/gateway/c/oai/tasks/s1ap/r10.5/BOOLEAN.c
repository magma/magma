 ...
 * Decode BOOLEAN type.
 */
asn_dec_rval_t BOOLEAN_decode_ber(
 ...
 */
static enum xer_pbd_rval BOOLEAN__xer_body_decode(
  asn_TYPE_descriptor_t *td,
  void *sptr,
    ...
    switch (xer_check_tag(chunk_buf, chunk_size, "false")) {
      ...
      case XCT_UNKNOWN_BO:
        ...
        *st = 1; /* Or 0xff as in DER?.. */
        break;
      default: return XPBD_BROKEN_ENCODING;
    }
...
asn_dec_rval_t BOOLEAN_decode_xer(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  void **sptr,
...
asn_enc_rval_t BOOLEAN_encode_xer(
  asn_TYPE_descriptor_t *td,
  void *sptr,
  int ilevel,
...
asn_dec_rval_t BOOLEAN_decode_uper(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t BOOLEAN_decode_aper(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void **sptr,
...
asn_enc_rval_t BOOLEAN_encode_uper(
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void *sptr,
  asn_per_outp_t *po)
{
  ...
  if (per_put_few_bits(po, *st ? 1 : 0, 1)) _ASN_ENCODE_FAILED;

  _ASN_ENCODED_OK(er);
}

asn_enc_rval_t BOOLEAN_encode_aper(
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void *sptr,
  asn_per_outp_t *po)
...
asn_comp_rval_t *BOOLEAN_compare(
