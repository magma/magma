...
static asn_TYPE_member_t asn_MBR_S1ap_MDT_Configuration_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_MDT_Configuration, mdt_Activation),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_MDT_Configuration, areaScopeOfMDT),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_MDT_Configuration, mDTMode),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_MDT_Configuration, iE_Extensions),
