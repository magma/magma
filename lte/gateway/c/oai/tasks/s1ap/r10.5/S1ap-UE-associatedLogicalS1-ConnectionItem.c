...
static asn_TYPE_member_t
  asn_MBR_S1ap_UE_associatedLogicalS1_ConnectionItem_1[] = {
    ...
    {ATF_POINTER,
     1,
     offsetof(struct S1ap_UE_associatedLogicalS1_ConnectionItem, iE_Extensions),
...
static int asn_MAP_S1ap_UE_associatedLogicalS1_ConnectionItem_oms_1[] = {0,
                                                                         1,
                                                                         2};
...
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_UE_associatedLogicalS1_ConnectionItem_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionItem = {
  ...
  sizeof(asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionItem_tags_1) /
    sizeof(
      asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionItem_tags_1[0]), /* 1 */
