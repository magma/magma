...
static asn_TYPE_member_t
  asn_MBR_S1ap_SourceeNB_ToTargeteNB_TransparentContainer_1[] = {
    {ATF_NOFLAGS,
     0,
     offsetof(
       struct S1ap_SourceeNB_ToTargeteNB_TransparentContainer,
       rRC_Container),
...
static int asn_MAP_S1ap_SourceeNB_ToTargeteNB_TransparentContainer_oms_1[] = {
  1,
  3,
  5};
...
static asn_TYPE_tag2member_t
  asn_MAP_S1ap_SourceeNB_ToTargeteNB_TransparentContainer_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     1,
     0,
     0}, /* e-RABInformationList at 1115 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0}, /* targetCell-ID at 1116 */
    {(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
     3,
     0,
     0}, /* subscriberProfileIDforRFP at 1117 */
    {(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
     4,
     0,
     0}, /* uE-HistoryInformation at 1118 */
    {(ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0} /* iE-Extensions at 1120 */
};
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_SourceeNB_ToTargeteNB_TransparentContainer_specs_1 = {
