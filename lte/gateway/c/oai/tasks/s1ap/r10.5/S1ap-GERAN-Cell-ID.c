...
static asn_TYPE_member_t asn_MBR_S1ap_GERAN_Cell_ID_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GERAN_Cell_ID, lAI),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GERAN_Cell_ID, rAC),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GERAN_Cell_ID, cI),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_GERAN_Cell_ID, iE_Extensions),
