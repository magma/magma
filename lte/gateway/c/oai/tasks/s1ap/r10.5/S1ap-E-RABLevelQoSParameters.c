...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABLevelQoSParameters_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABLevelQoSParameters, qCI),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABLevelQoSParameters, allocationRetentionPriority),
  ...
  {ATF_POINTER,
   2,
   offsetof(struct S1ap_E_RABLevelQoSParameters, gbrQosInformation),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABLevelQoSParameters, iE_Extensions),
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_E_RABLevelQoSParameters_tag2el_1[] = {
  ...
  {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
   1,
   0,
   0}, /* allocationRetentionPriority at 632 */
