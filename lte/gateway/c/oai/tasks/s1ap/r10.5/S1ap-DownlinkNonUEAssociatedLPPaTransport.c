...
static int memb_s1ap_DownlinkNonUEAssociatedLPPaTransport_ies_constraint_1(
...
static asn_SET_OF_specifics_t
  asn_SPC_s1ap_DownlinkNonUEAssociatedLPPaTransport_ies_specs_2 = {
    sizeof(
      struct
      S1ap_DownlinkNonUEAssociatedLPPaTransport__s1ap_DownlinkNonUEAssociatedLPPaTransport_ies),
    offsetof(
      struct
      S1ap_DownlinkNonUEAssociatedLPPaTransport__s1ap_DownlinkNonUEAssociatedLPPaTransport_ies,
      _asn_ctx),
...
static /* Use -fall-defs-global to expose */
  asn_TYPE_descriptor_t asn_DEF_s1ap_DownlinkNonUEAssociatedLPPaTransport_ies_2 = {
    ...
    sizeof(asn_DEF_s1ap_DownlinkNonUEAssociatedLPPaTransport_ies_tags_2) /
        sizeof(
          asn_DEF_s1ap_DownlinkNonUEAssociatedLPPaTransport_ies_tags_2[0]) -
      1,                                                          /* 1 */
...
static asn_TYPE_tag2member_t
  asn_MAP_S1ap_DownlinkNonUEAssociatedLPPaTransport_tag2el_1[] = {
    {(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
     0,
     0,
     0} /* s1ap-DownlinkNonUEAssociatedLPPaTransport-ies at 397 */
};
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_DownlinkNonUEAssociatedLPPaTransport_specs_1 = {
