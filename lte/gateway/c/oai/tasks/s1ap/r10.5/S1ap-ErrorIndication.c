...
static int memb_s1ap_ErrorIndication_ies_constraint_1(
...
static asn_per_constraints_t asn_PER_type_s1ap_ErrorIndication_ies_constr_2
  GCC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_s1ap_ErrorIndication_ies_constr_2
  GCC_NOTUSED = {
    {APC_UNCONSTRAINED, -1, -1, 0, 0},
    {APC_CONSTRAINED, 16, 16, 0, 65535} /* (SIZE(0..65535)) */,
    0,
...
static /* Use -fall-defs-global to expose */
  asn_TYPE_descriptor_t asn_DEF_s1ap_ErrorIndication_ies_2 = {
    ...
    sizeof(asn_DEF_s1ap_ErrorIndication_ies_tags_2) /
        sizeof(asn_DEF_s1ap_ErrorIndication_ies_tags_2[0]) -
      1,                                     /* 1 */
...
static asn_TYPE_member_t asn_MBR_S1ap_ErrorIndication_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_ErrorIndication, s1ap_ErrorIndication_ies),
   (ASN_TAG_CLASS_CONTEXT | (0 << 2)),
   0,
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_ErrorIndication_tag2el_1[] = {
  {(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
   0,
   0,
   0} /* s1ap-ErrorIndication-ies at 212 */
};
