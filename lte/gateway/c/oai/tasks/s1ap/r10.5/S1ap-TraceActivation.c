...
static asn_TYPE_member_t asn_MBR_S1ap_TraceActivation_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_TraceActivation, e_UTRAN_Trace_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_TraceActivation, interfacesToTrace),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_TraceActivation, traceDepth),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_TraceActivation, iE_Extensions),
