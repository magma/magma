...
static asn_TYPE_member_t asn_MBR_S1ap_LAI_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_LAI, pLMNidentity),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_LAI, iE_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_S1ap_LAI = {
  ...
  sizeof(asn_DEF_S1ap_LAI_tags_1) / sizeof(asn_DEF_S1ap_LAI_tags_1[0]), /* 1 */
