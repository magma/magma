...
static int memb_nextHopChainingCount_constraint_1(
...
static asn_per_constraints_t asn_PER_memb_nextHopChainingCount_constr_2
  GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_S1ap_SecurityContext_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_SecurityContext, nextHopChainingCount),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_SecurityContext, nextHopParameter),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_SecurityContext, iE_Extensions),
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_SecurityContext_tag2el_1[] = {
  {(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
   0,
   0,
   0}, /* nextHopChainingCount at 1051 */
