...
int S1ap_RRC_Establishment_Cause_constraint(
 ...
 */
static void S1ap_RRC_Establishment_Cause_1_inherit_TYPE_descriptor(
  asn_TYPE_descriptor_t *td)
{
...
void S1ap_RRC_Establishment_Cause_free(
  asn_TYPE_descriptor_t *td,
  void *struct_ptr,
  int contents_only)
{
...
int S1ap_RRC_Establishment_Cause_print(
  asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t S1ap_RRC_Establishment_Cause_decode_ber(
...
asn_enc_rval_t S1ap_RRC_Establishment_Cause_encode_der(
  asn_TYPE_descriptor_t *td,
  void *structure,
  int tag_mode,
  ber_tlv_tag_t tag,
...
asn_dec_rval_t S1ap_RRC_Establishment_Cause_decode_xer(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  void **structure,
...
asn_enc_rval_t S1ap_RRC_Establishment_Cause_encode_xer(
  asn_TYPE_descriptor_t *td,
  void *structure,
  int ilevel,
...
asn_dec_rval_t S1ap_RRC_Establishment_Cause_decode_uper(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t S1ap_RRC_Establishment_Cause_encode_uper(
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void *structure,
...
asn_enc_rval_t S1ap_RRC_Establishment_Cause_encode_aper(
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void *structure,
  asn_per_outp_t *per_out)
...
asn_comp_rval_t *S1ap_RRC_Establishment_Cause_compare(
...
asn_dec_rval_t S1ap_RRC_Establishment_Cause_decode_aper(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void **structure,
...
static asn_per_constraints_t asn_PER_type_S1ap_RRC_Establishment_Cause_constr_1
  GCC_NOTUSED = {
