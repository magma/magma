...
static int memb_local_constraint_1(
...
static asn_per_constraints_t asn_PER_type_S1ap_PrivateIE_ID_constr_1
  GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_S1ap_PrivateIE_ID_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_PrivateIE_ID, choice.local),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_PrivateIE_ID, choice.global),
