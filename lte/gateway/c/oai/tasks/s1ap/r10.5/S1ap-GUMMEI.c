...
static asn_TYPE_member_t asn_MBR_S1ap_GUMMEI_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GUMMEI, pLMN_Identity),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GUMMEI, mME_Group_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GUMMEI, mME_Code),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_GUMMEI, iE_Extensions),
