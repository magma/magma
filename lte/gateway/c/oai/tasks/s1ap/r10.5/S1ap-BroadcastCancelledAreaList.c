...
static asn_per_constraints_t
  asn_PER_type_S1ap_BroadcastCancelledAreaList_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_S1ap_BroadcastCancelledAreaList_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_BroadcastCancelledAreaList, choice.cellID_Cancelled),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_BroadcastCancelledAreaList, choice.tAI_Cancelled),
  ...
  {ATF_NOFLAGS,
   ...
   offsetof(
     ...
     choice.emergencyAreaID_Cancelled),
...
static asn_TYPE_tag2member_t
  asn_MAP_S1ap_BroadcastCancelledAreaList_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     2,
     0,
     0} /* emergencyAreaID-Cancelled at 101 */
};
