...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABReleaseItemBearerRelComp_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABReleaseItemBearerRelComp, e_RAB_ID),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABReleaseItemBearerRelComp, iE_Extensions),
...
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_E_RABReleaseItemBearerRelComp_specs_1 = {
