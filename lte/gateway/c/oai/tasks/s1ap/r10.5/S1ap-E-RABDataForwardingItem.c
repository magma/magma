...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABDataForwardingItem_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABDataForwardingItem, e_RAB_ID),
  ...
  {ATF_POINTER,
   5,
   offsetof(struct S1ap_E_RABDataForwardingItem, dL_transportLayerAddress),
  ...
  {ATF_POINTER,
   4,
   offsetof(struct S1ap_E_RABDataForwardingItem, dL_gTP_TEID),
  ...
  {ATF_POINTER,
   3,
   offsetof(struct S1ap_E_RABDataForwardingItem, uL_TransportLayerAddress),
  ...
  {ATF_POINTER,
   2,
   offsetof(struct S1ap_E_RABDataForwardingItem, uL_GTP_TEID),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABDataForwardingItem, iE_Extensions),
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_E_RABDataForwardingItem_tag2el_1[] = {
  ...
  {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
   1,
   0,
   0}, /* dL-transportLayerAddress at 473 */
  {(ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0}, /* dL-gTP-TEID at 474 */
  {(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
   3,
   0,
   0}, /* uL-TransportLayerAddress at 475 */
