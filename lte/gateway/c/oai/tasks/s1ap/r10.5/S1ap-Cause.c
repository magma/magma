...
static asn_TYPE_member_t asn_MBR_S1ap_Cause_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cause, choice.radioNetwork),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cause, choice.transport),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cause, choice.nas),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cause, choice.protocol),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_Cause, choice.misc),
