 ...
 */
static void S1ap_GTP_TEID_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td)
{
...
asn_dec_rval_t S1ap_GTP_TEID_decode_ber(
...
asn_enc_rval_t S1ap_GTP_TEID_encode_der(
  asn_TYPE_descriptor_t *td,
  void *structure,
  int tag_mode,
  ber_tlv_tag_t tag,
...
asn_dec_rval_t S1ap_GTP_TEID_decode_xer(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  void **structure,
...
asn_enc_rval_t S1ap_GTP_TEID_encode_xer(
  asn_TYPE_descriptor_t *td,
  void *structure,
  int ilevel,
...
asn_dec_rval_t S1ap_GTP_TEID_decode_uper(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t S1ap_GTP_TEID_encode_uper(
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void *structure,
...
asn_enc_rval_t S1ap_GTP_TEID_encode_aper(
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void *structure,
  asn_per_outp_t *per_out)
...
asn_comp_rval_t *S1ap_GTP_TEID_compare(
...
asn_dec_rval_t S1ap_GTP_TEID_decode_aper(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  asn_per_constraints_t *constraints,
  void **structure,
