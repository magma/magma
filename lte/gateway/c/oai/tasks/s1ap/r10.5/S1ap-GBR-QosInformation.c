...
static asn_TYPE_member_t asn_MBR_S1ap_GBR_QosInformation_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GBR_QosInformation, e_RAB_MaximumBitrateDL),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GBR_QosInformation, e_RAB_MaximumBitrateUL),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GBR_QosInformation, e_RAB_GuaranteedBitrateDL),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_GBR_QosInformation, e_RAB_GuaranteedBitrateUL),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_GBR_QosInformation, iE_Extensions),
...
static asn_TYPE_tag2member_t asn_MAP_S1ap_GBR_QosInformation_tag2el_1[] = {
  {(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
   0,
   0,
   0}, /* e-RAB-MaximumBitrateDL at 693 */
  {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
   1,
   0,
   0}, /* e-RAB-MaximumBitrateUL at 694 */
  {(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
   2,
   0,
   0}, /* e-RAB-GuaranteedBitrateDL at 695 */
  {(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
   3,
   0,
   0}, /* e-RAB-GuaranteedBitrateUL at 696 */
