 ...
 * Decode INTEGER type.
 */
asn_dec_rval_t NativeInteger_decode_ber(
  ...
  int tag_mode)
{
  ...
  /*
	 ...
	 */
  rval = ber_check_tags(
    opt_codec_ctx, td, 0, buf_ptr, size, tag_mode, 0, &length, 0);
 ...
 */
asn_dec_rval_t NativeInteger_decode_xer(
  asn_codec_ctx_t *opt_codec_ctx,
  asn_TYPE_descriptor_t *td,
  void **sptr,
...
asn_enc_rval_t NativeInteger_encode_xer(
  asn_TYPE_descriptor_t *td,
  void *sptr,
  int ilevel,
  ...
  void *app_key)
{
  ...
  er.encoded = snprintf(
    ...
    *native);
  if (
    er.encoded <= 0 || (size_t) er.encoded >= sizeof(scratch) ||
  ...
  asn_per_outp_t *po)
{
  ...
  memset(&tmpint, 0, sizeof(tmpint));
  if (
    (specs && specs->field_unsigned) ? asn_ulong2INTEGER(&tmpint, native) :
  ...
  asn_per_outp_t *po)
{
  ...
  if (specs && specs->field_unsigned) {
    ...
    ASN_DEBUG(
      "Encoding NativeInteger %s %lu (APER) (unsigned)", td->name, native);
    ...
    ASN_DEBUG(
      "Encoding NativeInteger %s %ld (APER) (unsigned)", td->name, native);
...
void NativeInteger_free(asn_TYPE_descriptor_t *td, void *ptr, int contents_only)
{
  ...
  ASN_DEBUG(
    "Freeing %s as INTEGER (%d, %p, Native)", td->name, contents_only, ptr);
...
asn_comp_rval_t *NativeInteger_compare(
