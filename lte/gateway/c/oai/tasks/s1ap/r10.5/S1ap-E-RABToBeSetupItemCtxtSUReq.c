...
static asn_TYPE_member_t asn_MBR_S1ap_E_RABToBeSetupItemCtxtSUReq_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemCtxtSUReq, e_RAB_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemCtxtSUReq, e_RABlevelQoSParameters),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemCtxtSUReq, transportLayerAddress),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_E_RABToBeSetupItemCtxtSUReq, gTP_TEID),
  ...
  {ATF_POINTER,
   2,
   offsetof(struct S1ap_E_RABToBeSetupItemCtxtSUReq, nAS_PDU),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_E_RABToBeSetupItemCtxtSUReq, iE_Extensions),
...
static asn_TYPE_tag2member_t
  asn_MAP_S1ap_E_RABToBeSetupItemCtxtSUReq_tag2el_1[] = {
    ...
    {(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
     1,
     0,
     0}, /* e-RABlevelQoSParameters at 561 */
    {(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
     2,
     0,
     0}, /* transportLayerAddress at 562 */
...
static asn_SEQUENCE_specifics_t
  asn_SPC_S1ap_E_RABToBeSetupItemCtxtSUReq_specs_1 = {
