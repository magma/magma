...
static asn_TYPE_member_t asn_MBR_S1ap_UE_S1AP_ID_pair_1[] = {
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_UE_S1AP_ID_pair, mME_UE_S1AP_ID),
  ...
  {ATF_NOFLAGS,
   0,
   offsetof(struct S1ap_UE_S1AP_ID_pair, eNB_UE_S1AP_ID),
  ...
  {ATF_POINTER,
   1,
   offsetof(struct S1ap_UE_S1AP_ID_pair, iE_Extensions),
