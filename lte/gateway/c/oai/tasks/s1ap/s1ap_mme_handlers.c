  ...
  struct s1ap_message_s *message)
{
   ...
   */
  if (
    (message->procedureCode > (sizeof(messages_callback) /
                               (3 * sizeof(s1ap_message_decoded_callback)))) ||
   ...
   */
  if (
    messages_callback[message->procedureCode][message->direction - 1] == NULL) {
    OAILOG_DEBUG(
      LOG_S1AP,
  ...
  struct s1ap_message_s *message)
{
   ...
   */
  {
    ...
    MSC_LOG_TX_MESSAGE(
      ...
      NULL,
      0,
      "0 S1AP_UE_CAPABILITIES_IND enb_ue_s1ap_id " ENB_UE_S1AP_ID_FMT
  ...
  struct s1ap_message_s *message)
{
  ...
  MSC_LOG_TX_MESSAGE(
    ...
    NULL,
    0,
    "0 MME_APP_INITIAL_CONTEXT_SETUP_RSP mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT
    " ebi %u s1u enb teid %u",
  ...
  struct s1ap_message_s *message)
{
  ...
  */
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UE_CONTEXT_RELEASE_REQUEST ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      ueContextReleaseRequest_p->mme_ue_s1ap_id);
    OAILOG_FUNC_RETURN(LOG_S1AP, RETURNerror);
  } else {
    if (
      ...
      MSC_LOG_TX_MESSAGE(
        ...
        NULL,
        0,
        "0 S1AP_UE_CONTEXT_RELEASE_REQ mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
        S1AP_UE_CONTEXT_RELEASE_REQ(message_p).mme_ue_s1ap_id);
      rc = itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
      OAILOG_FUNC_RETURN(LOG_S1AP, rc);
    } else {
      ...
      MSC_LOG_EVENT(
        MSC_S1AP_MME,
        "0 UE_CONTEXT_RELEASE_REQUEST ignored, cause mismatch enb_ue_s1ap_id: "
        "ctxt " ENB_UE_S1AP_ID_FMT " != request " ENB_UE_S1AP_ID_FMT " ",
        ue_ref_p->enb_ue_s1ap_id,
        (uint32_t) ueContextReleaseRequest_p->eNB_UE_S1AP_ID);
      OAILOG_FUNC_RETURN(LOG_S1AP, RETURNerror);
  ...
  enum s1cause cause)
{
  ...
  if (s1ap_mme_encode_pdu(&message, &buffer, &length) < 0) {
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UEContextRelease/initiatingMessage enb_ue_s1ap_id " ENB_UE_S1AP_ID_FMT
      " mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " encoding failed",
      ue_ref_p->enb_ue_s1ap_id,
      ue_ref_p->mme_ue_s1ap_id);
...
#define PLMN_SIZE 3
  ...
  if (s1ap_mme_encode_pdu(&message, &buffer, &length) < 0) {
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UEContextModificationReq/initiatingMessage "
      "enb_ue_s1ap_id " ENB_UE_S1AP_ID_FMT " mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT
      " encoding failed",
      ue_ref_p->enb_ue_s1ap_id,
      ue_ref_p->mme_ue_s1ap_id);
  ...
  MSC_LOG_TX_MESSAGE(
    ...
    NULL,
    0,
    "0 UEContextModificationMessage/initiatingMessage "
    "enb_ue_s1ap_id " ENB_UE_S1AP_ID_FMT " mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT
    "",
    ue_ref_p->enb_ue_s1ap_id,
    ue_ref_p->mme_ue_s1ap_id);
    ...
    *const ue_context_release_command_pP)
{
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UE_CONTEXT_RELEASE_COMMAND ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      ue_context_release_command_pP->mme_ue_s1ap_id);
    rc = RETURNok;
  } else {
  ...
  const itti_s1ap_ue_context_mod_req_t *const ue_context_mod_req_pP)
{
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UE_CONTEXT_MODIFICATION REQUEST ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      ue_context_mod_req_pP->mme_ue_s1ap_id);
    rc = RETURNok;
  } else {
  ...
  struct s1ap_message_s *message)
{
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UEContextReleaseComplete ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      ueContextReleaseComplete_p->mme_ue_s1ap_id);
    OAILOG_FUNC_RETURN(LOG_S1AP, RETURNok);
  }
...
#if 0
int
s1ap_mme_handle_ue_context_mod_resp (
    __attribute__((unused)) const sctp_assoc_id_t assoc_id,
    __attribute__((unused)) const sctp_stream_id_t stream,
    struct s1ap_message_s *message)
{
  S1ap_UEContextModificationResp_t     *ueContextModResp_p = NULL;
  ue_description_t                       *ue_ref_p = NULL;
  MessageDef                             *message_p = NULL;
  ...
  struct s1ap_message_s *message)
{
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 InitialContextSetupFailure ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      initialContextSetupFailureIEs_p->mme_ue_s1ap_id);
    OAILOG_INFO(
      LOG_S1AP,
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 InitialContextSetupFailure ignored, mismatch "
  ...
  struct s1ap_message_s *message)
{
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UE_CONTEXT_MODIFICATION_RESPONSE ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      ueContextModification_p->mme_ue_s1ap_id);
    OAILOG_FUNC_RETURN(LOG_S1AP, RETURNerror);
  } else {
    if (
      ue_ref_p->enb_ue_s1ap_id ==
      ...
      MSC_LOG_TX_MESSAGE(
        ...
        NULL,
        0,
        "0 S1AP_UE_CONTEXT_MODIFICATION_RESPONSE "
        "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
        S1AP_UE_CONTEXT_MODIFICATION_RESPONSE(message_p).mme_ue_s1ap_id);
      rc = itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
      OAILOG_FUNC_RETURN(LOG_S1AP, rc);
      ...
      MSC_LOG_EVENT(
        MSC_S1AP_MME,
        "0 S1AP_UE_CONTEXT_MODIFICATION_RESPONSE ignored,cause mismatch "
        "enb_ue_s1ap_id: ctxt" ENB_UE_S1AP_ID_FMT
        " != request " ENB_UE_S1AP_ID_FMT " ",
        ue_ref_p->enb_ue_s1ap_id,
        (uint32_t) ueContextModification_p->eNB_UE_S1AP_ID);
  ...
  struct s1ap_message_s *message)
{
  ...
  if (
    ...
    MSC_LOG_EVENT(
      MSC_S1AP_MME,
      "0 UE_CONTEXT_MODIFICATION_FAILURE ignored, no context "
      "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
      ueContextModification_p->mme_ue_s1ap_id);
    OAILOG_FUNC_RETURN(LOG_S1AP, RETURNerror);
  } else {
    if (
      ...
      MSC_LOG_TX_MESSAGE(
        ...
        NULL,
        0,
        "0 S1AP_UE_CONTEXT_MODIFICATION_FAILURE "
        "mme_ue_s1ap_id " MME_UE_S1AP_ID_FMT " ",
        S1AP_UE_CONTEXT_MODIFICATION_FAILURE(message_p).mme_ue_s1ap_id);
      rc = itti_send_msg_to_task(TASK_MME_APP, INSTANCE_DEFAULT, message_p);
      OAILOG_FUNC_RETURN(LOG_S1AP, rc);
      ...
      MSC_LOG_EVENT(
        MSC_S1AP_MME,
        "0 S1AP_UE_CONTEXT_MODIFICATION_FAILURE ignored, cause mismatch "
        "enb_ue_s1ap_id: ctxt " ENB_UE_S1AP_ID_FMT
        " != request " ENB_UE_S1AP_ID_FMT " ",
        ue_ref_p->enb_ue_s1ap_id,
        (uint32_t) ueContextModification_p->eNB_UE_S1AP_ID);
  ...
  void **resultP)
{
  ...
  if (ue_ref_p) {
    enb_ue_s1ap_id = ue_ref_p->enb_ue_s1ap_id;
    S1AP_ENB_INITIATED_RESET_REQ(arg->message_p)
      .ue_to_reset_list[i]
      .mme_ue_s1ap_id = &(ue_ref_p->mme_ue_s1ap_id);
    S1AP_ENB_INITIATED_RESET_REQ(arg->message_p)
      .ue_to_reset_list[i]
...
int s1ap_handle_sctp_disconnection(const sctp_assoc_id_t assoc_id, bool reset)
{
  ...
  MSC_LOG_EVENT(
    MSC_S1AP_MME, "0 Event SCTP_CLOSE_ASSOCIATION assoc_id: %d", assoc_id);
  ...
  struct s1ap_message_s *message)
{
  ...
  if (s1ap_reset_type == RESET_PARTIAL) {
    if (enb_reset_p->resetType.choice.partOfS1_Interface.list.count == 0) {
      OAILOG_ERROR(
        LOG_S1AP,
        "Partial Reset Request without any S1 signaling connection.Ignoring it "
        "\n");
      // TBD - Here MME should send Error Indication as it is abnormal scenario.
      OAILOG_FUNC_RETURN(LOG_S1AP, RETURNerror);
    }
  ...
  AssertFatal(message_p != NULL, "itti_alloc_new_message Failed");
  memset(
    (void *) &message_p->ittiMsg.s1ap_enb_initiated_reset_req,
    0,
    sizeof(itti_s1ap_enb_initiated_reset_req_t));
  ...
  if (s1ap_reset_type == RESET_ALL) {
    ...
    S1AP_ENB_INITIATED_RESET_REQ(message_p).num_ue =
      enb_association->nb_ue_associated;
    S1AP_ENB_INITIATED_RESET_REQ(message_p).ue_to_reset_list =
      (s1_sig_conn_id_t *) calloc(
        enb_association->nb_ue_associated,
    ...
    S1AP_ENB_INITIATED_RESET_REQ(message_p).ue_to_reset_list =
      (s1_sig_conn_id_t *) calloc(
        ...
        sizeof(*(S1AP_ENB_INITIATED_RESET_REQ(message_p).ue_to_reset_list)));
    DevAssert(S1AP_ENB_INITIATED_RESET_REQ(message_p).ue_to_reset_list != NULL);
    for (i = 0; i < enb_reset_p->resetType.choice.partOfS1_Interface.list.count;
         i++) {
      s1_sig_conn_id_p =
      ...
      if (s1_sig_conn_id_p->mME_UE_S1AP_ID != NULL) {
        ...
        if ((ue_ref_p = s1ap_is_ue_mme_id_in_list(mme_ue_s1ap_id)) != NULL) {
          ...
          OAILOG_ERROR(
            LOG_S1AP,
            "Partial Reset Request - No UE context found for mme_ue_s1ap_id %d "
            "\n",
            mme_ue_s1ap_id);
          // TBD - Here MME should send Error Indication as it is abnormal scenario.
          OAILOG_FUNC_RETURN(LOG_S1AP, RETURNerror);
