...
int DeRegistrationRequestUEInitMsg::DecodeDeRegistrationRequestUEInitMsg(
  ...
  MLOG(MDEBUG) << "\n\n---Decoding De-Registration Request Message---\n"
               << endl;
  if ((decoded_result = de_reg_request->extended_protocol_discriminator
  ...
  if ((decoded_result = de_reg_request->spare_half_octet.DecodeSpareHalfOctetMsg(
...
int DeRegistrationRequestUEInitMsg::EncodeDeRegistrationRequestUEInitMsg(
  ...
  if ((encoded_result = de_reg_request->extended_protocol_discriminator
  ...
  if ((encoded_result = de_reg_request->spare_half_octet.EncodeSpareHalfOctetMsg(
