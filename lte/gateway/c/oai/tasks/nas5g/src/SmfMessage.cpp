  ...
  switch ((unsigned char) msg->header.message_type) {
    ...
    case PDU_SESSION_MODIFICATION_REQUEST:
     ...
     case PDU_SESSION_MODIFICATION_COMPLETE:
      decode_result =
          msg->pdu_session_modif_complete.DecodePDUSessionModificationCompleteMsg(
              &msg->pdu_session_modif_complete, buffer, len);
      break;
      case PDU_SESSION_MODIFICATION_COMMAND_REJECT:
      decode_result =
          msg->pdu_session_modif_command_reject.DecodePDUSessionModificationCommandRejectMsg(
              &msg->pdu_session_modif_command_reject, buffer, len);
      break;
  default:
  ...
  switch ((unsigned char) msg->header.message_type) {
    ...
    case PDU_SESSION_MODIFICATION_REJECT:
     ...
     case PDU_SESSION_MODIFICATION_COMMAND:
      encode_result =
          msg->pdu_session_modif_command.EncodePDUSessionModificationCommandMsg(
              &msg->pdu_session_modif_command, buffer, len);
      break;
