...
namespace magma5g
{
      ...
      #define REGISTRATION_ACCEPT_MINIMUM_LENGTH 5
        ...
        //PDUSessionReactivationResultErrorCauseMsg pdusessionreactivationresulterrorcause;
        ...
        GPRSTimer2Msg gprstimer2; //Non-3GPP de-registration timer value or T3502 value
        ...
        //OperatorDefinedAccessCategoryDefinitionsMsg operatordefinedaccesscategorydefinitions;
        ...
        #endif
        int DecodeRegistrationAcceptMsg (RegistrationAcceptMsg *registrationaccept, uint8_t *buffer, uint32_t len);
        int EncodeRegistrationAcceptMsg (RegistrationAcceptMsg *registrationaccept, uint8_t *buffer, uint32_t len);
    };
} //namespace magma5g
/*
...
79		LADN information						LADN information9.11.3.30	O	TLV-E	12-1715
