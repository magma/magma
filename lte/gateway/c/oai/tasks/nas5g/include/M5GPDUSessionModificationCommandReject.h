...
class PDUSessionModificationCommandRejectMsg {
 public:
#define PDU_SESSION_MODIFICATION_CMD_REJ_MIN_LEN 5
  ...
  ~PDUSessionModificationCommandRejectMsg();
  int DecodePDUSessionModificationCommandRejectMsg(
      PDUSessionModificationCommandRejectMsg* pdu_session_modif_request,
      uint8_t* buffer, uint32_t len);
  int EncodePDUSessionModificationCommandRejectMsg(
      PDUSessionModificationCommandRejectMsg* pdu_session_modif_request,
      uint8_t* buffer, uint32_t len);
};
}  // namespace magma5g
