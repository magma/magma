...
int Decode(void) {
  ...
  MLOG(MDEBUG)
      ...
      << int(AuthRes.response_parameter.response_parameter[10]) << hex
      << setw(2) << int(AuthRes.response_parameter.response_parameter[11])
      << hex << setw(2)
      << int(AuthRes.response_parameter.response_parameter[12]) << hex
      << setw(2) << int(AuthRes.response_parameter.response_parameter[13])
      << hex << setw(2)
      << int(AuthRes.response_parameter.response_parameter[14]) << hex
      << setw(2) << int(AuthRes.response_parameter.response_parameter[15])
      << endl;
