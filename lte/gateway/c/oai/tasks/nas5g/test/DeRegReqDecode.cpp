...
int decode(void) {
  ...
  MLOG(MDEBUG)
      ...
      << int(De_Req.extended_protocol_discriminator.extended_proto_discriminator);
  ...
  MLOG(MDEBUG) << "   Mobile Country Code (MCC) = " << dec
               << int(De_Req.m5gs_mobile_identity.mobile_identity.guti.mcc_digit1)
               << dec
               << int(De_Req.m5gs_mobile_identity.mobile_identity.guti.mcc_digit2)
               << dec
               << int(De_Req.m5gs_mobile_identity.mobile_identity.guti.mcc_digit3);
  MLOG(MDEBUG) << "   Mobile NetWork Code (MNC) = " << dec
               << int(De_Req.m5gs_mobile_identity.mobile_identity.guti.mnc_digit1)
               << dec
               << int(De_Req.m5gs_mobile_identity.mobile_identity.guti.mnc_digit2)
               << dec
