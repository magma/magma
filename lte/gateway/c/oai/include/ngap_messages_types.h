...
//#include "ngap_common_types.h" cobraranu contains copy of common.h
//#include "nas/securityDef.h"  cobraranu not there
...
#define NGAP_PDUSESSION_RESOURCE_SETUP_REQ(mSGpTR) (mSGpTR)->ittiMsg.ngap_pdusession_resource_setup_req
#define NGAP_PDUSESSIONRESOURCE_SETUP_RSP(mSGpTR) (mSGpTR)->ittiMsg.ngap_pdusessionresource_setup_rsp
#define NGAP_PDUSESSIONRESOURCE_REL_RSP(mSGpTR) (mSGpTR)->ittiMsg.ngap_pdusessionresource_rel_rsp
#define NGAP_PDUSESSIONRESOURCE_REL_REQ(mSGpTR) (mSGpTR)->ittiMsg.ngap_pdusessionresource_rel_req
...
//  pdu_session_resource_setup_request_transfer_t amf_pdu_ses_setup_transfer_req;//pdu_res_set_change
