...
/*****************************************************************************
  ...
  Subsystem   AMF Application Protocol IEs

  Author      Sandeep Kumar Mall

  Description Defines AMF Application Protocol Messages

*****************************************************************************/
#ifndef FILE_AMF_AS_MESSAGE_SEEN
#define FILE_AMF_AS_MESSAGE_SEEN
 ...
 */
typedef struct m5g_paging_ind_s {
  // paging_cause_t cause; /* Paging cause                 */ // TODO
} m5g_paging_ind_t;
...
typedef struct amf_as_message_s {
  ...
  union {
    ...
    // m5g_paging_ind_t 		 paging_ind; //check requrimet
...
#if 0  // TODO
    pdusession_establish_ind_t pdusession_establish_ind;
    pdusession_establish_rsp_t pdusession_establish_rsp;
    pdusession_establish_cnf_t pdusession_establish_cnf;
    pdusession_release_req_t pdusession_release_req;
    pdusession_release_ind_t pdusession_release_ind;
    deactivate_pdusession_context_req_t deactivate_pdusession_context_req;
#endif
