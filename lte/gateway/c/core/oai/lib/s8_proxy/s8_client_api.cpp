...
static void get_qos_from_proto_msg(const magma::feg::QosInformation& proto_qos,
...
static void get_fteid_from_proto_msg(const magma::feg::Fteid& proto_fteid,
                                     fteid_t* pgw_fteid) {
  OAILOG_FUNC_IN(LOG_SGW_S8);
...
static void convert_pco_to_proto_msg(protocol_configuration_options_t pco,
                                     magma::feg::CreateSessionRequestPgw* csr) {
  OAILOG_FUNC_IN(LOG_SGW_S8);
