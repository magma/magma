...
public:
   ...
   */
  static void
  location_update_request(const itti_sgsap_location_update_req_t *msg,
                          std::function<void(grpc::Status, Void)> callback);
   ...
   */
  static void
  tmsi_reallocation_complete(const itti_sgsap_tmsi_reallocation_comp_t *msg,
                             std::function<void(grpc::Status, Void)> callback);
   ...
   */
  static void
  eps_detach_indication(const itti_sgsap_eps_detach_ind_t *msg,
                        std::function<void(grpc::Status, Void)> callback);
   ...
   */
  static void
  imsi_detach_indication(const itti_sgsap_imsi_detach_ind_t *msg,
                         std::function<void(grpc::Status, Void)> callback);
   ...
   */
  static void
  ue_activity_indication(const itti_sgsap_ue_activity_ind_t *msg,
                         std::function<void(grpc::Status, Void)> callback);
   ...
   */
  static void
  send_uplink_unitdata(const itti_sgsap_uplink_unitdata_t *msg,
                       std::function<void(grpc::Status, Void)> callback);
