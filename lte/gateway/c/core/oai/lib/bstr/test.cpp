...
int test12(void) {
  ...
  try {
    ...
    c3.format("x%s%s%s%s%s%s%s%s", (const char*)c0, (const char*)c0,
              (const char*)c0, (const char*)c0, (const char*)c0,
              (const char*)c0, (const char*)c0, (const char*)c0);
    ret += c2 != c3;
...
#define bMultiConcat(dst, ...) \
  bMultiConcatNeedNULLAsLastArgument((dst), ##__VA_ARGS__, NULL)
#define bMultiCatCstr(dst, ...) \
  bMultiCatCstrNeedNULLAsLastArgument((dst), ##__VA_ARGS__, NULL)
