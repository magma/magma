...
#define DEFAULT_DNS_PRIMARY_ARRAY {0x08, 0x08, 0x08, 0x08}
#define DEFAULT_DNS_SECONDARY_HEX 0x4040808  // 8.8.4.4
#define DEFAULT_DNS_SECONDARY_ARRAY {0x08, 0x08, 0x04, 0x04}
#define DEFAULT_DNS_IPV6 "2001:4860:4860:0:0:0:0:8888"

#define DEFAULT_PCSCF_IPV4 0x96171bac  // "172.27.23.150"
#define DEFAULT_PCSCF_IPV4_ARRAY {0xac, 0x1b, 0x17, 0x96}
