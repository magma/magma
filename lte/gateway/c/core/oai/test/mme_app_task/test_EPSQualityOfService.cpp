...
TEST(test_qos_params_to_eps_qos_for_apnambr_test, qos_params_to_eps_qos_for_apnambr_test) {
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 17000000, 17000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 20000000, 20000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 128000000, 128000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 130000000, 130000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 150000000, 150000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 256000000, 256000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 260000000, 260000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 300000000, 300000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 500000000, 500000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 510000000, 510000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 600000000, 600000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 1500000000, 1500000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 1600000000, 1600000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 2000000000, 2000000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 10000000000, 10000000000, 1280000, 1280000, &eps_qos, false) ,
      RETURNok);
