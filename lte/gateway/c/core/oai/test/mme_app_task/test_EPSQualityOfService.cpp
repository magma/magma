...
TEST(
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(1, 28000, 28000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ASSERT_EQ((eps_qos.bitRates.maxBitRateForUL), 28);
  ASSERT_EQ((eps_qos.bitRates.maxBitRateForDL), 28);

  ASSERT_EQ(
      qos_params_to_eps_qos(1, 63000, 63000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ASSERT_EQ((eps_qos.bitRates.maxBitRateForUL), 63);
  ASSERT_EQ((eps_qos.bitRates.maxBitRateForDL), 63);

  ASSERT_EQ(
      qos_params_to_eps_qos(1, 72000, 72000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 568000, 568000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 575000, 575000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ASSERT_EQ((eps_qos.bitRates.maxBitRateForUL), 127);
  ASSERT_EQ((eps_qos.bitRates.maxBitRateForDL), 127);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 640000, 640000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 704000, 704000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 8640000, 8640000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
  ...
  ASSERT_EQ(
      qos_params_to_eps_qos(
          1, 8800000, 8800000, 1280000, 1280000, &eps_qos, false),
      RETURNok);
