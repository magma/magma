...
void send_s11_create_bearer_req(ebi_t lbi) {
  ...
  s11_actv_bearer_request->eps_bearer_qos.gbr.br_dl = 10000; // arbitrary number
  s11_actv_bearer_request->eps_bearer_qos.gbr.br_ul = 10000; // arbitrary number
...
void send_s1ap_handover_required(const uint32_t src_sctp_assoc_id,
                                 const uint32_t enb_id,
                                 const uint32_t enb_ue_s1ap_id,
...
void send_s1ap_handover_request_ack(const uint32_t src_sctp_assoc_id,
                                    const uint32_t enb_id,
