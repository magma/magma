...
TEST(test_pdu_session_modification, test_pdu_session_modification_request_msg) {
  ...
  pdu_sess_mod_req.requested_qosrules =
  ...
  pdu_sess_mod_req.requested_qosflowdescriptors =
  ...
  EXPECT_EQ(memcmp(pdu_sess_mod_req.requested_qosrules->data,
                   decode_pdu_sess_mod_req.requested_qosrules->data,
                   blength(pdu_sess_mod_req.requested_qosrules)),
            0);

  EXPECT_EQ(memcmp(pdu_sess_mod_req.requested_qosflowdescriptors->data,
                   decode_pdu_sess_mod_req.requested_qosflowdescriptors->data,
                   blength(pdu_sess_mod_req.requested_qosflowdescriptors)),
            0);

  bdestroy(pdu_sess_mod_req.requested_qosrules);
  bdestroy(decode_pdu_sess_mod_req.requested_qosrules);
  bdestroy(pdu_sess_mod_req.requested_qosflowdescriptors);
  bdestroy(decode_pdu_sess_mod_req.requested_qosflowdescriptors);
}
