...
Status S6aGatewayImpl::CancelLocation(ServerContext* context,
  ...
  OAILOG_INFO(LOG_MME_APP, "Received CLR for %s of type %d\n ", imsi.c_str(),
              cancellation_type);
...
Status S6aGatewayImpl::Reset(ServerContext* context,
