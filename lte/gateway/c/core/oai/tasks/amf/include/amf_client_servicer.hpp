...
public:
  ...
  virtual status_code_e
  amf_smf_create_pdu_session(char *imsi, uint8_t *apn, uint32_t pdu_session_id,
  ...
  virtual status_code_e
  n11_update_location_req(const s6a_update_location_req_t *const ulr_p);
