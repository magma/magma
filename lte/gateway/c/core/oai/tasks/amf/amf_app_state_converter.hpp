...
public:
  ...
  static void
  ue_m5gmm_context_to_proto(const ue_m5gmm_context_t *state_ue_m5gmm_context,
                            UeContext *ue_context_proto);

  static void
  proto_to_ue_m5gmm_context(const UeContext &ue_context_proto,
                            ue_m5gmm_context_t *state_ue_m5gmm_context);

  static void
  smf_context_to_proto(const smf_context_t *state_smf_context,
                       magma::lte::oai::SmfContext *smf_context_proto);

  static void
  proto_to_smf_context(const magma::lte::oai::SmfContext &smf_context_proto,
                       smf_context_t *state_smf_context);

  static void
  smf_proc_data_to_proto(const smf_proc_data_t *state_smf_proc_data,
  ...
  static void
  identity_tuple_to_proto(const NodeType *state_identity,
                          magma::lte::oai::IdentityTuple *identity_proto,
                          int size) {
  ...
  template <typename NodeType>
  static void
  proto_to_identity_tuple(const magma::lte::oai::IdentityTuple &identity_proto,
