...
status_code_e
emm_proc_attach_request(mme_ue_s1ap_id_t ue_id, const bool ctx_is_new,
...
status_code_e
emm_proc_security_mode_control(struct emm_context_s *emm_context,
                               nas_emm_specific_proc_t *const emm_specific_proc,
                               ksi_t ksi, success_cb_t success,
                               failure_cb_t failure);
status_code_e
emm_proc_security_mode_complete(mme_ue_s1ap_id_t ue_id,
