 ...
 */
typedef int (*esm_proc_procedure_t)(const bool, struct emm_context_s *const,
                                    const ebi_t, bstring *, const bool);
...
status_code_e
esm_proc_esm_information_request(emm_context_t *const emm_context_p,
                                 const pti_t pti);
...
status_code_e
esm_proc_dedicated_eps_bearer_context_accept(emm_context_t *emm_context,
                                             ebi_t ebi, esm_cause_t *esm_cause);
status_code_e
