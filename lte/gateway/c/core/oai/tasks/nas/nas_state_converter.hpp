...
public:
  ...
  static void
  esm_ebr_context_to_proto(const esm_ebr_context_t &state_esm_ebr_context,
                           oai::EsmEbrContext *esm_ebr_context_proto);

  static void
  proto_to_esm_ebr_context(const oai::EsmEbrContext &esm_ebr_context_proto,
  ...
  static void
  proto_to_nas_emm_smc_proc(const oai::SmcProc &smc_proc_proto,
                            nas_emm_smc_proc_t *state_nas_emm_smc_proc);

  static void
  proto_to_nas_emm_auth_proc(const oai::AuthProc &auth_proc_proto,
                             nas_emm_auth_proc_t *state_nas_emm_auth_proc);

private:
  static void
  partial_tai_list_to_proto(const partial_tai_list_t *state_partial_tai_list,
                            oai::PartialTaiList *partial_tai_list_proto);

  static void
  proto_to_partial_tai_list(const oai::PartialTaiList &partial_tai_list_proto,
  ...
  static void
  proto_to_esm_proc_data(const oai::EsmProcData &esm_proc_data_proto,
  ...
  static void
  nas_attach_proc_to_proto(const nas_emm_attach_proc_t *state_nas_attach_proc,
  ...
  static void
  nas_emm_tau_proc_to_proto(const nas_emm_tau_proc_t *state_nas_emm_tau_proc,
                            oai::NasTauProc *nas_tau_proc_proto);

  static void
  proto_to_nas_emm_tau_proc(const oai::NasTauProc &nas_tau_proc_proto,
                            nas_emm_tau_proc_t *state_nas_emm_tau_proc);

  static void
  nas_emm_auth_proc_to_proto(const nas_emm_auth_proc_t *state_nas_emm_auth_proc,
                             oai::AuthProc *auth_proc_proto);

  static void
  nas_emm_smc_proc_to_proto(const nas_emm_smc_proc_t *state_nas_emm_smc_proc,
  ...
  static void
  proto_to_nas_base_proc(const oai::NasBaseProc &nas_base_proc_proto,
  ...
  static void
  emm_common_proc_to_proto(const emm_procedures_t *state_emm_procedures,
                           oai::EmmProcedures *emm_procedures_proto);

  static void
  insert_proc_into_emm_common_procs(emm_procedures_t *state_emm_procedures,
                                    nas_emm_common_proc_t *emm_com_proc);

  static void
  proto_to_emm_common_proc(const oai::EmmProcedures &emm_procedures_proto,
                           emm_context_t *state_emm_context);

  static void
  eutran_vectors_to_proto(eutran_vector_t **state_eutran_vector_array,
                          uint8_t num_vectors,
                          oai::AuthInfoProc *auth_info_proc_proto);

  static void
  proto_to_eutran_vectors(const oai::AuthInfoProc &auth_info_proc_proto,
                          nas_auth_info_proc_t *state_nas_auth_info_proc);

  static void
  nas_auth_info_proc_to_proto(nas_auth_info_proc_t *state_nas_auth_info_proc,
                              oai::AuthInfoProc *auth_info_proc_proto);

  static void
  proto_to_nas_auth_info_proc(const oai::AuthInfoProc &auth_info_proc_proto,
                              nas_auth_info_proc_t *state_nas_auth_info_proc);

  static void
  nas_cn_procs_to_proto(const emm_procedures_t *state_emm_procedures,
                        oai::EmmProcedures *emm_procedures_proto);
  ...
  static void
  proto_to_nas_cn_proc(const oai::EmmProcedures &emm_procedures_proto,
                       emm_procedures_t *state_emm_procedures);

  static void
  mess_sign_array_to_proto(const emm_procedures_t *state_emm_procedures,
                           oai::EmmProcedures *emm_procedures_proto);

  static void
  proto_to_mess_sign_array(const oai::EmmProcedures &emm_procedures_proto,
                           emm_procedures_t *state_emm_procedures);

  static void
  emm_procedures_to_proto(const emm_procedures_t *state_emm_procedures,
                          oai::EmmProcedures *emm_procedures_proto);

  static void
  proto_to_emm_procedures(const oai::EmmProcedures &emm_procedures_proto,
                          emm_context_t *state_emm_context);

  static void
  auth_vectors_to_proto(const auth_vector_t *state_auth_vector_array,
                        int num_vectors, oai::EmmContext *emm_context_proto);
  ...
  static void
  nw_detach_data_to_proto(nw_detach_data_t *detach_timer_arg,
                          oai::NwDetachData *detach_timer_arg_proto);

  static void
  proto_to_nw_detach_data(const oai::NwDetachData &detach_timer_arg_proto,
                          nw_detach_data_t **detach_timer_arg);

  static void
  new_attach_info_to_proto(const new_attach_info_t *state_new_attach_info,
                           oai::NewAttachInfo *proto_new_attach_info);

  static void
  proto_to_new_attach_info(const oai::NewAttachInfo &proto_new_attach_info,
