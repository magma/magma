...
static const SGWCauseMapping_t causes[] = {
    ...
    {SERVICE_NOT_SUPPORTED, (char*)"Service not supported", 0, 0, 1, 0},
    {SYSTEM_FAILURE, (char*)"System failure", 1, 1, 1, 0},
    {NO_RESOURCES_AVAILABLE, (char*)"No resources available", 1, 0, 0, 0},
    {MISSING_OR_UNKNOWN_APN, (char*)"Missing or unknown APN", 1, 0, 0, 0},
    {GRE_KEY_NOT_FOUND, (char*)"GRE KEY not found", 1, 0, 0, 0},
    {DENIED_IN_RAT, (char*)"Denied in RAT", 1, 1, 0, 0},
