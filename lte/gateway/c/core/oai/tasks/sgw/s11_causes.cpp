...
static const SGWCauseMapping_t causes[] = {
    ...
    {NEW_PDN_TYPE_NW_PREF,
     const_cast<char *>("New PDN type network preference"), 1, 0, 0, 0},
    ...
    {SERVICE_NOT_SUPPORTED, const_cast<char *>("Service not supported"), 0, 0,
     1, 0},
    ...
    {NO_MEMORY_AVAILABLE, const_cast<char *>("No memory available"), 1, 1, 1,
     0},
    ...
    {M_PDN_APN_NOT_ALLOWED,
     const_cast<char *>("Multiple PDN for a given APN not allowed"), 1, 0, 0,
     0},
    {0, NULL, 0, 0, 0, 0},
};
