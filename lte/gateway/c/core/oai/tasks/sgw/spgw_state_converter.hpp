...
public:
   ...
   */
  static void
  proto_to_traffic_flow_template(const oai::TrafficFlowTemplate &tft_proto,
...
private:
   ...
   */
  static void
  spgw_bearer_context_to_proto(const oai::S11BearerContext *spgw_bearer_state,
   ...
   */
  static void
  proto_to_spgw_bearer_context(const oai::S11BearerContext &spgw_bearer_proto,
   ...
   */
  static void
  proto_to_sgw_eps_bearer(const oai::SgwEpsBearerContext &eps_bearer_proto,
   ...
   */
  static void
  proto_to_eps_bearer_qos(const oai::SgwBearerQos &eps_bearer_qos_proto,
   ...
   */
  static void
  proto_to_packet_filter(const oai::PacketFilter &packet_filter_proto,
