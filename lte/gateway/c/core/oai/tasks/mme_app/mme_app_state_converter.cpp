...
void MmeNasStateConverter::ue_context_to_proto(
  ...
  mme_app_timer_to_proto(state_ue_context->mobile_reachability_timer,
                         ue_context_proto->mutable_mobile_reachability_timer());
  mme_app_timer_to_proto(state_ue_context->implicit_detach_timer,
  ...
  mme_app_timer_to_proto(state_ue_context->paging_response_timer,
                         ue_context_proto->mutable_paging_response_timer());
  ue_context_proto->set_rau_tau_timer(state_ue_context->rau_tau_timer);
  mme_app_timer_to_proto(state_ue_context->ulr_response_timer,
...
void MmeNasStateConverter::proto_to_ue_mm_context(
  ...
  proto_to_mme_app_timer(ue_context_proto.mobile_reachability_timer(),
                         &state_ue_mm_context->mobile_reachability_timer);
  proto_to_mme_app_timer(ue_context_proto.implicit_detach_timer(),
                         &state_ue_mm_context->implicit_detach_timer);
  proto_to_mme_app_timer(ue_context_proto.initial_context_setup_rsp_timer(),
                         &state_ue_mm_context->initial_context_setup_rsp_timer);
  proto_to_mme_app_timer(ue_context_proto.ue_context_modification_timer(),
                         &state_ue_mm_context->ue_context_modification_timer);
  proto_to_mme_app_timer(ue_context_proto.ulr_response_timer(),
                         &state_ue_mm_context->ulr_response_timer);
  proto_to_mme_app_timer(ue_context_proto.paging_response_timer(),
