...
static int handle_message(zloop_t *loop, zsock_t *reader, void *arg) {
  ...
  case MME_APP_UPLINK_DATA_IND: {
    nas_proc_ul_transfer_ind(MME_APP_UL_DATA_IND(received_message_p).ue_id,
  ...
  case S11_CREATE_BEARER_REQUEST: {
    mme_app_handle_s11_create_bearer_req(
        mme_app_desc_p, &received_message_p->ittiMsg.s11_create_bearer_request);
    is_task_state_same = true;
  } break;
  ...
  case S11_MODIFY_BEARER_RESPONSE: {
    ...
    OAILOG_INFO(LOG_MME_APP, "Received S11 MODIFY BEARER RESPONSE from SPGW\n");
  ...
  case SGSAP_LOCATION_UPDATE_ACC: {
    ...
    mme_app_handle_sgsap_location_update_acc(
        mme_app_desc_p, &received_message_p->ittiMsg.sgsap_location_update_acc);
    is_task_state_same = true;
  } break;
  ...
  case SGSAP_LOCATION_UPDATE_REJ: {
    ...
    mme_app_handle_sgsap_location_update_rej(
        mme_app_desc_p, &received_message_p->ittiMsg.sgsap_location_update_rej);
  } break;
  ...
  case S6A_AUTH_INFO_ANS: {
     ...
     */
    nas_proc_authentication_info_answer(mme_app_desc_p,
...
static void *mme_app_thread(__attribute__((unused)) void *args) {
  ...
  const task_id_t peer_task_id[] = {TASK_SPGW_APP,   TASK_SGS, TASK_SMS_ORC8R,
                                    TASK_S11,        TASK_S6A, TASK_S1AP,
                                    TASK_SERVICE303, TASK_HA,  TASK_SGW_S8};
  init_task_context(TASK_MME_APP, peer_task_id, 9, handle_message,
