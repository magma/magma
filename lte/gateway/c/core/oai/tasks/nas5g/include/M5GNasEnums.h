...
enum class M5GMessageType : uint8_t {
  REG_REQUEST = 0b01000001,
  REG_ACCEPT = 0b01000010,
  REG_COMPLETE = 0b01000011,
  REG_REJECT = 0b01000100,
  DE_REG_REQUEST_UE_ORIGIN = 0b01000101,
  DE_REG_ACCEPT_UE_ORIGIN = 0b01000110,
  DEREGISTRATION_REQUEST_UE_TERMINATED = 0b01000111,
  DEREGISTRATION_ACCEPT_UE_TERMINATED = 0b01001000,
  M5G_SERVICE_REQUEST = 0b01001100,
  M5G_SERVICE_REJECT = 0b01001101,
  M5G_SERVICE_ACCEPT = 0b01001110,
  CONFIGURATION_UPDATE_COMMAND = 0b01010100,
  CONFIGURATION_UPDATE_COMPLETE = 0b01010101,
  AUTH_REQUEST = 0b01010110,
  AUTH_RESPONSE = 0b01010111,
  AUTH_REJECT = 0b01011000,
  AUTH_FAILURE = 0b01011001,
  AUTH_RESULT = 0b01011010,
  M5G_IDENTITY_REQUEST = 0b01011011,
  M5G_IDENTITY_RESPONSE = 0b01011100,
  SEC_MODE_COMMAND = 0b01011101,
  SEC_MODE_COMPLETE = 0b01011110,
  SEC_MODE_REJECT = 0b01011111,
  FIVEG_MM_STATUS = 0b01100100,
  NOTIFICATION = 0b01100101,
  NOTIFICATION_RESPONSE = 0b01100110,
  ULNASTRANSPORT = 0b01100111,
  DLNASTRANSPORT = 0b01101000,
