...
status_code_e s1ap_mme_generate_ue_context_modification(
  ...
  S1AP_FIND_PROTOCOLIE_BY_ID(S1ap_UEContextModificationRequestIEs_t, ie,
                             container, S1ap_ProtocolIE_ID_id_RegisteredLAI,
                             true);
...
status_code_e s1ap_handle_path_switch_req_failure(
  ...
  S1AP_FIND_PROTOCOLIE_BY_ID(S1ap_PathSwitchRequestFailureIEs_t, ie, container,
                             S1ap_ProtocolIE_ID_id_MME_UE_S1AP_ID, true);
  mme_ue_s1ap_id = ie->value.choice.MME_UE_S1AP_ID;
  if ((ie) &&
