...
static inline status_code_e s1ap_mme_encode_initiating(S1ap_S1AP_PDU_t *pdu,
                                                       uint8_t **buffer,
                                                       uint32_t *length);
static inline status_code_e
s1ap_mme_encode_successful_outcome(S1ap_S1AP_PDU_t *pdu, uint8_t **buffer,
                                   uint32_t *len);
static inline status_code_e
s1ap_mme_encode_unsuccessful_outcome(S1ap_S1AP_PDU_t *pdu, uint8_t **buffer,
                                     uint32_t *len);
//------------------------------------------------------------------------------
