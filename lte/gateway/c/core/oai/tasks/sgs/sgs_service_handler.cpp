...
status_code_e handle_sgs_imsi_detach_ack(
  ...
  memset((void *)sgs_imsi_detach_ack_p, 0,
...
status_code_e
handle_sgs_release_req(const itti_sgsap_release_req_t *sgs_release_req_p) {
  status_code_e rc = RETURNok;
...
status_code_e
handle_sgs_status_message(const itti_sgsap_status_t *sgs_status_pP) {
  MessageDef *message_p = NULL;
  status_code_e rc = RETURNok;
  OAILOG_FUNC_IN(LOG_SGS);
