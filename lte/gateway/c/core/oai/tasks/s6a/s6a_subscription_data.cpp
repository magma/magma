...
static inline int
s6a_parse_network_access_mode(struct avp_hdr *hdr_network_am,
...
static inline int
s6a_parse_access_restriction_data(struct avp_hdr *hdr_access_restriction,
...
static inline int
s6a_parse_service_selection(struct avp_hdr *hdr_service_selection,
                            char *service_selection, int *length) {
  DevCheck(hdr_service_selection->avp_value->os.len <=
...
static inline int
s6a_parse_pre_emp_capability(struct avp_hdr *hdr,
...
static inline int
s6a_parse_allocation_retention_priority(struct avp *avp_arp,
...
static inline int
s6a_parse_eps_subscribed_qos_profile(struct avp *avp_qos,
...
static inline int
s6a_parse_apn_configuration_profile(struct avp *avp_apn_conf_prof,
