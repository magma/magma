...
status_code_e s6a_fd_init_dict_objs(void) {
   ...
   */
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Purge-UE-Request", &s6a_fd_cnf.dataobj_s6a_pur,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Purge-UE-Answer", &s6a_fd_cnf.dataobj_s6a_pua,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Reset-Request", &s6a_fd_cnf.dataobj_s6a_rsr,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_COMMAND, CMD_BY_NAME,
                              "Reset-Answer", &s6a_fd_cnf.dataobj_s6a_rsa,
                              ENOENT));
  /*
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP, AVP_BY_NAME,
                              "User-Name", &s6a_fd_cnf.dataobj_s6a_user_name,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP, AVP_BY_NAME,
                              "Session-Id", &s6a_fd_cnf.dataobj_s6a_session_id,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP, AVP_BY_NAME,
                              "Vendor-Id", &s6a_fd_cnf.dataobj_s6a_vendor_id,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(
  ...
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP,
                              ...
                              &s6a_fd_cnf.dataobj_s6a_supported_features,
                              ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP,
                              AVP_BY_NAME_ALL_VENDORS, "Feature-List-ID",
                              &s6a_fd_cnf.dataobj_s6a_feature_list_id, ENOENT));
  CHECK_FD_FCT(fd_dict_search(fd_g_config->cnf_dict, DICT_AVP,
                              AVP_BY_NAME_ALL_VENDORS, "Feature-List",
  ...
  when.app = s6a_fd_cnf.dataobj_s6a_app;
  CHECK_FD_FCT(fd_disp_register(s6a_clr_cb, DISP_HOW_CC, &when, NULL,
                                &s6a_fd_cnf.clr_hdl));
  ...
  when.app = s6a_fd_cnf.dataobj_s6a_app;
  CHECK_FD_FCT(fd_disp_register(s6a_pua_cb, DISP_HOW_CC, &when, NULL,
                                &s6a_fd_cnf.pua_hdl));
  ...
  when.app = s6a_fd_cnf.dataobj_s6a_app;
  CHECK_FD_FCT(fd_disp_register(s6a_rsr_cb, DISP_HOW_CC, &when, NULL,
                                &s6a_fd_cnf.rsr_hdl));
