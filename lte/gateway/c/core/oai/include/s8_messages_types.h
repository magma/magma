...
typedef struct s8_create_session_response_s {
  ...
  teid_t sgw_s8_up_teid;  // Orc8r generates sgw's s8 interface's user plane
                          // teid and shares the sgw_s8u_teid in create session
                          // response for default bearer
...
typedef struct s8_create_bearer_request_s {
  ...
  teid_t sgw_s8_up_teid;  // Orc8r generates sgw's s8 interface's user plane
                          // teid and shares the sgw_s8u_teid in create bearer
                          // request for dedicated bearer
