...
MESSAGE_DEF(S8_CREATE_BEARER_REQ, s8_create_bearer_request_t,
            s8_create_bearer_req)
MESSAGE_DEF(S8_DELETE_BEARER_REQ, s8_delete_bearer_request_t,
            s8_delete_bearer_req)
