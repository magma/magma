...
TEST_F(LocalEnforcerTest, test_init_cwf_session_credit) {
  ...
  EXPECT_CALL(
      *pipelined_client, activate_flows_for_rules(
                             IMSI1, testing::_, testing::_, testing::_, CheckCount(0),
  ...
  EXPECT_CALL(
      *pipelined_client,
      deactivate_flows_for_rules(
          IMSI1, testing::_, testing::_, std::vector<std::string>{"rule1"}, CheckCount(0),
          testing::_))
      .Times(1)
      .WillOnce(testing::Return(true));
  local_enforcer->update_session_credits_and_rules(
...
TEST_F(LocalEnforcerTest, test_dynamic_rule_actions) {
  ...
  EXPECT_CALL(
      *pipelined_client,
      deactivate_flows_for_rules(
          testing::_, testing::_, testing::_, CheckCount(2), CheckCount(1), testing::_))
      .Times(1)
      .WillOnce(testing::Return(true));
  std::vector<std::unique_ptr<ServiceAction>> actions;
  auto usage_updates =
  ...
  EXPECT_CALL(
      *pipelined_client,
      activate_flows_for_rules(
          IMSI1, testing::_, testing::_,  testing::_, std::vector<std::string>{"pcrf_only"},
          CheckCount(0), testing::_))
      .Times(1)
      .WillOnce(testing::Return(true));
  local_enforcer->update_session_credits_and_rules(
...
TEST_F(LocalEnforcerTest, test_dedicated_bearer_lifecycle) {
  ...
  EXPECT_CALL(
      *pipelined_client,
      deactivate_flows_for_rules(
          IMSI1, testing::_, testing::_, CheckSubset(rule_ids), CheckCount(0), testing::_))
      .Times(0);
  local_enforcer->bind_policy_to_bearer(
      session_map, bearer_bind_req_success1, update);
  local_enforcer->bind_policy_to_bearer(
  ...
  EXPECT_CALL(
      *pipelined_client,
      deactivate_flows_for_rules(
          IMSI1, testing::_, testing::_, std::vector<std::string>{"rule2"},
          CheckCount(0), testing::_))
      .Times(1);
  EXPECT_CALL(
      *spgw_client, delete_dedicated_bearer(CheckDeleteOneBearerReq(
...
TEST_F(LocalEnforcerTest, test_set_session_rules) {
  ...
  EXPECT_CALL(
      *pipelined_client,
      deactivate_flows_for_rules(
          IMSI1, testing::_, testing::_, std::vector<std::string>{"static2"},
  ...
  EXPECT_CALL(
      *pipelined_client, setup_cwf(
                             CheckSessionInfos(
                                 ...
                                 test_cwf_cfg2, static_rule_list,
                                 dynamic_rule_list),
...
TEST_F(LocalEnforcerTest, test_pipelined_lte_setup) {
  ...
  EXPECT_CALL(
      *pipelined_client, setup_lte(
                             CheckSessionInfos(
                                imsi_list, ip_address_list, ipv6_address_list,
                                test_cfg_, static_rule_list, dynamic_rule_list),
                             testing::_, testing::_))
      .Times(1)
      .WillOnce(testing::Return(true));
...
TEST_F(LocalEnforcerTest, test_final_unit_activation_and_canceling) {
  ...
  EXPECT_CALL(
      *pipelined_client,
      activate_flows_for_rules(
          IMSI1, ip_addr, ipv6_addr, testing::_, CheckCount(2), CheckCount(1), testing::_))
      .Times(1)
      .WillOnce(testing::Return(true));
  ...
  EXPECT_CALL(
      *pipelined_client,
      activate_flows_for_rules(
          IMSI1, ip_addr, ipv6_addr, testing::_, testing::_, testing::_, testing::_))
      .Times(1)
      .WillOnce(testing::Return(true));
  actions.clear();
  local_enforcer->collect_updates(session_map, actions, update);
