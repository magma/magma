...
TEST_F(SessiondTest, end_to_end_cloud_down) {
  ...
  auto records2 = table2.mutable_records();
  create_rule_record(IMSI1, agw_teid, "rule1", 512, 512, records2->Add());
  create_rule_record(IMSI1, agw_teid, "rule2", 512, 512, records2->Add());
