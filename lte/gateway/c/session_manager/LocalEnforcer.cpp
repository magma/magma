      ...
      [=] {
        ...
        pipelined_client_->activate_flows_for_rules(
            ...
            std::bind(&LocalEnforcer::handle_activate_ue_flows_callback, this,
                      imsi, ip_addr, ipv6_addr, teids, _1, _2));
...
void LocalEnforcer::handle_session_activate_rule_updates(
  ...
  propagate_rule_updates_to_pipelined(config, pending_activation,
...
void LocalEnforcer::remove_rules_for_suspended_credit(
  ...
  propagate_rule_updates_to_pipelined(session->get_config(), RulesToProcess{},
...
void LocalEnforcer::add_rules_for_unsuspended_credit(
  ...
  propagate_rule_updates_to_pipelined(session->get_config(), rules_to_add,
...
void LocalEnforcer::init_policy_reauth_for_session(
  ...
  propagate_rule_updates_to_pipelined(session->get_config(), pending_activation,
                                      pending_deactivation, false);
...
void LocalEnforcer::remove_rule_due_to_bearer_creation_failure(
  ...
  if (remove_info) {
    ...
    propagate_rule_updates_to_pipelined(session.get_config(), {},
                                        pending_deactivation, false);
  }
}
