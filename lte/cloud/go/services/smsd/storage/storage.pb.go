...
type SMS struct {
	...
	CreatedTime *timestamppb.Timestamp `protobuf:"bytes,20,opt,name=createdTime,proto3" json:"createdTime,omitempty"`
	// time that we last tried delivering this message. if status is delivered,
	// this will be the delivery time
	LastDeliveryAttemptTime *timestamppb.Timestamp `protobuf:"bytes,21,opt,name=lastDeliveryAttemptTime,proto3" json:"lastDeliveryAttemptTime,omitempty"`
...
func (x *SMS) GetCreatedTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *SMS) GetLastDeliveryAttemptTime() *timestamppb.Timestamp {
	if x != nil {
