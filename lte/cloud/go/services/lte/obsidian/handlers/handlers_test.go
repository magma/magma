...
func TestCreateNetworkProbeTask(t *testing.T) {
	...
	payload := &lteModels.NetworkProbeTask{
		TaskID: "test",
		TaskDetails: &lteModels.NetworkProbeTaskDetails{
			TargetID:      "test",
			TargetType:    "imsi",
			DeliveryType:  "all",
...
func TestListNetworkProbeTasks(t *testing.T) {
	...
	tc := tests.Test{
		...
		ParamValues:    []string{"n1"},
		ExpectedStatus: 200,
		ExpectedResult: tests.JSONMarshaler(map[string]*lteModels.NetworkProbeTask{}),
	}
	tests.RunUnitTest(t, e, tc)
		...
		[]configurator.NetworkEntity{
			{
				Key:  "IMSI1234",
				Type: lte.NetworkProbeTaskEntityType,
				Config: &lteModels.NetworkProbeTaskDetails{
					TargetID:      "IMSI1234",
					TargetType:    "imsi",
...
func TestGetNetworkProbeTask(t *testing.T) {
	...
	tc = tests.Test{
		...
		ParamValues:    []string{"n1", "IMSI1234"},
		ExpectedStatus: 200,
		ExpectedResult: &lteModels.NetworkProbeTask{
			TaskID: "IMSI1234",
			TaskDetails: &lteModels.NetworkProbeTaskDetails{
				TargetID:      "IMSI1234",
				TargetType:    "imsi",
...
func TestCreateNetworkProbeDestination(t *testing.T) {
	...
	payload := &lteModels.NetworkProbeDestination{
		DestinationID: "test",
		DestinationDetails: &lteModels.NetworkProbeDestinationDetails{
...
func TestListNetworkProbeDestinations(t *testing.T) {
	...
	tc := tests.Test{
		...
		ParamValues:    []string{"n1"},
		ExpectedStatus: 200,
		ExpectedResult: tests.JSONMarshaler(map[string]*lteModels.NetworkProbeDestination{}),
	}
	tests.RunUnitTest(t, e, tc)
		...
		[]configurator.NetworkEntity{
			{
				Key:  "1111-2222-3333",
				Type: lte.NetworkProbeDestinationEntityType,
				Config: &lteModels.NetworkProbeDestinationDetails{
					DeliveryAddress: "127.0.0.1:4000",
					DeliveryType:    "all",
				},
			},
...
func TestGetNetworkProbeDestination(t *testing.T) {
	...
	tc = tests.Test{
		...
		ParamValues:    []string{"n1", "1111-2222-3333"},
		ExpectedStatus: 200,
		ExpectedResult: &lteModels.NetworkProbeDestination{
			DestinationID: "1111-2222-3333",
			DestinationDetails: &lteModels.NetworkProbeDestinationDetails{
				DeliveryAddress: "127.0.0.1:4000",
				DeliveryType:    "all",
