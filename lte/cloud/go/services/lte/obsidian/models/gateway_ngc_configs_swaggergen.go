...
func (m *GatewayNgcConfigs) validateAmfDefaultSd(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("amf_default_sd", "body", string(m.AmfDefaultSd), `^[A-Fa-f0-9]{1,6}$`); err != nil {
		return err
	}
...
func (m *GatewayNgcConfigs) validateAmfDefaultSst(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("amf_default_sst", "body", int64(m.AmfDefaultSst), 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("amf_default_sst", "body", int64(m.AmfDefaultSst), 255, false); err != nil {
		return err
	}
...
func (m *GatewayNgcConfigs) validateAmfPointer(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("amf_pointer", "body", string(m.AmfPointer), `^[0-3][A-Fa-f0-9]{0,1}$`); err != nil {
		return err
	}
...
func (m *GatewayNgcConfigs) validateAmfRegionID(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("amf_region_id", "body", string(m.AmfRegionID), `^[A-Fa-f0-9]{1,2}$`); err != nil {
		return err
	}
...
func (m *GatewayNgcConfigs) validateAmfSetID(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("amf_set_id", "body", string(m.AmfSetID), `^[0-3][A-Fa-f0-9]{0,2}$`); err != nil {
		return err
	}
