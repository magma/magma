...
// All implementations should embed UnimplementedEnodebStateLookupServer
...
// UnimplementedEnodebStateLookupServer should be embedded to have forward compatible implementations.
