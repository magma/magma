...
func (m *NetworkRanConfigs) validateSpecialSubframePattern(formats strfmt.Registry) error {
...
func (m *NetworkRanConfigs) validateSubframeAssignment(formats strfmt.Registry) error {
