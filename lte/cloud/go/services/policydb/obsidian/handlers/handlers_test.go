...
func TestPolicyDBHandlers(t *testing.T) {
	...
	listPolicies := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/rules", obsidian.GET).HandlerFunc
	createPolicy := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/rules", obsidian.POST).HandlerFunc
	getPolicy := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/rules/:rule_id", obsidian.GET).HandlerFunc
	updatePolicy := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/rules/:rule_id", obsidian.PUT).HandlerFunc
	deletePolicy := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/rules/:rule_id", obsidian.DELETE).HandlerFunc
	listNames := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/base_names", obsidian.GET).HandlerFunc
	createName := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/base_names", obsidian.POST).HandlerFunc
	getName := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/base_names/:base_name", obsidian.GET).HandlerFunc
	updateName := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/base_names/:base_name", obsidian.PUT).HandlerFunc
	deleteName := tests.GetHandlerByPathAndMethod(t, obsidianHandlers, "/magma/networks/:network_id/policies/base_names/:base_name", obsidian.DELETE).HandlerFunc
	// Test empty response
	tc := tests.Test{
		Method:         "GET",
	...
	testRule.FlowList = []*models.FlowDescription{
		{Action: swag.String("PERMIT"), Match: &models.FlowMatch{IPProto: swag.String("IPPROTO_ICMP"), Direction: "DOWNLINK"}},
	}
