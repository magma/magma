...
func main() {
	...
	subscriber := []subscriberdb_storage.Blob{{
		Key:     "wonderful_IMSI",
	...
	err = subscriberStateStore.SetSubscribers("1", "snowflake_ID", subscriber)
	if err != nil {
		glog.Fatalf("Error writing subscriber to database: %+v", err)
	}
