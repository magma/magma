...
type SingleEnodebStatus struct {
	...
	GpsAititude          string                            `protobuf:"bytes,14,opt,name=gps_aititude,json=gpsAititude,proto3" json:"gps_aititude,omitempty"`
...
func (m *SingleEnodebStatus) GetGpsAititude() string {
	if m != nil {
		return m.GpsAititude
	}
	return ""
}
...
var fileDescriptor_b803bda4b235859b = []byte{
	...
	0x95, 0x74, 0xa9, 0x7e, 0xb1, 0x02, 0x33, 0x47, 0x01, 0xcd, 0x1c, 0xd5, 0xe7, 0x8e, 0xba, 0x19,
	...
	0xd1, 0x3c, 0x8f, 0xff, 0x0b, 0x00, 0x00, 0xff, 0xff, 0x3e, 0x0e, 0x0d, 0x26, 0x7b, 0x09, 0x00,
	0x00,
}
