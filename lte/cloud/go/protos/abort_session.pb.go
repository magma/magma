...
func (AbortSessionResult_Code) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_abort_session_27a0fefc3f1d6547, []int{1, 0}
}
...
func (*AbortSessionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_abort_session_27a0fefc3f1d6547, []int{0}
}
...
func (dst *AbortSessionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AbortSessionRequest.Merge(dst, src)
}
...
func (*AbortSessionResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_abort_session_27a0fefc3f1d6547, []int{1}
}
...
func (dst *AbortSessionResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AbortSessionResult.Merge(dst, src)
}
...
func NewAbortSessionResponderClient(cc *grpc.ClientConn) AbortSessionResponderClient {
...
func init() {
	proto.RegisterFile("lte/protos/abort_session.proto", fileDescriptor_abort_session_27a0fefc3f1d6547)
}

var fileDescriptor_abort_session_27a0fefc3f1d6547 = []byte{
