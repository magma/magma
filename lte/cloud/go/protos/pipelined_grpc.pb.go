...
// All implementations should embed UnimplementedPipelinedServer
...
// UnimplementedPipelinedServer should be embedded to have forward compatible implementations.
