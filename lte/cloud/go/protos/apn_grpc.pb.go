...
// All implementations should embed UnimplementedApnDBCloudServer
...
// UnimplementedApnDBCloudServer should be embedded to have forward compatible implementations.
