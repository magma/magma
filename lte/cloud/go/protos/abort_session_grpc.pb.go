...
// All implementations should embed UnimplementedAbortSessionResponderServer
// for forward compatibility
type AbortSessionResponderServer interface {
	AbortSession(context.Context, *AbortSessionRequest) (*AbortSessionResult, error)
}

// UnimplementedAbortSessionResponderServer should be embedded to have forward compatible implementations.
