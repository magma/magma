...
type AllocateIPAddressResponse_IPVersion int32

const (
	AllocateIPAddressResponse_IPV4 AllocateIPAddressResponse_IPVersion = 0
	AllocateIPAddressResponse_IPV6 AllocateIPAddressResponse_IPVersion = 1
)

var AllocateIPAddressResponse_IPVersion_name = map[int32]string{
	0: "IPV4",
	1: "IPV6",
}

var AllocateIPAddressResponse_IPVersion_value = map[string]int32{
	"IPV4": 0,
	"IPV6": 1,
}

func (x AllocateIPAddressResponse_IPVersion) String() string {
	return proto.EnumName(AllocateIPAddressResponse_IPVersion_name, int32(x))
}

func (AllocateIPAddressResponse_IPVersion) EnumDescriptor() ([]byte, []int) {
...
type RemoveIPBlockRequest_IPVersion int32

const (
	RemoveIPBlockRequest_IPV4 RemoveIPBlockRequest_IPVersion = 0
	RemoveIPBlockRequest_IPV6 RemoveIPBlockRequest_IPVersion = 1
)

var RemoveIPBlockRequest_IPVersion_name = map[int32]string{
	0: "IPV4",
	1: "IPV6",
}

var RemoveIPBlockRequest_IPVersion_value = map[string]int32{
	"IPV4": 0,
	"IPV6": 1,
}

func (x RemoveIPBlockRequest_IPVersion) String() string {
	return proto.EnumName(RemoveIPBlockRequest_IPVersion_name, int32(x))
}

func (RemoveIPBlockRequest_IPVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3f226a441609c6cc, []int{10, 0}
}
...
type AllocateIPAddressResponse struct {
	...
	Version              AllocateIPAddressResponse_IPVersion `protobuf:"varint,3,opt,name=version,proto3,enum=magma.lte.AllocateIPAddressResponse_IPVersion" json:"version,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                            `json:"-"`
	XXX_unrecognized     []byte                              `json:"-"`
	XXX_sizecache        int32                               `json:"-"`
}
...
func (m *AllocateIPAddressResponse) GetIpAddr() *IPAddress {
	if m != nil {
		return m.IpAddr
	}
	return nil
...
func (m *AllocateIPAddressResponse) GetVersion() AllocateIPAddressResponse_IPVersion {
	if m != nil {
		return m.Version
	}
	return AllocateIPAddressResponse_IPV4
}
...
type RemoveIPBlockRequest struct {
	...
	Version              RemoveIPBlockRequest_IPVersion `protobuf:"varint,3,opt,name=version,proto3,enum=magma.lte.RemoveIPBlockRequest_IPVersion" json:"version,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
func (m *RemoveIPBlockRequest) GetVersion() RemoveIPBlockRequest_IPVersion {
	if m != nil {
		return m.Version
	}
	return RemoveIPBlockRequest_IPV4
}
...
func init() {
	...
	proto.RegisterEnum("magma.lte.AllocateIPAddressResponse_IPVersion", AllocateIPAddressResponse_IPVersion_name, AllocateIPAddressResponse_IPVersion_value)
	...
	proto.RegisterEnum("magma.lte.RemoveIPBlockRequest_IPVersion", RemoveIPBlockRequest_IPVersion_name, RemoveIPBlockRequest_IPVersion_value)
...
var fileDescriptor_3f226a441609c6cc = []byte{
	...
	,
}
