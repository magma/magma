...
type UeContext struct {
	...
	TimeMobileReachabilityTimerStarted *timestamppb.Timestamp `protobuf:"bytes,207,opt,name=time_mobile_reachability_timer_started,json=timeMobileReachabilityTimerStarted,proto3" json:"time_mobile_reachability_timer_started,omitempty"`
	TimeImplicitDetachTimerStarted     *timestamppb.Timestamp `protobuf:"bytes,208,opt,name=time_implicit_detach_timer_started,json=timeImplicitDetachTimerStarted,proto3" json:"time_implicit_detach_timer_started,omitempty"`
	TimePagingResponseTimerStarted     *timestamppb.Timestamp `protobuf:"bytes,209,opt,name=time_paging_response_timer_started,json=timePagingResponseTimerStarted,proto3" json:"time_paging_response_timer_started,omitempty"`
	...
	TimeIcsRspTimerStarted             *timestamppb.Timestamp `protobuf:"bytes,211,opt,name=time_ics_rsp_timer_started,json=timeIcsRspTimerStarted,proto3" json:"time_ics_rsp_timer_started,omitempty"`
	// 5G protos
...
func (x *UeContext) GetTimeMobileReachabilityTimerStarted() *timestamppb.Timestamp {
	if x != nil {
...
func (x *UeContext) GetTimeImplicitDetachTimerStarted() *timestamppb.Timestamp {
	if x != nil {
...
func (x *UeContext) GetTimePagingResponseTimerStarted() *timestamppb.Timestamp {
	if x != nil {
...
func (x *UeContext) GetTimeIcsRspTimerStarted() *timestamppb.Timestamp {
	if x != nil {
