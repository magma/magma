...
type S1ApImsiMap struct {
	...
	MmeUeIdImsiMap map[uint32]uint64 `protobuf:"bytes,1,rep,name=mme_ue_id_imsi_map,json=mmeUeIdImsiMap,proto3" json:"mme_ue_id_imsi_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // mme_s1ap_ue_id => IMSI64
}
...
func (x *S1ApImsiMap) GetMmeUeIdImsiMap() map[uint32]uint64 {
	if x != nil {
