...
var file_lte_protos_oai_s1ap_state_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_lte_protos_oai_s1ap_state_proto_depIdxs = []int32{
	...
	3,  // 9: magma.lte.oai.S1apState.EnbsEntry.value:type_name -> magma.lte.oai.EnbDescription
