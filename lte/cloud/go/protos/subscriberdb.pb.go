...
type CheckSubscribersInSyncRequest struct {
	...
	FlatDigest           *SubscribersDigest `protobuf:"bytes,1,opt,name=flat_digest,json=flatDigest,proto3" json:"flat_digest,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *CheckSubscribersInSyncRequest) GetFlatDigest() *SubscribersDigest {
	if m != nil {
		return m.FlatDigest
	}
	return nil
...
type SyncSubscribersRequest struct {
	...
	// by their IDs (IMSI).
	PerSubDigests        map[string]*SubscribersDigest `protobuf:"bytes,1,rep,name=per_sub_digests,json=perSubDigests,proto3" json:"per_sub_digests,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (m *SyncSubscribersRequest) GetPerSubDigests() map[string]*SubscribersDigest {
	if m != nil {
...
type SyncSubscribersResponse struct {
	...
	FlatDigest *SubscribersDigest `protobuf:"bytes,2,opt,name=flat_digest,json=flatDigest,proto3" json:"flat_digest,omitempty"`
	// per_sub_digests is a set of digests for each server-side subscriber, indexed
	// by their IDs (IMSI).
	PerSubDigests map[string]*SubscribersDigest `protobuf:"bytes,3,rep,name=per_sub_digests,json=perSubDigests,proto3" json:"per_sub_digests,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// added_modified is the set of all subscriber data modified/added on the server
	// side, indexed by their IDs (IMSI).
	AddedModified map[string]*SubscriberDataWithDigest `protobuf:"bytes,4,rep,name=added_modified,json=addedModified,proto3" json:"added_modified,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *SyncSubscribersResponse) GetFlatDigest() *SubscribersDigest {
	if m != nil {
		return m.FlatDigest
	}
	return nil
...
func (m *SyncSubscribersResponse) GetPerSubDigests() map[string]*SubscribersDigest {
	if m != nil {
		return m.PerSubDigests
	}
	return nil
...
func (m *SyncSubscribersResponse) GetAddedModified() map[string]*SubscriberDataWithDigest {
	if m != nil {
...
type SubscriberDataWithDigest struct {
	// digest is the deterministic digest of a single subscriber.
	Digest *SubscribersDigest `protobuf:"bytes,1,opt,name=digest,proto3" json:"digest,omitempty"`
	// data is the original subscriber data.
	Data                 *SubscriberData `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *SubscriberDataWithDigest) Reset()         { *m = SubscriberDataWithDigest{} }
func (m *SubscriberDataWithDigest) String() string { return proto.CompactTextString(m) }
func (*SubscriberDataWithDigest) ProtoMessage()    {}
func (*SubscriberDataWithDigest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d870e4203d378ec0, []int{14}
}

func (m *SubscriberDataWithDigest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SubscriberDataWithDigest.Unmarshal(m, b)
}
func (m *SubscriberDataWithDigest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SubscriberDataWithDigest.Marshal(b, m, deterministic)
}
func (m *SubscriberDataWithDigest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubscriberDataWithDigest.Merge(m, src)
}
func (m *SubscriberDataWithDigest) XXX_Size() int {
	return xxx_messageInfo_SubscriberDataWithDigest.Size(m)
}
func (m *SubscriberDataWithDigest) XXX_DiscardUnknown() {
	xxx_messageInfo_SubscriberDataWithDigest.DiscardUnknown(m)
}

var xxx_messageInfo_SubscriberDataWithDigest proto.InternalMessageInfo

func (m *SubscriberDataWithDigest) GetDigest() *SubscribersDigest {
	if m != nil {
		return m.Digest
	}
	return nil
...
func (m *SubscriberDataWithDigest) GetData() *SubscriberData {
	if m != nil {
		return m.Data
	}
	return nil
...
type ListSubscribersResponse struct {
	...
	FlatDigest *SubscribersDigest `protobuf:"bytes,3,opt,name=flat_digest,json=flatDigest,proto3" json:"flat_digest,omitempty"`
	// per_sub_digests is a set of per-subscriber digests, indexed by the
	// subscriber IDs (IMSI).
	PerSubDigests        map[string]*SubscribersDigest `protobuf:"bytes,4,rep,name=per_sub_digests,json=perSubDigests,proto3" json:"per_sub_digests,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (m *ListSubscribersResponse) GetFlatDigest() *SubscribersDigest {
	if m != nil {
		return m.FlatDigest
	}
	return nil
...
func (m *ListSubscribersResponse) GetPerSubDigests() map[string]*SubscribersDigest {
	if m != nil {
		return m.PerSubDigests
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*SubscribersDigest)(nil), "magma.lte.SyncSubscribersRequest.PerSubDigestsEntry")
	proto.RegisterType((*SyncSubscribersResponse)(nil), "magma.lte.SyncSubscribersResponse")
	proto.RegisterMapType((map[string]*SubscriberDataWithDigest)(nil), "magma.lte.SyncSubscribersResponse.AddedModifiedEntry")
	proto.RegisterMapType((map[string]*SubscribersDigest)(nil), "magma.lte.SyncSubscribersResponse.PerSubDigestsEntry")
	proto.RegisterType((*SubscriberDataWithDigest)(nil), "magma.lte.SubscriberDataWithDigest")
	...
	proto.RegisterMapType((map[string]*SubscribersDigest)(nil), "magma.lte.ListSubscribersResponse.PerSubDigestsEntry")
}
...
var fileDescriptor_d870e4203d378ec0 = []byte{
	...
	,
}
