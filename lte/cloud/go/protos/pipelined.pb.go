...
func (SetupFlowsResult_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{1, 0}
}
...
func (RuleModResult_Result) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{4, 0}
}
...
func (*SetupFlowsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{0}
}
...
func (*SetupFlowsResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{1}
}
...
func (*ActivateFlowsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{2}
}
...
func (*DeactivateFlowsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{3}
}
...
func (*RuleModResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{4}
}
...
func (*ActivateFlowsResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{5}
}
...
func (*DeactivateFlowsResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{6}
}
...
func (*FlowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{7}
}
...
func (*FlowResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{8}
}
...
func (*UEMacFlowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{9}
}
...
func (*TableAssignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{10}
}
...
func (*AllTableAssignments) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{11}
}
...
func (*SerializedRyuPacket) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{12}
}
...
func (*PacketDropTableId) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipelined_b1e3a26b689d93c3, []int{13}
}
...
func init() {
	proto.RegisterFile("lte/protos/pipelined.proto", fileDescriptor_pipelined_b1e3a26b689d93c3)
}

var fileDescriptor_pipelined_b1e3a26b689d93c3 = []byte{
