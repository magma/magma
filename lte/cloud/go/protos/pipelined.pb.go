...
type ActivateFlowsRequest struct {
	...
	// Subscriber session ip address
	IpAddr               *IPAddress `protobuf:"bytes,7,opt,name=ip_addr,json=ipAddr,proto3" json:"ip_addr,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *ActivateFlowsRequest) GetIpAddr() *IPAddress {
	if m != nil {
		return m.IpAddr
	}
	return nil
...
type DeactivateFlowsRequest struct {
	...
	IpAddr               *IPAddress         `protobuf:"bytes,5,opt,name=ip_addr,json=ipAddr,proto3" json:"ip_addr,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *DeactivateFlowsRequest) GetIpAddr() *IPAddress {
	if m != nil {
		return m.IpAddr
	}
	return nil
...
var fileDescriptor_e17e923ef6f5752e = []byte{
	...
	,
}
