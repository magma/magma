...
// All implementations should embed UnimplementedEPSAuthenticationServer
...
// UnimplementedEPSAuthenticationServer should be embedded to have forward compatible implementations.
