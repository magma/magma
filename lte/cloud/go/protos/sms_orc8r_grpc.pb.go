...
// All implementations should embed UnimplementedSMSOrc8RServiceServer
// for forward compatibility
type SMSOrc8RServiceServer interface {
	SMOUplink(context.Context, *SMOUplinkUnitdata) (*protos.Void, error)
}

// UnimplementedSMSOrc8RServiceServer should be embedded to have forward compatible implementations.
...
// All implementations should embed UnimplementedSMSOrc8RGatewayServiceServer
// for forward compatibility
type SMSOrc8RGatewayServiceServer interface {
	SMODownlink(context.Context, *SMODownlinkUnitdata) (*protos.Void, error)
}

// UnimplementedSMSOrc8RGatewayServiceServer should be embedded to have forward compatible implementations.
...
// All implementations should embed UnimplementedSmsDServer
// for forward compatibility
...
// UnimplementedSmsDServer should be embedded to have forward compatible implementations.
