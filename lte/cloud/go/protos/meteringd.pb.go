...
func (*FlowRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_meteringd_97ff2927fcdc668a, []int{0}
}
...
func (*FlowRecord_ID) Descriptor() ([]byte, []int) {
	return fileDescriptor_meteringd_97ff2927fcdc668a, []int{0, 0}
}
...
func (dst *FlowRecord_ID) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlowRecord_ID.Merge(dst, src)
}
...
func (*FlowRecordSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_meteringd_97ff2927fcdc668a, []int{1}
}
...
func (dst *FlowRecordSet) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlowRecordSet.Merge(dst, src)
}
...
func (*FlowTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_meteringd_97ff2927fcdc668a, []int{2}
}
...
func (*FlowRecordQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_meteringd_97ff2927fcdc668a, []int{3}
}
...
func (dst *FlowRecordQuery) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FlowRecordQuery.Merge(dst, src)
}
...
func (*FlowRecordQuery) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _FlowRecordQuery_OneofMarshaler, _FlowRecordQuery_OneofUnmarshaler, _FlowRecordQuery_OneofSizer, []interface{}{
...
func _FlowRecordQuery_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*FlowRecordQuery)
	// query
	switch x := m.Query.(type) {
	case *FlowRecordQuery_RecordId:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.RecordId)
	case *FlowRecordQuery_GatewayId:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.GatewayId)
	case *FlowRecordQuery_SubscriberId:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.SubscriberId)
	case nil:
	default:
		return fmt.Errorf("FlowRecordQuery.Query has unexpected type %T", x)
	}
	return nil
}

func _FlowRecordQuery_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*FlowRecordQuery)
	switch tag {
	case 2: // query.record_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Query = &FlowRecordQuery_RecordId{x}
		return true, err
	case 3: // query.gateway_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Query = &FlowRecordQuery_GatewayId{x}
		return true, err
	case 4: // query.subscriber_id
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Query = &FlowRecordQuery_SubscriberId{x}
		return true, err
	default:
		return false, nil
	}
...
func _FlowRecordQuery_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*FlowRecordQuery)
	// query
	switch x := m.Query.(type) {
	case *FlowRecordQuery_RecordId:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.RecordId)))
		n += len(x.RecordId)
	case *FlowRecordQuery_GatewayId:
		n += 1 // tag and wire
	...
	case *FlowRecordQuery_SubscriberId:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.SubscriberId)))
		n += len(x.SubscriberId)
	case nil:
	default:
...
func init() {
	proto.RegisterFile("lte/protos/meteringd.proto", fileDescriptor_meteringd_97ff2927fcdc668a)
}

var fileDescriptor_meteringd_97ff2927fcdc668a = []byte{
