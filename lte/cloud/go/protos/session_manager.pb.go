...
func (ChargingReAuthRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{9, 0}
}
...
type LocalCreateSessionRequest struct {
	...
	// Types that are valid to be assigned to RatSpecificContext:
	//	*LocalCreateSessionRequest_LteContext
	//	*LocalCreateSessionRequest_WlanContext
	RatSpecificContext   isLocalCreateSessionRequest_RatSpecificContext `protobuf_oneof:"rat_specific_context"`
	XXX_NoUnkeyedLiteral struct{}                                       `json:"-"`
	XXX_unrecognized     []byte                                         `json:"-"`
	XXX_sizecache        int32                                          `json:"-"`
}
...
type isLocalCreateSessionRequest_RatSpecificContext interface {
	isLocalCreateSessionRequest_RatSpecificContext()
}

type LocalCreateSessionRequest_LteContext struct {
	LteContext *LTESessionContext `protobuf:"bytes,17,opt,name=lte_context,json=lteContext,proto3,oneof"`
}

type LocalCreateSessionRequest_WlanContext struct {
	WlanContext *WLANSessionContext `protobuf:"bytes,18,opt,name=wlan_context,json=wlanContext,proto3,oneof"`
}

func (*LocalCreateSessionRequest_LteContext) isLocalCreateSessionRequest_RatSpecificContext() {}

func (*LocalCreateSessionRequest_WlanContext) isLocalCreateSessionRequest_RatSpecificContext() {}

func (m *LocalCreateSessionRequest) GetRatSpecificContext() isLocalCreateSessionRequest_RatSpecificContext {
	if m != nil {
...
func (m *LocalCreateSessionRequest) GetLteContext() *LTESessionContext {
	if x, ok := m.GetRatSpecificContext().(*LocalCreateSessionRequest_LteContext); ok {
		return x.LteContext
	}
	return nil
}

func (m *LocalCreateSessionRequest) GetWlanContext() *WLANSessionContext {
	if x, ok := m.GetRatSpecificContext().(*LocalCreateSessionRequest_WlanContext); ok {
...
func (*LocalCreateSessionRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*LocalCreateSessionRequest_LteContext)(nil),
		(*LocalCreateSessionRequest_WlanContext)(nil),
	}
}
...
type WLANSessionContext struct {
	HardwareAddr         []byte   `protobuf:"bytes,1,opt,name=hardware_addr,json=hardwareAddr,proto3" json:"hardware_addr,omitempty"`
	RadiusSessionId      string   `protobuf:"bytes,2,opt,name=radius_session_id,json=radiusSessionId,proto3" json:"radius_session_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *WLANSessionContext) GetHardwareAddr() []byte {
	if m != nil {
		return m.HardwareAddr
	}
	return nil
...
type CreditUsageUpdate struct {
	...
	CommonContext *CommonSessionContext `protobuf:"bytes,16,opt,name=common_context,json=commonContext,proto3" json:"common_context,omitempty"`
	// Types that are valid to be assigned to RatSpecificContext:
	//	*CreditUsageUpdate_LteContext
	//	*CreditUsageUpdate_WlanContext
	RatSpecificContext   isCreditUsageUpdate_RatSpecificContext `protobuf_oneof:"rat_specific_context"`
	XXX_NoUnkeyedLiteral struct{}                               `json:"-"`
	XXX_unrecognized     []byte                                 `json:"-"`
	XXX_sizecache        int32                                  `json:"-"`
}
...
type isCreditUsageUpdate_RatSpecificContext interface {
	isCreditUsageUpdate_RatSpecificContext()
}

type CreditUsageUpdate_LteContext struct {
	LteContext *LTESessionContext `protobuf:"bytes,17,opt,name=lte_context,json=lteContext,proto3,oneof"`
}

type CreditUsageUpdate_WlanContext struct {
	WlanContext *WLANSessionContext `protobuf:"bytes,18,opt,name=wlan_context,json=wlanContext,proto3,oneof"`
}

func (*CreditUsageUpdate_LteContext) isCreditUsageUpdate_RatSpecificContext() {}

func (*CreditUsageUpdate_WlanContext) isCreditUsageUpdate_RatSpecificContext() {}

func (m *CreditUsageUpdate) GetRatSpecificContext() isCreditUsageUpdate_RatSpecificContext {
	if m != nil {
		return m.RatSpecificContext
	}
	return nil
...
func (m *CreditUsageUpdate) GetLteContext() *LTESessionContext {
	if x, ok := m.GetRatSpecificContext().(*CreditUsageUpdate_LteContext); ok {
		return x.LteContext
	}
	return nil
}

func (m *CreditUsageUpdate) GetWlanContext() *WLANSessionContext {
	if x, ok := m.GetRatSpecificContext().(*CreditUsageUpdate_WlanContext); ok {
		return x.WlanContext
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*CreditUsageUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*CreditUsageUpdate_LteContext)(nil),
		(*CreditUsageUpdate_WlanContext)(nil),
	}
}
...
type UsageMonitoringUpdateRequest struct {
	...
	CommonContext *CommonSessionContext `protobuf:"bytes,16,opt,name=common_context,json=commonContext,proto3" json:"common_context,omitempty"`
	// Types that are valid to be assigned to RatSpecificContext:
	//	*UsageMonitoringUpdateRequest_LteContext
	//	*UsageMonitoringUpdateRequest_WlanContext
	RatSpecificContext   isUsageMonitoringUpdateRequest_RatSpecificContext `protobuf_oneof:"rat_specific_context"`
	XXX_NoUnkeyedLiteral struct{}                                          `json:"-"`
	XXX_unrecognized     []byte                                            `json:"-"`
	XXX_sizecache        int32                                             `json:"-"`
}
...
func (m *UsageMonitoringUpdateRequest) GetCommonContext() *CommonSessionContext {
	if m != nil {
		return m.CommonContext
	}
	return nil
...
type isUsageMonitoringUpdateRequest_RatSpecificContext interface {
	isUsageMonitoringUpdateRequest_RatSpecificContext()
}

type UsageMonitoringUpdateRequest_LteContext struct {
	LteContext *LTESessionContext `protobuf:"bytes,17,opt,name=lte_context,json=lteContext,proto3,oneof"`
}

type UsageMonitoringUpdateRequest_WlanContext struct {
	WlanContext *WLANSessionContext `protobuf:"bytes,18,opt,name=wlan_context,json=wlanContext,proto3,oneof"`
}

func (*UsageMonitoringUpdateRequest_LteContext) isUsageMonitoringUpdateRequest_RatSpecificContext() {}

func (*UsageMonitoringUpdateRequest_WlanContext) isUsageMonitoringUpdateRequest_RatSpecificContext() {}

func (m *UsageMonitoringUpdateRequest) GetRatSpecificContext() isUsageMonitoringUpdateRequest_RatSpecificContext {
	if m != nil {
		return m.RatSpecificContext
	}
	return nil
...
func (m *UsageMonitoringUpdateRequest) GetLteContext() *LTESessionContext {
	if x, ok := m.GetRatSpecificContext().(*UsageMonitoringUpdateRequest_LteContext); ok {
		return x.LteContext
	}
	return nil
}

func (m *UsageMonitoringUpdateRequest) GetWlanContext() *WLANSessionContext {
	if x, ok := m.GetRatSpecificContext().(*UsageMonitoringUpdateRequest_WlanContext); ok {
		return x.WlanContext
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*UsageMonitoringUpdateRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*UsageMonitoringUpdateRequest_LteContext)(nil),
		(*UsageMonitoringUpdateRequest_WlanContext)(nil),
	}
}
...
type CreateSessionRequest struct {
	...
	CommonContext *CommonSessionContext  `protobuf:"bytes,16,opt,name=common_context,json=commonContext,proto3" json:"common_context,omitempty"`
	// Types that are valid to be assigned to RatSpecificContext:
	//	*CreateSessionRequest_LteContext
	//	*CreateSessionRequest_WlanContext
	RatSpecificContext   isCreateSessionRequest_RatSpecificContext `protobuf_oneof:"rat_specific_context"`
	XXX_NoUnkeyedLiteral struct{}                                  `json:"-"`
	XXX_unrecognized     []byte                                    `json:"-"`
	XXX_sizecache        int32                                     `json:"-"`
}
...
type isCreateSessionRequest_RatSpecificContext interface {
	isCreateSessionRequest_RatSpecificContext()
}

type CreateSessionRequest_LteContext struct {
	LteContext *LTESessionContext `protobuf:"bytes,17,opt,name=lte_context,json=lteContext,proto3,oneof"`
}

type CreateSessionRequest_WlanContext struct {
	WlanContext *WLANSessionContext `protobuf:"bytes,18,opt,name=wlan_context,json=wlanContext,proto3,oneof"`
}

func (*CreateSessionRequest_LteContext) isCreateSessionRequest_RatSpecificContext() {}

func (*CreateSessionRequest_WlanContext) isCreateSessionRequest_RatSpecificContext() {}

func (m *CreateSessionRequest) GetRatSpecificContext() isCreateSessionRequest_RatSpecificContext {
	if m != nil {
		return m.RatSpecificContext
	}
	return nil
...
func (m *CreateSessionRequest) GetLteContext() *LTESessionContext {
	if x, ok := m.GetRatSpecificContext().(*CreateSessionRequest_LteContext); ok {
		return x.LteContext
	}
	return nil
}

func (m *CreateSessionRequest) GetWlanContext() *WLANSessionContext {
	if x, ok := m.GetRatSpecificContext().(*CreateSessionRequest_WlanContext); ok {
		return x.WlanContext
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*CreateSessionRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*CreateSessionRequest_LteContext)(nil),
		(*CreateSessionRequest_WlanContext)(nil),
	}
}
...
type SessionTerminateRequest struct {
	...
	// Types that are valid to be assigned to RatSpecificContext:
	//	*SessionTerminateRequest_LteContext
	//	*SessionTerminateRequest_WlanContext
	RatSpecificContext   isSessionTerminateRequest_RatSpecificContext `protobuf_oneof:"rat_specific_context"`
	XXX_NoUnkeyedLiteral struct{}                                     `json:"-"`
	XXX_unrecognized     []byte                                       `json:"-"`
	XXX_sizecache        int32                                        `json:"-"`
}
...
type isSessionTerminateRequest_RatSpecificContext interface {
	isSessionTerminateRequest_RatSpecificContext()
}

type SessionTerminateRequest_LteContext struct {
	LteContext *LTESessionContext `protobuf:"bytes,18,opt,name=lte_context,json=lteContext,proto3,oneof"`
}

type SessionTerminateRequest_WlanContext struct {
	WlanContext *WLANSessionContext `protobuf:"bytes,19,opt,name=wlan_context,json=wlanContext,proto3,oneof"`
}

func (*SessionTerminateRequest_LteContext) isSessionTerminateRequest_RatSpecificContext() {}

func (*SessionTerminateRequest_WlanContext) isSessionTerminateRequest_RatSpecificContext() {}

func (m *SessionTerminateRequest) GetRatSpecificContext() isSessionTerminateRequest_RatSpecificContext {
	if m != nil {
		return m.RatSpecificContext
	}
	return nil
...
func (m *SessionTerminateRequest) GetLteContext() *LTESessionContext {
	if x, ok := m.GetRatSpecificContext().(*SessionTerminateRequest_LteContext); ok {
		return x.LteContext
	}
	return nil
}

func (m *SessionTerminateRequest) GetWlanContext() *WLANSessionContext {
	if x, ok := m.GetRatSpecificContext().(*SessionTerminateRequest_WlanContext); ok {
		return x.WlanContext
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*SessionTerminateRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*SessionTerminateRequest_LteContext)(nil),
		(*SessionTerminateRequest_WlanContext)(nil),
	}
}
...
var fileDescriptor_85add0446af78174 = []byte{
	...
	,
}
