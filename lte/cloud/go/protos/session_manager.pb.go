...
func (AmbrUnit_AmbrUnitType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{58, 0}
}
...
func (UserPlaneIPResourceSchema_InterfaceValue) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{62, 0}
}
...
type M5GSMSessionContext struct {
	PduSessionId uint32 `protobuf:"varint,1,opt,name=pdu_session_id,json=pduSessionId,proto3" json:"pdu_session_id,omitempty"`
	// Define ENUM 24-501 - 9.11.3.47 . 1 byte. i.e. initial requerst, existing pdusession etc...
	RequestType RequestType `protobuf:"varint,2,opt,name=request_type,json=requestType,proto3,enum=magma.lte.RequestType" json:"request_type,omitempty"`
...
type M5GSMSessionContextAccess struct {
	...
	DownlinkUnitType *AmbrUnit `protobuf:"bytes,5,opt,name=downlink_unit_type,json=downlinkUnitType,proto3" json:"downlink_unit_type,omitempty"`
	...
	UplinkUnitType *AmbrUnit `protobuf:"bytes,7,opt,name=uplink_unit_type,json=uplinkUnitType,proto3" json:"uplink_unit_type,omitempty"`
	// Only to use lower 2 bytes (16 bit values)
