...
const (
	...
	SMSessionFSMState_MODIFICATION_5 SMSessionFSMState = 5
)
...
const (
	QosPolicy_ADD QosPolicy_PolicyState = 0
	QosPolicy_DEL QosPolicy_PolicyState = 1
	QosPolicy_MOD QosPolicy_PolicyState = 2
)

var QosPolicy_PolicyState_name = map[int32]string{
	0: "ADD",
	1: "DEL",
	2: "MOD",
}

var QosPolicy_PolicyState_value = map[string]int32{
	"ADD": 0,
	"DEL": 1,
	"MOD": 2,
}
...
func (x QosPolicy_PolicyState) String() string {
	return proto.EnumName(QosPolicy_PolicyState_name, int32(x))
}

func (QosPolicy_PolicyState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{65, 0}
}
...
func (UserPlaneIPResourceSchema_InterfaceValue) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{69, 0}
}
...
func (UPFAssociationState_AssociationState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{70, 0}
}
...
type M5GSMSessionContext struct {
	...
	DefaultAmbr            *AggregatedMaximumBitrate `protobuf:"bytes,26,opt,name=default_ambr,json=defaultAmbr,proto3" json:"default_ambr,omitempty"`
	// For Modification policy
...
func (m *M5GSMSessionContext) GetDefaultAmbr() *AggregatedMaximumBitrate {
	if m != nil {
		return m.DefaultAmbr
	}
	return nil
}

func (m *M5GSMSessionContext) GetQosPolicy() []*QosPolicy {
	if m != nil {
		return m.QosPolicy
	}
	return nil
...
type QosPolicy struct {
	...
	Qos                  *FlowQos              `protobuf:"bytes,2,opt,name=qos,proto3" json:"qos,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}

func (m *QosPolicy) Reset()         { *m = QosPolicy{} }
func (m *QosPolicy) String() string { return proto.CompactTextString(m) }
func (*QosPolicy) ProtoMessage()    {}
func (*QosPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{65}
}

func (m *QosPolicy) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_QosPolicy.Unmarshal(m, b)
}
func (m *QosPolicy) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_QosPolicy.Marshal(b, m, deterministic)
}
func (m *QosPolicy) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QosPolicy.Merge(m, src)
}
func (m *QosPolicy) XXX_Size() int {
	return xxx_messageInfo_QosPolicy.Size(m)
}
func (m *QosPolicy) XXX_DiscardUnknown() {
	xxx_messageInfo_QosPolicy.DiscardUnknown(m)
}

var xxx_messageInfo_QosPolicy proto.InternalMessageInfo

func (m *QosPolicy) GetPolicyState() QosPolicy_PolicyState {
	if m != nil {
...
func (m *QosPolicy) GetQos() *FlowQos {
	if m != nil {
		return m.Qos
	}
	return nil
...
type M5GSMSessionModContextAccess struct {
	// received from UE. For 5G pdu_session_id.
	PduSessionId uint32 `protobuf:"varint,1,opt,name=pdu_session_id,json=pduSessionId,proto3" json:"pdu_session_id,omitempty"`
	// selected PDU session TS-24501 - 9.11.4.11
	PduSessionType PduSessionType `protobuf:"varint,2,opt,name=pdu_session_type,json=pduSessionType,proto3,enum=magma.lte.PduSessionType" json:"pdu_session_type,omitempty"`
	...
	SelectedSscMode SscMode `protobuf:"varint,3,opt,name=selected_ssc_mode,json=selectedSscMode,proto3,enum=magma.lte.SscMode" json:"selected_ssc_mode,omitempty"`
	// TS-24501 - 9.11.4.2
	M5GsmCause M5GSMCause `protobuf:"varint,4,opt,name=M5gsm_cause,json=M5gsmCause,proto3,enum=magma.lte.M5GSMCause" json:"M5gsm_cause,omitempty"`
	// PDU session is requested to be established as always-on PDU session.
	AlwaysOnPduSessionIndication bool     `protobuf:"varint,5,opt,name=always_on_pdu_session_indication,json=alwaysOnPduSessionIndication,proto3" json:"always_on_pdu_session_indication,omitempty"`
	UpfEndpoint                  *TeidSet `protobuf:"bytes,6,opt,name=upf_endpoint,json=upfEndpoint,proto3" json:"upf_endpoint,omitempty"`
	// Procedure transaction identity One byte TS-24501 9.6
	ProcedureTransIdentity []byte       `protobuf:"bytes,7,opt,name=procedure_trans_identity,json=procedureTransIdentity,proto3" json:"procedure_trans_identity,omitempty"`
	QosPolicy              []*QosPolicy `protobuf:"bytes,8,rep,name=qos_policy,json=qosPolicy,proto3" json:"qos_policy,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}     `json:"-"`
	XXX_unrecognized       []byte       `json:"-"`
	XXX_sizecache          int32        `json:"-"`
}

func (m *M5GSMSessionModContextAccess) Reset()         { *m = M5GSMSessionModContextAccess{} }
func (m *M5GSMSessionModContextAccess) String() string { return proto.CompactTextString(m) }
func (*M5GSMSessionModContextAccess) ProtoMessage()    {}
func (*M5GSMSessionModContextAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{66}
}

func (m *M5GSMSessionModContextAccess) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_M5GSMSessionModContextAccess.Unmarshal(m, b)
}
func (m *M5GSMSessionModContextAccess) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_M5GSMSessionModContextAccess.Marshal(b, m, deterministic)
}
func (m *M5GSMSessionModContextAccess) XXX_Merge(src proto.Message) {
	xxx_messageInfo_M5GSMSessionModContextAccess.Merge(m, src)
}
func (m *M5GSMSessionModContextAccess) XXX_Size() int {
	return xxx_messageInfo_M5GSMSessionModContextAccess.Size(m)
}
func (m *M5GSMSessionModContextAccess) XXX_DiscardUnknown() {
	xxx_messageInfo_M5GSMSessionModContextAccess.DiscardUnknown(m)
}

var xxx_messageInfo_M5GSMSessionModContextAccess proto.InternalMessageInfo

func (m *M5GSMSessionModContextAccess) GetPduSessionId() uint32 {
	if m != nil {
		return m.PduSessionId
	}
	return 0
...
func (m *M5GSMSessionModContextAccess) GetPduSessionType() PduSessionType {
	if m != nil {
		return m.PduSessionType
	}
	return PduSessionType_IPV4
...
func (m *M5GSMSessionModContextAccess) GetSelectedSscMode() SscMode {
	if m != nil {
		return m.SelectedSscMode
	}
	return SscMode_SSC_MODE_1
...
func (m *M5GSMSessionModContextAccess) GetM5GsmCause() M5GSMCause {
	if m != nil {
		return m.M5GsmCause
	}
	return M5GSMCause_OPERATOR_DETERMINED_BARRING
...
func (m *M5GSMSessionModContextAccess) GetAlwaysOnPduSessionIndication() bool {
	if m != nil {
		return m.AlwaysOnPduSessionIndication
	}
	return false
...
func (m *M5GSMSessionModContextAccess) GetUpfEndpoint() *TeidSet {
	if m != nil {
		return m.UpfEndpoint
	}
	return nil
...
func (m *M5GSMSessionModContextAccess) GetProcedureTransIdentity() []byte {
	if m != nil {
		return m.ProcedureTransIdentity
	}
	return nil
...
func (m *M5GSMSessionModContextAccess) GetQosPolicy() []*QosPolicy {
	if m != nil {
		return m.QosPolicy
	}
	return nil
...
// Modification Request from SMF
type SetSMSessionModContextAccess struct {
	CommonContext           *CommonSessionContext         `protobuf:"bytes,1,opt,name=common_context,json=commonContext,proto3" json:"common_context,omitempty"`
	M5GSessionModcontextRsp *M5GSMSessionModContextAccess `protobuf:"bytes,2,opt,name=m5g_session_modcontext_rsp,json=m5gSessionModcontextRsp,proto3" json:"m5g_session_modcontext_rsp,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                      `json:"-"`
	XXX_unrecognized        []byte                        `json:"-"`
	XXX_sizecache           int32                         `json:"-"`
}

func (m *SetSMSessionModContextAccess) Reset()         { *m = SetSMSessionModContextAccess{} }
func (m *SetSMSessionModContextAccess) String() string { return proto.CompactTextString(m) }
func (*SetSMSessionModContextAccess) ProtoMessage()    {}
func (*SetSMSessionModContextAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{67}
}

func (m *SetSMSessionModContextAccess) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SetSMSessionModContextAccess.Unmarshal(m, b)
}
func (m *SetSMSessionModContextAccess) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SetSMSessionModContextAccess.Marshal(b, m, deterministic)
}
func (m *SetSMSessionModContextAccess) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetSMSessionModContextAccess.Merge(m, src)
}
func (m *SetSMSessionModContextAccess) XXX_Size() int {
	return xxx_messageInfo_SetSMSessionModContextAccess.Size(m)
}
func (m *SetSMSessionModContextAccess) XXX_DiscardUnknown() {
	xxx_messageInfo_SetSMSessionModContextAccess.DiscardUnknown(m)
}

var xxx_messageInfo_SetSMSessionModContextAccess proto.InternalMessageInfo

func (m *SetSMSessionModContextAccess) GetCommonContext() *CommonSessionContext {
	if m != nil {
		return m.CommonContext
	}
	return nil
...
func (m *SetSMSessionModContextAccess) GetM5GSessionModcontextRsp() *M5GSMSessionModContextAccess {
	if m != nil {
		return m.M5GSessionModcontextRsp
	}
	return nil
}
...
func (*UPFSessionConfigState) Descriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{77}
}
...
func (*UPFPagingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_85add0446af78174, []int{78}
}
...
func init() {
	...
	proto.RegisterEnum("magma.lte.QosPolicy_PolicyState", QosPolicy_PolicyState_name, QosPolicy_PolicyState_value)
	...
	proto.RegisterType((*QosPolicy)(nil), "magma.lte.QosPolicy")
	proto.RegisterType((*M5GSMSessionModContextAccess)(nil), "magma.lte.M5GSMSessionModContextAccess")
	proto.RegisterType((*SetSMSessionModContextAccess)(nil), "magma.lte.SetSMSessionModContextAccess")
...
var fileDescriptor_85add0446af78174 = []byte{
	// 9302 bytes of a gzipped FileDescriptorProto
	,
}
...
type SmfPduSessionSmContextClient interface {
	...
	SetSmfSessionModContext(ctx context.Context, in *SetSMSessionModContextAccess, opts ...grpc.CallOption) (*SmContextVoid, error)
}
...
func (c *smfPduSessionSmContextClient) SetSmfSessionModContext(ctx context.Context, in *SetSMSessionModContextAccess, opts ...grpc.CallOption) (*SmContextVoid, error) {
	out := new(SmContextVoid)
	err := c.cc.Invoke(ctx, "/magma.lte.SmfPduSessionSmContext/SetSmfSessionModContext", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SmfPduSessionSmContextServer interface {
	...
	SetSmfSessionModContext(context.Context, *SetSMSessionModContextAccess) (*SmContextVoid, error)
}
...
func (*UnimplementedSmfPduSessionSmContextServer) SetSmfSessionModContext(ctx context.Context, req *SetSMSessionModContextAccess) (*SmContextVoid, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetSmfSessionModContext not implemented")
}
...
func _SmfPduSessionSmContext_SetSmfSessionModContext_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetSMSessionModContextAccess)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SmfPduSessionSmContextServer).SetSmfSessionModContext(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/magma.lte.SmfPduSessionSmContext/SetSmfSessionModContext",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmfPduSessionSmContextServer).SetSmfSessionModContext(ctx, req.(*SetSMSessionModContextAccess))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SmfPduSessionSmContext_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetSmfSessionModContext",
			Handler:    _SmfPduSessionSmContext_SetSmfSessionModContext_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "lte/protos/session_manager.proto",
