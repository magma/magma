...
// All implementations should embed UnimplementedSpgwServiceServer
...
// UnimplementedSpgwServiceServer should be embedded to have forward compatible implementations.
