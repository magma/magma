...
func (IPDesc_IPState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_keyval_5383d858f3392e16, []int{1, 0}
}
...
func (*AssignedIPBlocks) Descriptor() ([]byte, []int) {
	return fileDescriptor_keyval_5383d858f3392e16, []int{0}
}
...
func (dst *AssignedIPBlocks) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssignedIPBlocks.Merge(dst, src)
}
...
func (*IPDesc) Descriptor() ([]byte, []int) {
	return fileDescriptor_keyval_5383d858f3392e16, []int{1}
}
...
func (dst *IPDesc) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPDesc.Merge(dst, src)
}
...
func (*IPDescs) Descriptor() ([]byte, []int) {
	return fileDescriptor_keyval_5383d858f3392e16, []int{2}
}
...
func (dst *IPDescs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IPDescs.Merge(dst, src)
}
...
func init() { proto.RegisterFile("lte/protos/keyval.proto", fileDescriptor_keyval_5383d858f3392e16) }

var fileDescriptor_keyval_5383d858f3392e16 = []byte{
