...
// All implementations must embed UnimplementedS6AServiceServer
...
// UnimplementedS6AServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedS6AServiceServer) mustEmbedUnimplementedS6AServiceServer() {}
