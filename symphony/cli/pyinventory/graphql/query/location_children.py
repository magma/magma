...
class LocationChildrenQuery(DataClassJsonMixin):
    ...
    @classmethod
    # fmt: off
    def execute(cls, client: GraphqlClient, id: str) -> Optional[LocationChildrenQueryData.Node]:
        # fmt: off
        ...
        try:
            ...
            client.reporter.log_successful_operation("LocationChildrenQuery", variables, network_time, decode_time)
            return res.location
