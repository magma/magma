...
func ID(id string) predicate.LocationType {
...
func IDEQ(id string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
			s.Where(sql.EQ(s.C(FieldID), id))
...
func IDNEQ(id string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			// if not arguments were provided, append the FALSE constants,
			// since we can't apply "IN ()". This will make this predicate falsy.
...
func IDGT(id string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func HasLocationsWith(preds ...predicate.Location) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(LocationsColumn).From(builder.Table(LocationsTable))
			for _, p := range preds {
				p(t2)
			}
...
func HasSurveyTemplateCategoriesWith(preds ...predicate.SurveyTemplateCategory) predicate.LocationType {
	return predicate.LocationType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(SurveyTemplateCategoriesColumn).From(builder.Table(SurveyTemplateCategoriesTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(FieldID), t2))
