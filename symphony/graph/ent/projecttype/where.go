...
func ID(id string) predicate.ProjectType {
...
func IDEQ(id string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
			s.Where(sql.EQ(s.C(FieldID), id))
...
func IDNEQ(id string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			// if not arguments were provided, append the FALSE constants,
			// since we can't apply "IN ()". This will make this predicate falsy.
...
func IDGT(id string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func CreateTime(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func UpdateTime(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func CreateTimeEQ(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			s.Where(sql.EQ(s.C(FieldCreateTime), v))
		},
...
func CreateTimeNEQ(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func CreateTimeIn(vs ...time.Time) predicate.ProjectType {
...
func CreateTimeNotIn(vs ...time.Time) predicate.ProjectType {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateTimeGT(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func CreateTimeGTE(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func CreateTimeLT(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func CreateTimeLTE(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func UpdateTimeEQ(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			s.Where(sql.EQ(s.C(FieldUpdateTime), v))
		},
...
func UpdateTimeNEQ(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func UpdateTimeIn(vs ...time.Time) predicate.ProjectType {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateTimeNotIn(vs ...time.Time) predicate.ProjectType {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdateTimeGT(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func UpdateTimeGTE(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func UpdateTimeLT(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func UpdateTimeLTE(v time.Time) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
...
func HasProjectsWith(preds ...predicate.Project) predicate.ProjectType {
	return predicate.ProjectType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(ProjectsColumn).From(builder.Table(ProjectsTable))
			for _, p := range preds {
				p(t2)
			}
