...
func ID(id string) predicate.CheckListCategory {
...
func IDEQ(id string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
		s.Where(sql.EQ(s.C(FieldID), id))
	})
...
func IDNEQ(id string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.CheckListCategory {
	return predicate.CheckListCategory(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
