...
func (swfsq *SurveyWiFiScanQuery) prepareQuery(ctx context.Context) error {
	if swfsq.path != nil {
		prev, err := swfsq.path(ctx)
		if err != nil {
			return err
		}
		swfsq.sql = prev
