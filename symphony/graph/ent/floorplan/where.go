...
func ID(id string) predicate.FloorPlan {
...
func IDEQ(id string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
			s.Where(sql.EQ(s.C(FieldID), id))
...
func IDNEQ(id string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			// if not arguments were provided, append the FALSE constants,
			// since we can't apply "IN ()". This will make this predicate falsy.
...
func IDGT(id string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func HasReferencePointWith(preds ...predicate.FloorPlanReferencePoint) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(ReferencePointInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(ReferencePointColumn), t2))
		},
	)
}
...
func HasScaleWith(preds ...predicate.FloorPlanScale) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(ScaleInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(ScaleColumn), t2))
		},
	)
}
...
func HasImageWith(preds ...predicate.File) predicate.FloorPlan {
	return predicate.FloorPlan(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(ImageInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(ImageColumn), t2))
		},
	)
}
