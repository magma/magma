...
func ID(id string) predicate.Hyperlink {
	return predicate.Hyperlink(
		func(s *sql.Selector) {
...
func IDEQ(id string) predicate.Hyperlink {
...
func IDNEQ(id string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.Hyperlink {
	return predicate.Hyperlink(func(s *sql.Selector) {
		id, _ := strconv.Atoi(id)
