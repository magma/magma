...
func ID(id string) predicate.PropertyType {
...
func IDEQ(id string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
			s.Where(sql.EQ(s.C(FieldID), id))
...
func IDNEQ(id string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			// if not arguments were provided, append the FALSE constants,
			// since we can't apply "IN ()". This will make this predicate falsy.
...
func IDGT(id string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func HasLocationTypeWith(preds ...predicate.LocationType) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(LocationTypeInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(LocationTypeColumn), t2))
		},
	)
}
...
func HasLinkEquipmentPortTypeWith(preds ...predicate.EquipmentPortType) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(LinkEquipmentPortTypeInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(LinkEquipmentPortTypeColumn), t2))
		},
	)
}
...
func HasServiceTypeWith(preds ...predicate.ServiceType) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(ServiceTypeInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(ServiceTypeColumn), t2))
		},
	)
}
...
func HasWorkOrderTypeWith(preds ...predicate.WorkOrderType) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(WorkOrderTypeInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(WorkOrderTypeColumn), t2))
		},
	)
}
...
func HasProjectTypeWith(preds ...predicate.ProjectType) predicate.PropertyType {
	return predicate.PropertyType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(FieldID).From(builder.Table(ProjectTypeInverseTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(ProjectTypeColumn), t2))
		},
	)
}
