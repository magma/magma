...
func ID(id string) predicate.WorkOrderType {
...
func IDEQ(id string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
			s.Where(sql.EQ(s.C(FieldID), id))
...
func IDNEQ(id string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDIn(ids ...string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
...
func IDNotIn(ids ...string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			// if not arguments were provided, append the FALSE constants,
			// since we can't apply "IN ()". This will make this predicate falsy.
...
func IDGT(id string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDGTE(id string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLT(id string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func IDLTE(id string) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			id, _ := strconv.Atoi(id)
...
func HasDefinitionsWith(preds ...predicate.WorkOrderDefinition) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(DefinitionsColumn).From(builder.Table(DefinitionsTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(FieldID), t2))
...
func HasCheckListDefinitionsWith(preds ...predicate.CheckListItemDefinition) predicate.WorkOrderType {
	return predicate.WorkOrderType(
		func(s *sql.Selector) {
			builder := sql.Dialect(s.Dialect())
			t1 := s.Table()
			t2 := builder.Select(CheckListDefinitionsColumn).From(builder.Table(CheckListDefinitionsTable))
			for _, p := range preds {
				p(t2)
			}
			s.Where(sql.In(t1.C(FieldID), t2))
