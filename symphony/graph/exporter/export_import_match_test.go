	...
	for i := 0; ; i++ {
		...
		if i == 0 {
			...
			case MethodEdit:
				newLine = line
				if line[1] == currEquip {
					newLine[10] = "str-prop-value" + strconv.FormatInt(int64(i), 10)
					newLine[1] = "newName" + strconv.FormatInt(int64(i), 10)
					newLine[11] = "10" + strconv.FormatInt(int64(i), 10)
					newLine[12] = "new-prop-value" + strconv.FormatInt(int64(i), 10)
				}
			default:
