...
func (surveyCellScanResolver) NetworkType(ctx context.Context, obj *ent.SurveyCellScan) (models.CellularNetworkType, error) {
	return models.CellularNetworkType(obj.NetworkType), nil
}

func (surveyCellScanResolver) Timestamp(ctx context.Context, obj *ent.SurveyCellScan) (*int, error) {
...
func (surveyWiFiScanResolver) Timestamp(ctx context.Context, obj *ent.SurveyWiFiScan) (int, error) {
