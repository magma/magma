...
func New() (complexity generated.ComplexityRoot) {
	...
	complexity.Query.WorkOrders = func(childComplexity int, after *ent.Cursor, first *int, before *ent.Cursor, last *int, showCompleted *bool, filters []*models.WorkOrderFilterInput) int {
		return PaginationComplexity(childComplexity, after, first, before, last)
	}
