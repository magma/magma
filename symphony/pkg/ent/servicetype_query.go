...
func (stgb *ServiceTypeGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
...
func (stgb *ServiceTypeGroupBy) StringX(ctx context.Context) string {
...
func (stgb *ServiceTypeGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
...
func (stgb *ServiceTypeGroupBy) IntX(ctx context.Context) int {
	v, err := stgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (stgb *ServiceTypeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
...
func (stgb *ServiceTypeGroupBy) Float64X(ctx context.Context) float64 {
...
func (stgb *ServiceTypeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
...
func (stgb *ServiceTypeGroupBy) BoolX(ctx context.Context) bool {
	v, err := stgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (sts *ServiceTypeSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
...
// StringX is like String, but panics if an error occurs.
func (sts *ServiceTypeSelect) StringX(ctx context.Context) string {
...
func (sts *ServiceTypeSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
...
// IntX is like Int, but panics if an error occurs.
func (sts *ServiceTypeSelect) IntX(ctx context.Context) int {
	v, err := sts.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (sts *ServiceTypeSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
...
// Float64X is like Float64, but panics if an error occurs.
func (sts *ServiceTypeSelect) Float64X(ctx context.Context) float64 {
...
func (sts *ServiceTypeSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
...
// BoolX is like Bool, but panics if an error occurs.
func (sts *ServiceTypeSelect) BoolX(ctx context.Context) bool {
	v, err := sts.Bool(ctx)
	if err != nil {
		panic(err)
	}
