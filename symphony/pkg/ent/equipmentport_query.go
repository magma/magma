...
func (epq *EquipmentPortQuery) Order(o ...OrderFunc) *EquipmentPortQuery {
...
func (epq *EquipmentPortQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (epq *EquipmentPortQuery) FirstXID(ctx context.Context) int {
...
func (epq *EquipmentPortQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (epq *EquipmentPortQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
...
func (epq *EquipmentPortQuery) IDsX(ctx context.Context) []int {
	ids, err := epq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (epq *EquipmentPortQuery) prepareQuery(ctx context.Context) error {
	if epq.path != nil {
	...
	if err := equipmentport.Policy.EvalQuery(ctx, epq); err != nil {
		return err
	}
	return nil
}
...
func (epq *EquipmentPortQuery) sqlAll(ctx context.Context) ([]*EquipmentPort, error) {
	...
	if query := epq.withDefinition; query != nil {
		...
		nodeids := make(map[int][]*EquipmentPort)
		for i := range nodes {
			if fk := nodes[i].equipment_port_definition; fk != nil {
				ids = append(ids, *fk)
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "equipment_port_definition" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := epq.withParent; query != nil {
		...
		nodeids := make(map[int][]*EquipmentPort)
		for i := range nodes {
			if fk := nodes[i].equipment_ports; fk != nil {
				ids = append(ids, *fk)
				nodeids[*fk] = append(nodeids[*fk], nodes[i])
			}
		}
		...
		for _, n := range neighbors {
			nodes, ok := nodeids[n.ID]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "equipment_ports" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := epq.withLink; query != nil {
		...
		nodeids := make(map[int][]*EquipmentPort)
		for i := range nodes {
			if fk := nodes[i].equipment_port_link; fk != nil {
				ids = append(ids, *fk)
				nodeids[*fk] = append(nodeids[*fk], nodes[i])
			}
		}
		...
		for _, n := range neighbors {
			nodes, ok := nodeids[n.ID]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "equipment_port_link" returned %v`, n.ID)
			}
			for i := range nodes {
	...
	if query := epq.withProperties; query != nil {
		...
		for _, n := range neighbors {
			fk := n.equipment_port_properties
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "equipment_port_properties" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "equipment_port_properties" returned %v for node %v`, *fk, n.ID)
			}
	...
	if query := epq.withEndpoints; query != nil {
		...
		for _, n := range neighbors {
			fk := n.service_endpoint_port
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "service_endpoint_port" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "service_endpoint_port" returned %v for node %v`, *fk, n.ID)
			}
...
func (epgb *EquipmentPortGroupBy) Aggregate(fns ...AggregateFunc) *EquipmentPortGroupBy {
...
func (epgb *EquipmentPortGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (epgb *EquipmentPortGroupBy) StringX(ctx context.Context) string {
...
func (epgb *EquipmentPortGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (epgb *EquipmentPortGroupBy) IntX(ctx context.Context) int {
	v, err := epgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (epgb *EquipmentPortGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (epgb *EquipmentPortGroupBy) Float64X(ctx context.Context) float64 {
...
func (epgb *EquipmentPortGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (epgb *EquipmentPortGroupBy) BoolX(ctx context.Context) bool {
	v, err := epgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (eps *EquipmentPortSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (eps *EquipmentPortSelect) StringX(ctx context.Context) string {
...
func (eps *EquipmentPortSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (eps *EquipmentPortSelect) IntX(ctx context.Context) int {
	v, err := eps.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (eps *EquipmentPortSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (eps *EquipmentPortSelect) Float64X(ctx context.Context) float64 {
...
func (eps *EquipmentPortSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{equipmentport.Label}
	default:
		err = fmt.Errorf("ent: EquipmentPortSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (eps *EquipmentPortSelect) BoolX(ctx context.Context) bool {
	v, err := eps.Bool(ctx)
	if err != nil {
		panic(err)
	}
