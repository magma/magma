...
func (ltq *LocationTypeQuery) prepareQuery(ctx context.Context) error {
	...
	if err := locationtype.Policy.EvalQuery(ctx, ltq); err != nil {
		return err
	}
	return nil
}
...
func (ltgb *LocationTypeGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (ltgb *LocationTypeGroupBy) StringX(ctx context.Context) string {
...
func (ltgb *LocationTypeGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (ltgb *LocationTypeGroupBy) IntX(ctx context.Context) int {
	v, err := ltgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (ltgb *LocationTypeGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (ltgb *LocationTypeGroupBy) Float64X(ctx context.Context) float64 {
...
func (ltgb *LocationTypeGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (ltgb *LocationTypeGroupBy) BoolX(ctx context.Context) bool {
	v, err := ltgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
func (lts *LocationTypeSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (lts *LocationTypeSelect) StringX(ctx context.Context) string {
...
func (lts *LocationTypeSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (lts *LocationTypeSelect) IntX(ctx context.Context) int {
	v, err := lts.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (lts *LocationTypeSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (lts *LocationTypeSelect) Float64X(ctx context.Context) float64 {
...
func (lts *LocationTypeSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{locationtype.Label}
	default:
		err = fmt.Errorf("ent: LocationTypeSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (lts *LocationTypeSelect) BoolX(ctx context.Context) bool {
	v, err := lts.Bool(ctx)
	if err != nil {
		panic(err)
	}
