...
const (
	...
	// FieldActingUserID holds the string denoting the acting_user_id vertex property in the database.
	FieldActingUserID = "actingUserId"
	// FieldOrganization holds the string denoting the organization vertex property in the database.
	FieldOrganization = "organization"
	// FieldMutationType holds the string denoting the mutation_type vertex property in the database.
	FieldMutationType = "mutationType"
	// FieldObjectID holds the string denoting the object_id vertex property in the database.
	FieldObjectID = "objectId"
	// FieldObjectType holds the string denoting the object_type vertex property in the database.
	FieldObjectType = "objectType"
	// FieldObjectDisplayName holds the string denoting the object_display_name vertex property in the database.
	FieldObjectDisplayName = "objectDisplayName"
	// FieldMutationData holds the string denoting the mutation_data vertex property in the database.
	FieldMutationData = "mutationData"
	// FieldURL holds the string denoting the url vertex property in the database.
	FieldURL = "url"
	// FieldIPAddress holds the string denoting the ip_address vertex property in the database.
	FieldIPAddress = "ipAddress"
	// FieldStatus holds the string denoting the status vertex property in the database.
	FieldStatus = "status"
	// FieldStatusCode holds the string denoting the status_code vertex property in the database.
