...
var grammar = {
    ...
    {"name": "BIN_OP", "symbols": [(lexer.has("binComp") ? {type: "binComp"} : binComp)], "postprocess": d => d[0].value},
    {"name": "BIN_OP", "symbols": [(lexer.has("setOp") ? {type: "setOp"} : setOp)], "postprocess": d => d[0].value},
    {"name": "BIN_OP", "symbols": [(lexer.has("arithmetic") ? {type: "arithmetic"} : arithmetic)], "postprocess": d => d[0].value},
