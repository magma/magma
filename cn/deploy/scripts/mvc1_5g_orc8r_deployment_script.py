...
def create_docker_images(pwd):
    myprint(
        "BLUE",
        "Creating docker images for stubbed AMF, SMF, UPF core components")
    ...
    execute_cmd(cmd)
    cmd = "{ sleep 0.1; echo '%s'; } | script -q -c 'sudo docker build -t amf-container:latest %s' /dev/null" % (
        pwd, BUILD_CONTEXT_AMF)
    execute_cmd(cmd)
    ...
    execute_cmd(cmd)
    cmd = "{ sleep 0.1; echo '%s'; } | script -q -c 'sudo docker build -t smf-container:latest %s' /dev/null" % (
        pwd, BUILD_CONTEXT_SMF)
    execute_cmd(cmd)
    ...
    execute_cmd(cmd)
    cmd = "{ sleep 0.1; echo '%s'; } | script -q -c 'sudo docker build -t upf-container:latest %s' /dev/null" % (
        pwd, BUILD_CONTEXT_UPF)
    execute_cmd(cmd)
    os.chdir(CWD)
...
def get_status(lock):
    while True:
        ...
        for _ in k8s_obj_dict.values():
            ...
            cmd = "kubectl get deployment -n default | awk " + \
...
def start_to_run():
    cmd = "kubectl get services -n default | awk " + \
...
def run_services():
    ...
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/monitoring.coreos.com_alertmanagers.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/monitoring.coreos.com_podmonitors.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/monitoring.coreos.com_prometheuses.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/monitoring.coreos.com_prometheusrules.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/monitoring.coreos.com_servicemonitors.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/monitoring.coreos.com_thanosrulers.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/amfchart.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/smfchart.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/upfchart.yaml -n default")
    execute_cmd(
        "kubectl apply -f $PWD/../helm/templates/efkchart.yaml -n default")
    time.sleep(3)
    execute_cmd(
        "helm install prometheus-default stable/prometheus-operator --namespace default")
    myprint(
        "FAIL",
        "change type(key) value from 'ClusterIP' to 'NodePort' and save it")
    time.sleep(3)
    execute_cmd(
        "kubectl edit service/prometheus-default-prometh-alertmanager -n default")
    myprint(
        "FAIL",
        "change type(key) value from 'ClusterIP' to 'NodePort' and save it")
    time.sleep(3)
    ...
    time.sleep(3)
    execute_cmd(
        "kubectl edit service/prometheus-default-prometh-prometheus -n default")
    myprint("GREEN", "+++++++++++++++++++++++++++++++++++++++++++++++")
...
def un_install(pwd):
    ...
    execute_cmd(
        "helm uninstall prometheus-default stable/prometheus-operator --namespace default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/monitoring.coreos.com_thanosrulers.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/monitoring.coreos.com_servicemonitors.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/monitoring.coreos.com_prometheusrules.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/monitoring.coreos.com_prometheuses.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/monitoring.coreos.com_podmonitors.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/monitoring.coreos.com_alertmanagers.yaml -n default")
    myprint("BLUE", "*****Trying to Un-install AMF/SMF/UPF containers*****")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/amfchart.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/smfchart.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/upfchart.yaml -n default")
    execute_cmd(
        "kubectl delete -f $PWD/../helm/templates/efkchart.yaml -n default")
...
def get_help(color):
    ...
    myprint(
        color,
        './mvc1_5g_orc8r_deployment_script.py --password <sudo-password> --install')
    myprint(
        color,
        './mvc1_5g_orc8r_deployment_script.py --password <sudo-password> --uninstall')
