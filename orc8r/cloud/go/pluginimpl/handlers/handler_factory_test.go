...
func (m *ID) ToUpdateCriteria(network configurator.Network) configurator.NetworkUpdateCriteria {
	feature := (&TestFeature1{}).GetFromNetwork(network)
...
func (m *TestFeature1) ToUpdateCriteria(network configurator.Network) configurator.NetworkUpdateCriteria {
	return configurator.NetworkUpdateCriteria{
		ID:                   network.ID,
