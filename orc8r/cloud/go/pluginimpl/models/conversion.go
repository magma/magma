...
func (m *NetworkFeatures) ToUpdateCriteria(network configurator.Network) configurator.NetworkUpdateCriteria {
	return configurator.NetworkUpdateCriteria{
		ID: network.ID,
		ConfigsToAddOrUpdate: map[string]interface{}{
...
func (m *NetworkDNSConfig) ToUpdateCriteria(network configurator.Network) configurator.NetworkUpdateCriteria {
	return configurator.NetworkUpdateCriteria{
		ID: network.ID,
		ConfigsToAddOrUpdate: map[string]interface{}{
