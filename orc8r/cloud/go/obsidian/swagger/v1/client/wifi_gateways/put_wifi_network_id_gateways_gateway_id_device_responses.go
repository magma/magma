...
/*PutWifiNetworkIDGatewaysGatewayIDDeviceNoContent handles this case with default header values.
...
/*PutWifiNetworkIDGatewaysGatewayIDDeviceDefault handles this case with default header values.
