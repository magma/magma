...
/*PutLTENetworkIDGatewaysGatewayIDCellularEpcNoContent handles this case with default header values.
...
/*PutLTENetworkIDGatewaysGatewayIDCellularEpcDefault handles this case with default header values.
