...
func (ServiceInfo_ServiceState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{2, 0}
}
...
func (ServiceInfo_ApplicationHealth) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{2, 1}
}
...
func (*EnodebdStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{0}
}
...
func (*ServiceStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{1}
}
...
func (*ServiceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{2}
}
...
func (*LogLevelMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{3}
}
...
func (*LogVerbosity) Descriptor() ([]byte, []int) {
	return fileDescriptor_service303_ff07b95784c6f89c, []int{4}
}
...
func init() {
	proto.RegisterFile("orc8r/protos/service303.proto", fileDescriptor_service303_ff07b95784c6f89c)
}

var fileDescriptor_service303_ff07b95784c6f89c = []byte{
	// 791 bytes of a gzipped FileDescriptorProto
	,
}
