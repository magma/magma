...
func (*RedisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_redis_d454e9a7c8681dcf, []int{0}
}
...
func (dst *RedisState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RedisState.Merge(dst, src)
}
...
func init() { proto.RegisterFile("orc8r/protos/redis.proto", fileDescriptor_redis_d454e9a7c8681dcf) }

var fileDescriptor_redis_d454e9a7c8681dcf = []byte{
