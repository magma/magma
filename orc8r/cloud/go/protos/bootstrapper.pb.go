...
func (ChallengeKey_KeyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{1, 0}
}
...
func (*Challenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{0}
}
...
func (*ChallengeKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{1}
}
...
func (dst *ChallengeKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChallengeKey.Merge(dst, src)
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{2}
}
...
func _Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Response_EchoResponse:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.EchoResponse); err != nil {
			return err
		}
	case *Response_RsaResponse:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RsaResponse); err != nil {
			return err
		}
	case *Response_EcdsaResponse:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.EcdsaResponse); err != nil {
			return err
		}
	case nil:
	default:
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Response)
	switch tag {
	case 3: // response.echo_response
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Response_Echo)
		err := b.DecodeMessage(msg)
		m.Response = &Response_EchoResponse{msg}
		return true, err
	case 4: // response.rsa_response
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Response_RSA)
		err := b.DecodeMessage(msg)
		m.Response = &Response_RsaResponse{msg}
		return true, err
	case 5: // response.ecdsa_response
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Response_ECDSA)
		err := b.DecodeMessage(msg)
		m.Response = &Response_EcdsaResponse{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Response_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.Response.(type) {
	case *Response_EchoResponse:
		s := proto.Size(x.EchoResponse)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Response_RsaResponse:
		s := proto.Size(x.RsaResponse)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Response_EcdsaResponse:
		s := proto.Size(x.EcdsaResponse)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Response_Echo) Descriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{2, 0}
}
...
func (dst *Response_Echo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Response_Echo.Merge(dst, src)
}
...
func (*Response_RSA) Descriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{2, 1}
}
...
func (dst *Response_RSA) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Response_RSA.Merge(dst, src)
}
...
func (*Response_ECDSA) Descriptor() ([]byte, []int) {
	return fileDescriptor_bootstrapper_6370f262c5f2dbf0, []int{2, 2}
}
...
func (dst *Response_ECDSA) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Response_ECDSA.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("orc8r/protos/bootstrapper.proto", fileDescriptor_bootstrapper_6370f262c5f2dbf0)
}

var fileDescriptor_bootstrapper_6370f262c5f2dbf0 = []byte{
