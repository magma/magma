...
func (*PhysicalEntity) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_017c08e7ecae3d3e, []int{0}
}
...
func (*RegisterOrUpdateDevicesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_017c08e7ecae3d3e, []int{1}
}
...
func (dst *RegisterOrUpdateDevicesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegisterOrUpdateDevicesRequest.Merge(dst, src)
}
...
func (*DeviceID) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_017c08e7ecae3d3e, []int{2}
}
...
func (*GetDeviceInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_017c08e7ecae3d3e, []int{3}
}
...
func (*GetDeviceInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_017c08e7ecae3d3e, []int{4}
}
...
func (*DeleteDevicesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_017c08e7ecae3d3e, []int{5}
}
...
func init() { proto.RegisterFile("device.proto", fileDescriptor_device_017c08e7ecae3d3e) }

var fileDescriptor_device_017c08e7ecae3d3e = []byte{
