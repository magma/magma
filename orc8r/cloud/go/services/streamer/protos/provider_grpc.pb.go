...
// All implementations should embed UnimplementedStreamProviderServer
// for forward compatibility
type StreamProviderServer interface {
	GetUpdates(context.Context, *protos.StreamRequest) (*protos.DataUpdateBatch, error)
}

// UnimplementedStreamProviderServer should be embedded to have forward compatible implementations.
