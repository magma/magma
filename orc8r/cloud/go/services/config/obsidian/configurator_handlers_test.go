...
func TestConfiguratorCreateConfigHandler(t *testing.T) {
	commonSetup(t)
...
func TestConfiguratorUpdateConfigHandler(t *testing.T) {
	commonSetup(t)
...
func TestConfiguratorDeleteConfigHandler(t *testing.T) {
	commonSetup(t)
