...
import (
	...
	analytics_svc "magma/orc8r/cloud/go/services/orchestrator/analytics"
...
func main() {
	...
	collectorService := analytics.NewCollectorService(
		&serviceConfig.Analytics,
		analytics.GetPrometheusClient(),
		analytics_svc.GetAnalyticsCalculations(&serviceConfig.Analytics),
		nil)
	analytics_protos.RegisterAnalyticsCollectorServer(srv.GrpcServer, collectorService)
