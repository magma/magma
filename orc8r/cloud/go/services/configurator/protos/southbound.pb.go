...
func (*GetMconfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_southbound_b2772570049da9e2, []int{0}
}
...
func (dst *GetMconfigRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMconfigRequest.Merge(dst, src)
}
...
func (*GetMconfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_southbound_b2772570049da9e2, []int{1}
}
...
func (dst *GetMconfigResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetMconfigResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("southbound.proto", fileDescriptor_southbound_b2772570049da9e2) }

var fileDescriptor_southbound_b2772570049da9e2 = []byte{
