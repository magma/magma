...
func TestCheckind(t *testing.T) {
	...
	getAGStatusTestCase := tests.Testcase{
		...
		Expected: fmt.Sprintf(
			`{"checkin_time":%d,"hardware_id":"Test-AGW-Hw-Id",
			"kernel_version":"4.9.0-6-amd64",
			"meta":{"hello":"world"},"system_status":
			{"cpu_idle":1869111,"cpu_system":8361,"cpu_user":31498,
			"mem_free":412772,"mem_total":1016084,"mem_used":54416,
			"time":1495484735606,"uptime_secs":1234},"version":"1.2.3"}`, resp.Time),
	}
