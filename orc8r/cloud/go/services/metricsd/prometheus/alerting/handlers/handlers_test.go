...
func TestGetConfigureAlertHandler(t *testing.T) {
	...
	client.On("RuleExists", sampleAlert1.Alert, testNID).Return(false)
	client.On("WriteRule", sampleAlert1, testNID).Return(nil)
	...
	client.AssertCalled(t, "RuleExists", sampleAlert1.Alert, testNID)
	client.AssertCalled(t, "WriteRule", sampleAlert1, testNID)
}
...
func TestGetDeleteAlertHandler(t *testing.T) {
	client := &mocks.PrometheusAlertClient{}
	client.On("DeleteRule", sampleAlert1.Alert, testNID).Return(nil)
	...
	assert.NoError(t, err)
	assert.Equal(t, http.StatusOK, rec.Code)
	client.AssertCalled(t, "DeleteRule", sampleAlert1.Alert, testNID)
...
func TestUpdateAlertHandler(t *testing.T) {
	client := &mocks.PrometheusAlertClient{}
	client.On("RuleExists", sampleAlert1.Alert, testNID).Return(true)
	client.On("ValidateRule", sampleAlert1).Return(nil)
	client.On("UpdateRule", sampleAlert1, testNID).Return(nil)
	...
	client.AssertCalled(t, "RuleExists", sampleAlert1.Alert, testNID)
	client.AssertCalled(t, "ValidateRule", sampleAlert1)
	client.AssertCalled(t, "UpdateRule", sampleAlert1, testNID)
}
...
func TestGetBulkAlertUpdateHandler(t *testing.T) {
	...
	client.On("BulkUpdateRules", bulkAlerts, testNID).Return(sampleUpdateResult, nil)
	...
	assert.NoError(t, err)
	client.AssertCalled(t, "BulkUpdateRules", bulkAlerts, testNID)
