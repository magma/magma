...
// ContextValidate validate this prom alert config list based on the context it is used
func (m PromAlertConfigList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
