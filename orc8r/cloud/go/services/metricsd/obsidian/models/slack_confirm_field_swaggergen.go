...
// ContextValidate validates this slack confirm field based on context it is used
func (m *SlackConfirmField) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
