...
// ContextValidate validate this promql result based on the context it is used
func (m PromqlResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
