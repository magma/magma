...
/* PutFegNetworkIDSubscriberConfigBaseNamesParams contains all the parameters to send to the API endpoint
   for the put feg network ID subscriber config base names operation.
...
// WithDefaults hydrates default values in the put feg network ID subscriber config base names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutFegNetworkIDSubscriberConfigBaseNamesParams) WithDefaults() *PutFegNetworkIDSubscriberConfigBaseNamesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put feg network ID subscriber config base names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutFegNetworkIDSubscriberConfigBaseNamesParams) SetDefaults() {
