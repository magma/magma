...
/* GetFegNetworkIDFederationParams contains all the parameters to send to the API endpoint
   for the get feg network ID federation operation.
...
// WithDefaults hydrates default values in the get feg network ID federation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDFederationParams) WithDefaults() *GetFegNetworkIDFederationParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get feg network ID federation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDFederationParams) SetDefaults() {
