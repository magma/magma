...
// WithDefaults hydrates default values in the get feg params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegParams) WithDefaults() *GetFegParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get feg params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegParams) SetDefaults() {
