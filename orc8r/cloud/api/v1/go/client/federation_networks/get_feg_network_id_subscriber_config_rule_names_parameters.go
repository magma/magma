...
/* GetFegNetworkIDSubscriberConfigRuleNamesParams contains all the parameters to send to the API endpoint
   for the get feg network ID subscriber config rule names operation.
...
// WithDefaults hydrates default values in the get feg network ID subscriber config rule names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDSubscriberConfigRuleNamesParams) WithDefaults() *GetFegNetworkIDSubscriberConfigRuleNamesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get feg network ID subscriber config rule names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDSubscriberConfigRuleNamesParams) SetDefaults() {
