...
/* PostNetworksNetworkIDPrometheusAlertReceiverRouteParams contains all the parameters to send to the API endpoint
   for the post networks network ID prometheus alert receiver route operation.
...
// WithDefaults hydrates default values in the post networks network ID prometheus alert receiver route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostNetworksNetworkIDPrometheusAlertReceiverRouteParams) WithDefaults() *PostNetworksNetworkIDPrometheusAlertReceiverRouteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post networks network ID prometheus alert receiver route params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostNetworksNetworkIDPrometheusAlertReceiverRouteParams) SetDefaults() {
