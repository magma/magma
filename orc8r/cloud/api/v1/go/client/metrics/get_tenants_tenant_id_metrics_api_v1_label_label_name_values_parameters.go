...
/* GetTenantsTenantIDMetricsAPIV1LabelLabelNameValuesParams contains all the parameters to send to the API endpoint
   for the get tenants tenant ID metrics API v1 label label name values operation.
...
// WithDefaults hydrates default values in the get tenants tenant ID metrics API v1 label label name values params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTenantsTenantIDMetricsAPIV1LabelLabelNameValuesParams) WithDefaults() *GetTenantsTenantIDMetricsAPIV1LabelLabelNameValuesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get tenants tenant ID metrics API v1 label label name values params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTenantsTenantIDMetricsAPIV1LabelLabelNameValuesParams) SetDefaults() {
