...
/* GetNetworksNetworkIDPrometheusQueryParams contains all the parameters to send to the API endpoint
   for the get networks network ID prometheus query operation.
...
// WithDefaults hydrates default values in the get networks network ID prometheus query params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetNetworksNetworkIDPrometheusQueryParams) WithDefaults() *GetNetworksNetworkIDPrometheusQueryParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get networks network ID prometheus query params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetNetworksNetworkIDPrometheusQueryParams) SetDefaults() {
