...
/* GetCwfNetworkIDSubscriberConfigBaseNamesParams contains all the parameters to send to the API endpoint
   for the get cwf network ID subscriber config base names operation.
...
// WithDefaults hydrates default values in the get cwf network ID subscriber config base names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCwfNetworkIDSubscriberConfigBaseNamesParams) WithDefaults() *GetCwfNetworkIDSubscriberConfigBaseNamesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cwf network ID subscriber config base names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCwfNetworkIDSubscriberConfigBaseNamesParams) SetDefaults() {
