...
/* PutCwfNetworkIDParams contains all the parameters to send to the API endpoint
   for the put cwf network ID operation.
...
// WithDefaults hydrates default values in the put cwf network ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCwfNetworkIDParams) WithDefaults() *PutCwfNetworkIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put cwf network ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCwfNetworkIDParams) SetDefaults() {
