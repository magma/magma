...
/* GetCwfNetworkIDHaPairsHaPairIDParams contains all the parameters to send to the API endpoint
   for the get cwf network ID ha pairs ha pair ID operation.
...
// WithDefaults hydrates default values in the get cwf network ID ha pairs ha pair ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCwfNetworkIDHaPairsHaPairIDParams) WithDefaults() *GetCwfNetworkIDHaPairsHaPairIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cwf network ID ha pairs ha pair ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCwfNetworkIDHaPairsHaPairIDParams) SetDefaults() {
