...
/* PutCwfNetworkIDSubscriberConfigBaseNamesParams contains all the parameters to send to the API endpoint
   for the put cwf network ID subscriber config base names operation.
...
// WithDefaults hydrates default values in the put cwf network ID subscriber config base names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCwfNetworkIDSubscriberConfigBaseNamesParams) WithDefaults() *PutCwfNetworkIDSubscriberConfigBaseNamesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put cwf network ID subscriber config base names params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCwfNetworkIDSubscriberConfigBaseNamesParams) SetDefaults() {
