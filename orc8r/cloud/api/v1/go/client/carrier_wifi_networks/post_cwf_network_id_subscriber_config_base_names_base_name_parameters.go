...
/* PostCwfNetworkIDSubscriberConfigBaseNamesBaseNameParams contains all the parameters to send to the API endpoint
   for the post cwf network ID subscriber config base names base name operation.
...
// WithDefaults hydrates default values in the post cwf network ID subscriber config base names base name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostCwfNetworkIDSubscriberConfigBaseNamesBaseNameParams) WithDefaults() *PostCwfNetworkIDSubscriberConfigBaseNamesBaseNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post cwf network ID subscriber config base names base name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostCwfNetworkIDSubscriberConfigBaseNamesBaseNameParams) SetDefaults() {
