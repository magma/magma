...
/* GetCwfNetworkIDHaPairsParams contains all the parameters to send to the API endpoint
   for the get cwf network ID ha pairs operation.
...
// WithDefaults hydrates default values in the get cwf network ID ha pairs params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCwfNetworkIDHaPairsParams) WithDefaults() *GetCwfNetworkIDHaPairsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get cwf network ID ha pairs params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCwfNetworkIDHaPairsParams) SetDefaults() {
