...
/* PostNetworksNetworkIDDNSRecordsDomainParams contains all the parameters to send to the API endpoint
   for the post networks network ID DNS records domain operation.
...
// WithDefaults hydrates default values in the post networks network ID DNS records domain params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostNetworksNetworkIDDNSRecordsDomainParams) WithDefaults() *PostNetworksNetworkIDDNSRecordsDomainParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post networks network ID DNS records domain params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostNetworksNetworkIDDNSRecordsDomainParams) SetDefaults() {
