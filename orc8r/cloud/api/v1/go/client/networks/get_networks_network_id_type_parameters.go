...
/* GetNetworksNetworkIDTypeParams contains all the parameters to send to the API endpoint
   for the get networks network ID type operation.
...
// WithDefaults hydrates default values in the get networks network ID type params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetNetworksNetworkIDTypeParams) WithDefaults() *GetNetworksNetworkIDTypeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get networks network ID type params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetNetworksNetworkIDTypeParams) SetDefaults() {
