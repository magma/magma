...
/* GetNetworksNetworkIDGatewaysGatewayIDNameParams contains all the parameters to send to the API endpoint
   for the get networks network ID gateways gateway ID name operation.
...
// WithDefaults hydrates default values in the get networks network ID gateways gateway ID name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetNetworksNetworkIDGatewaysGatewayIDNameParams) WithDefaults() *GetNetworksNetworkIDGatewaysGatewayIDNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get networks network ID gateways gateway ID name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetNetworksNetworkIDGatewaysGatewayIDNameParams) SetDefaults() {
