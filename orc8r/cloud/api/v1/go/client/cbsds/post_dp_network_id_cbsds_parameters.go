...
/* PostDpNetworkIDCbsdsParams contains all the parameters to send to the API endpoint
   for the post dp network ID cbsds operation.
...
// WithDefaults hydrates default values in the post dp network ID cbsds params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostDpNetworkIDCbsdsParams) WithDefaults() *PostDpNetworkIDCbsdsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post dp network ID cbsds params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostDpNetworkIDCbsdsParams) SetDefaults() {
