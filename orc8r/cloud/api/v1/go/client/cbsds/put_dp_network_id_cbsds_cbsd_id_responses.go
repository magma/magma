...
/*PutDpNetworkIDCbsdsCbsdIDNoContent handles this case with default header values.
...
/*PutDpNetworkIDCbsdsCbsdIDDefault handles this case with default header values.
