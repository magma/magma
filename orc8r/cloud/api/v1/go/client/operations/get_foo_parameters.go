...
// WithDefaults hydrates default values in the get foo params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFooParams) WithDefaults() *GetFooParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get foo params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFooParams) SetDefaults() {
