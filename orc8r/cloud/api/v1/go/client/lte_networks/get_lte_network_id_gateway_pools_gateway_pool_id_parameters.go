...
/* GetLTENetworkIDGatewayPoolsGatewayPoolIDParams contains all the parameters to send to the API endpoint
   for the get LTE network ID gateway pools gateway pool ID operation.
...
// WithDefaults hydrates default values in the get LTE network ID gateway pools gateway pool ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDGatewayPoolsGatewayPoolIDParams) WithDefaults() *GetLTENetworkIDGatewayPoolsGatewayPoolIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get LTE network ID gateway pools gateway pool ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDGatewayPoolsGatewayPoolIDParams) SetDefaults() {
