...
/* PutLTENetworkIDCellularParams contains all the parameters to send to the API endpoint
   for the put LTE network ID cellular operation.
...
// WithDefaults hydrates default values in the put LTE network ID cellular params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutLTENetworkIDCellularParams) WithDefaults() *PutLTENetworkIDCellularParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put LTE network ID cellular params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutLTENetworkIDCellularParams) SetDefaults() {
