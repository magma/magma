...
// WithDefaults hydrates default values in the get LTE params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTEParams) WithDefaults() *GetLTEParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get LTE params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTEParams) SetDefaults() {
