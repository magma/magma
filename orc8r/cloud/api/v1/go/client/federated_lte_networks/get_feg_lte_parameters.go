...
// WithDefaults hydrates default values in the get feg LTE params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegLTEParams) WithDefaults() *GetFegLTEParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get feg LTE params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegLTEParams) SetDefaults() {
