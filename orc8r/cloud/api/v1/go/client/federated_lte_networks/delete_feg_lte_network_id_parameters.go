...
/* DeleteFegLTENetworkIDParams contains all the parameters to send to the API endpoint
   for the delete feg LTE network ID operation.
...
// WithDefaults hydrates default values in the delete feg LTE network ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteFegLTENetworkIDParams) WithDefaults() *DeleteFegLTENetworkIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete feg LTE network ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteFegLTENetworkIDParams) SetDefaults() {
