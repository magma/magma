...
/* GetWifiNetworkIDDescriptionParams contains all the parameters to send to the API endpoint
   for the get wifi network ID description operation.
...
// WithDefaults hydrates default values in the get wifi network ID description params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWifiNetworkIDDescriptionParams) WithDefaults() *GetWifiNetworkIDDescriptionParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get wifi network ID description params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWifiNetworkIDDescriptionParams) SetDefaults() {
