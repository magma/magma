...
/* GetWifiNetworkIDNameParams contains all the parameters to send to the API endpoint
   for the get wifi network ID name operation.
...
// WithDefaults hydrates default values in the get wifi network ID name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWifiNetworkIDNameParams) WithDefaults() *GetWifiNetworkIDNameParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get wifi network ID name params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetWifiNetworkIDNameParams) SetDefaults() {
