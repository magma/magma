...
/* GetLTENetworkIDGatewaysGatewayIDConnectedENODEBSerialsParams contains all the parameters to send to the API endpoint
   for the get LTE network ID gateways gateway ID connected ENODEB serials operation.
...
// WithDefaults hydrates default values in the get LTE network ID gateways gateway ID connected ENODEB serials params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDGatewaysGatewayIDConnectedENODEBSerialsParams) WithDefaults() *GetLTENetworkIDGatewaysGatewayIDConnectedENODEBSerialsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get LTE network ID gateways gateway ID connected ENODEB serials params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDGatewaysGatewayIDConnectedENODEBSerialsParams) SetDefaults() {
