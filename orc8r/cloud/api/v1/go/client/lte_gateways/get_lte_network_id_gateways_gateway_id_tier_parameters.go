...
/* GetLTENetworkIDGatewaysGatewayIDTierParams contains all the parameters to send to the API endpoint
   for the get LTE network ID gateways gateway ID tier operation.
...
// WithDefaults hydrates default values in the get LTE network ID gateways gateway ID tier params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDGatewaysGatewayIDTierParams) WithDefaults() *GetLTENetworkIDGatewaysGatewayIDTierParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get LTE network ID gateways gateway ID tier params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDGatewaysGatewayIDTierParams) SetDefaults() {
