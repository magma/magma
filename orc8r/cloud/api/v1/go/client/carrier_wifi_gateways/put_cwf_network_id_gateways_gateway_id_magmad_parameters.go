...
/* PutCwfNetworkIDGatewaysGatewayIDMagmadParams contains all the parameters to send to the API endpoint
   for the put cwf network ID gateways gateway ID magmad operation.
...
// WithDefaults hydrates default values in the put cwf network ID gateways gateway ID magmad params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCwfNetworkIDGatewaysGatewayIDMagmadParams) WithDefaults() *PutCwfNetworkIDGatewaysGatewayIDMagmadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put cwf network ID gateways gateway ID magmad params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCwfNetworkIDGatewaysGatewayIDMagmadParams) SetDefaults() {
