...
/* PostChannelsParams contains all the parameters to send to the API endpoint
   for the post channels operation.
...
// WithDefaults hydrates default values in the post channels params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostChannelsParams) WithDefaults() *PostChannelsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post channels params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostChannelsParams) SetDefaults() {
