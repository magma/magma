...
/* GetFegNetworkIDGatewaysGatewayIDParams contains all the parameters to send to the API endpoint
   for the get feg network ID gateways gateway ID operation.
...
// WithDefaults hydrates default values in the get feg network ID gateways gateway ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDGatewaysGatewayIDParams) WithDefaults() *GetFegNetworkIDGatewaysGatewayIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get feg network ID gateways gateway ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDGatewaysGatewayIDParams) SetDefaults() {
