...
/* GetFegNetworkIDGatewaysGatewayIDFederationParams contains all the parameters to send to the API endpoint
   for the get feg network ID gateways gateway ID federation operation.
...
// WithDefaults hydrates default values in the get feg network ID gateways gateway ID federation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDGatewaysGatewayIDFederationParams) WithDefaults() *GetFegNetworkIDGatewaysGatewayIDFederationParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get feg network ID gateways gateway ID federation params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFegNetworkIDGatewaysGatewayIDFederationParams) SetDefaults() {
