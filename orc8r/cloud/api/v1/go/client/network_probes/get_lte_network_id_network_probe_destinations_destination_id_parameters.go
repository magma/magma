...
/* GetLTENetworkIDNetworkProbeDestinationsDestinationIDParams contains all the parameters to send to the API endpoint
   for the get LTE network ID network probe destinations destination ID operation.
...
// WithDefaults hydrates default values in the get LTE network ID network probe destinations destination ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDNetworkProbeDestinationsDestinationIDParams) WithDefaults() *GetLTENetworkIDNetworkProbeDestinationsDestinationIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get LTE network ID network probe destinations destination ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLTENetworkIDNetworkProbeDestinationsDestinationIDParams) SetDefaults() {
