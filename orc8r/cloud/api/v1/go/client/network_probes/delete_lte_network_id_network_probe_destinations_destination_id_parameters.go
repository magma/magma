...
/* DeleteLTENetworkIDNetworkProbeDestinationsDestinationIDParams contains all the parameters to send to the API endpoint
   for the delete LTE network ID network probe destinations destination ID operation.
...
// WithDefaults hydrates default values in the delete LTE network ID network probe destinations destination ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteLTENetworkIDNetworkProbeDestinationsDestinationIDParams) WithDefaults() *DeleteLTENetworkIDNetworkProbeDestinationsDestinationIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete LTE network ID network probe destinations destination ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteLTENetworkIDNetworkProbeDestinationsDestinationIDParams) SetDefaults() {
