...
// ContextValidate validates this prometheus labelset based on context it is used
func (m PrometheusLabelset) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
