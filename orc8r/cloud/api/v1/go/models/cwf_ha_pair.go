...
// ContextValidate validate this cwf ha pair based on the context it is used
func (m *CwfHaPair) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CwfHaPair) contextValidateConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CwfHaPair) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
