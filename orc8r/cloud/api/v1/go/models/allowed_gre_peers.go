...
// ContextValidate validate this allowed gre peers based on the context it is used
func (m AllowedGrePeers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
