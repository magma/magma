...
package testcfg // import "magma/ocr8c/gateway/mconfig/test/testcfg"
...
func (*Service1Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_configs_1cdc68dc6648cff7, []int{0}
}
...
func (dst *Service1Config) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Service1Config.Merge(dst, src)
}
...
func (*Service2Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_configs_1cdc68dc6648cff7, []int{1}
}
...
func (dst *Service2Config) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Service2Config.Merge(dst, src)
}
...
func init() { proto.RegisterFile("test_configs.proto", fileDescriptor_test_configs_1cdc68dc6648cff7) }

var fileDescriptor_test_configs_1cdc68dc6648cff7 = []byte{
