...
func GetMetrics(prometheusLabels map[string]string) ([]*prometheus_proto.MetricFamily, error) {
	...
	var labels []*prometheus_proto.LabelPair
	for labelName, labelValue := range prometheusLabels {
