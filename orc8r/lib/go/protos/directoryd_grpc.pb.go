...
// All implementations should embed UnimplementedGatewayDirectoryServiceServer
...
// UnimplementedGatewayDirectoryServiceServer should be embedded to have forward compatible implementations.
