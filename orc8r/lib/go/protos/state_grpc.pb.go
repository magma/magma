...
// All implementations should embed UnimplementedCloudStateServiceServer
...
// UnimplementedCloudStateServiceServer should be embedded to have forward compatible implementations.
