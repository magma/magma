...
type EnodebdStatus struct {
	...
	EnodebConnected  *wrapperspb.BoolValue  `protobuf:"bytes,1,opt,name=enodeb_connected,json=enodebConnected,proto3" json:"enodeb_connected,omitempty"`
	OpstateEnabled   *wrapperspb.BoolValue  `protobuf:"bytes,2,opt,name=opstate_enabled,json=opstateEnabled,proto3" json:"opstate_enabled,omitempty"`
	RfTxOn           *wrapperspb.BoolValue  `protobuf:"bytes,3,opt,name=rf_tx_on,json=rfTxOn,proto3" json:"rf_tx_on,omitempty"`
	GpsConnected     *wrapperspb.BoolValue  `protobuf:"bytes,4,opt,name=gps_connected,json=gpsConnected,proto3" json:"gps_connected,omitempty"`
	PtpConnected     *wrapperspb.BoolValue  `protobuf:"bytes,5,opt,name=ptp_connected,json=ptpConnected,proto3" json:"ptp_connected,omitempty"`
	MmeConnected     *wrapperspb.BoolValue  `protobuf:"bytes,6,opt,name=mme_connected,json=mmeConnected,proto3" json:"mme_connected,omitempty"`
	EnodebConfigured *wrapperspb.BoolValue  `protobuf:"bytes,7,opt,name=enodeb_configured,json=enodebConfigured,proto3" json:"enodeb_configured,omitempty"`
	GpsLatitude      *wrapperspb.FloatValue `protobuf:"bytes,8,opt,name=gps_latitude,json=gpsLatitude,proto3" json:"gps_latitude,omitempty"`
	GpsLongitude     *wrapperspb.FloatValue `protobuf:"bytes,9,opt,name=gps_longitude,json=gpsLongitude,proto3" json:"gps_longitude,omitempty"`
	RfTxDesired      *wrapperspb.BoolValue  `protobuf:"bytes,10,opt,name=rf_tx_desired,json=rfTxDesired,proto3" json:"rf_tx_desired,omitempty"`
}
...
func (x *EnodebdStatus) GetEnodebConnected() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *EnodebdStatus) GetOpstateEnabled() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *EnodebdStatus) GetRfTxOn() *wrapperspb.BoolValue {
	if x != nil {
		return x.RfTxOn
	}
	return nil
...
func (x *EnodebdStatus) GetGpsConnected() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *EnodebdStatus) GetPtpConnected() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *EnodebdStatus) GetMmeConnected() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *EnodebdStatus) GetEnodebConfigured() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *EnodebdStatus) GetGpsLatitude() *wrapperspb.FloatValue {
	if x != nil {
...
func (x *EnodebdStatus) GetGpsLongitude() *wrapperspb.FloatValue {
	if x != nil {
...
func (x *EnodebdStatus) GetRfTxDesired() *wrapperspb.BoolValue {
	if x != nil {
