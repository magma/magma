...
type GatewayConfigs struct {
	...
	ConfigsByKey map[string]*anypb.Any   `protobuf:"bytes,10,rep,name=configs_by_key,json=configsByKey,proto3" json:"configs_by_key,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *GatewayConfigs) GetConfigsByKey() map[string]*anypb.Any {
	if x != nil {
