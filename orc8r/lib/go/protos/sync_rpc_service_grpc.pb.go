...
// All implementations should embed UnimplementedSyncRPCServiceServer
...
// UnimplementedSyncRPCServiceServer should be embedded to have forward compatible implementations.
