...
// All implementations should embed UnimplementedActiveModeControllerServer
...
// UnimplementedActiveModeControllerServer should be embedded to have forward compatible implementations.
