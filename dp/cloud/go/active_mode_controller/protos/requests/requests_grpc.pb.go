...
// All implementations should embed UnimplementedRadioControllerServer
// for forward compatibility
type RadioControllerServer interface {
	UploadRequests(context.Context, *RequestPayload) (*RequestDbIds, error)
}

// UnimplementedRadioControllerServer should be embedded to have forward compatible implementations.
