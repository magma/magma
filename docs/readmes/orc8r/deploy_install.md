...
cd ~/secrets/envdir
echo "STREAMER,SUBSCRIBERDB,METRICSD,CHECKIND,UPGRADE,MAGMAD,CERTIFIER,BOOTSTRAPPER,POLICYDB,METERINGD_RECORDS,ACCESSD,OBSIDIAN,DISPATCHER,CONFIG,DIRECTORYD" > CONTROLLER_SERVICES
