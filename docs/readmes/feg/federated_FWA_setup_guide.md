...
![NMS-FederatedLTE-Config.png](/magma/docs/readmes/assets/feg/NMS-FederatedLTE-Config.png)
...
![API-Federation-Network-Config.png](/magma/docs/readmes/assets/feg/API-Federation-Network-Config.png)
...
![API-LTE-Network-EPC-Config.png](/magma/docs/readmes/assets/feg/API-LTE-Network-EPC-Config.png)
```
...
![NMS-Policy-Config.png](/magma/docs/readmes/assets/feg/NMS-Policy-Config.png)
...
![NMS-Network-Wide-Rules-Config.png](/magma/docs/readmes/assets/feg/NMS-Network-Wide-Rules-Config.png)
...
![API-LTE-Magmad-Config.png](/magma/docs/readmes/assets/feg/API-LTE-Magmad-Config.png)
```
