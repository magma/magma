...
- See *Bindings for Magma's REST API* [internal document — no longer available] for notes on the Python bindings for our REST API generated by [swagger-codegen](https://github.com/swagger-api/swagger-codegen).
